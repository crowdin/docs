...
<CardGrid>
  <LinkCard title="Pré-Tradução" description="Speed up the translation process and ease the work of translators." href="/enterprise/pre-translation/" />
  <LinkCard title="Definições do Projeto" description="Configure machine translation settings for your project." href="/enterprise/project-settings/machine-translation/" />
</CardGrid>
