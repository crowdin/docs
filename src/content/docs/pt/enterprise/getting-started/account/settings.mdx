...
<Image src={introAccountSettings} alt="Definições da Conta" class="width-2xl" />
...
Altere a sua senha atual, gerencie a autenticação de dois fatores para a conta e verifique os aplicativos vinculados. Você também pode controlar a autenticação por serviços externos e sair de todos os dispositivos.
...
| Strength      | Visual Indicator | Estado       | Descrição                                                                                                               |
| :------------ | :--------------- | :----------- | :---------------------------------------------------------------------------------------------------------------------- |
...
<Image src={tokens} alt="Tokens de Acesso Pessoal" />
