...
<Steps>
  ...
  3. Autoriza a conexão com o Crowdin no lado do Slack. <Image src={slackAuthorize} alt="Authorize Slack" class="width-lg" />
...
<Steps>
  ...
  2. You'll get a response in a JSON format that will contain your Telegram channel's original chat id. <img src="{{site.url}}/assets/docs/custom_notifications_telegram_json_response.png" alt="JSON response" />\{: .width-500 }
     <img src="{{site.url}}/assets/docs/custom_notifications_telegram_json_response.png" alt="JSON response" />\{: .width-500 }
