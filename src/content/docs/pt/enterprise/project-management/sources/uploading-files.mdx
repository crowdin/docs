...
<Tabs syncKey="projectType">
  ...
  <TabItem label="String-based project">
    <Steps>
      ...
      4. Crowdin Enterprise automatically tries to detect whether you're uploading source content or translations. Verify the detection is correct and adjust the language settings if needed (e.g., English (source) should be selected for source files if the project's source language is English).
...
<CardGrid>
  <LinkCard title="Enviar Traduções Existentes" description="Learn how to upload existing translations to your project." href="/enterprise/uploading-translations/" />
  <LinkCard title="File Management" description="Manage and configure source files in your project." href="/enterprise/file-management/" />
