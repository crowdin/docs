...
Maintain an agile localization process and avoid translation delays for added texts or new product features. Integrate your project branches with Crowdin Enterprise and allow translators to access all new texts immediately.
...
To help translators translate versions consistently and avoid additional translation costs, we have the <strong x-id="1">Show within a version branch</strong> option that allows hiding duplicated strings only between versions. To help translators translate versions consistently and avoid additional translation costs, Crowdin Enterprise offers the **Show within a version branch** option, which hides duplicate strings between branches.
...
<Image src={branchMerging} alt="Mesclar Ramos" class="no-shadow mb-8" />
