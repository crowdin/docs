...
<img src={screenshotsTextRecognition.src} alt="Reconhecimento de texto" />
...
<Steps>
  1. Open the screenshot with a double click or right-click on the screenshot and select **Edit**.
  2. Ordena e filtra as frases listadas. You can select all or specific files and search strings by text or context.
...
<CardGrid>
  <LinkCard title="Definições do Projeto" description="Configure your project's Language Page View to enable screenshot translation." href="/enterprise/project-settings/#project-language-page-view" />
