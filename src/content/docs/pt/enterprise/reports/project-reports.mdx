...
### Geração de um Relatório {#generating-cost-estimate}
...
### Geração de um Relatório {#generating-translation-cost}
...
### Geração de um Relatório {#generating-pre-translation-accuracy}
...
### Geração de um Relatório {#generating-translator-accuracy}
...
### Geração de um Relatório {#generating-time-spent}
...
<Image src={topMembersSorted} alt="Melhores Membros" />
...
<CardGrid>
  <LinkCard title="Organization Reports" description="View your organization status and various available reports." href="/enterprise/organization-reports/" />
  <LinkCard title="Relatórios de Contribuição" description="Estimate and count the price of your contribution to the project." href="/enterprise/contributor-reports/" />
</CardGrid>
