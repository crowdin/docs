...
Added strings will be transferred to your Crowdin Enterprise project and also will be displayed in the list of the **Strings** tab. You can edit or delete the strings from the same list anytime. You can edit or delete the strings from the same list anytime.
...
In Crowdin Enterprise, a root folder *Sketch plugin* will be created. This folder will contain HTML files for each artboard the selected Sketch page contains. If needed, you can disable content segmentation in the plugin **Settings** so the long texts will not be split into sentences.
