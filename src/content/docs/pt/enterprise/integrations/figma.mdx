...
* Pare de usar 'Lorem Ipsum', adicione textos reais da Crowdin Enterprise aos seus protótipos. Strings added from Crowdin Enterprise become linked to the text fields in Figma.
* Crie e carregue textos de origem dos seus desenhos para o seu projeto da Crowdin Enterprise. Created strings become linked to text fields in Figma. This way, developers could use uploaded strings, reducing time spent on development.
