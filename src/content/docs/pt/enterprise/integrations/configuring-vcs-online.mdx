...
<Image src={configuringSpreadsheets} alt="Configurar Folhas de Cálculo" class="width-2xl" />
...
<Image src={configuringXml} alt="Configurar Ficheiros XML" class="width-2xl" />
