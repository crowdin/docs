---
title: Configuração do Ficheiro
...
<CardGrid>
  ...
  <LinkCard title="Consola do Cliente (CLI)" description="Cross-platform command-line tool." href="https://crowdin.github.io/crowdin-cli/" target="_blank" />
