...
<Image src={installPermissions} alt="Permissões" class="width-md m-auto crowdin-modal" />
...
<Image src={installPermissionsEnterprise} alt="Permissões" class="width-md m-auto" />
