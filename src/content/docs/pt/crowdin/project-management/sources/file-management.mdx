...
Cada vez que atualizares o ficheiro de origem, uma nova revisão é criada. To restore your file to the previous revision, click the number on the needed file in the *Revision* column. In the appeared dialog, select the revision you want to restore your file to and click **Restore** next to it.
