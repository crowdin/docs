...
<LinkCard title="Configuring CDN Distributions" description="Learn how to create distributions, manage releases, and check usage statistics." href="/cdn-distributions/" />
