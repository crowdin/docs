...
<Image src={languageMapping} alt="Mapeamento do Idioma" />

## Ver Também

<LinkCard title="Idiomas Compatíveis" description="Explore the list of languages supported by Crowdin." href="/developer/language-codes/" />
