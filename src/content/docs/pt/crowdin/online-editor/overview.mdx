...
<Aside>
  Make sure to enable [QA checks](/project-settings/qa-checks/) to help you find strings that require review. Os problemas encontrados serão destacados em vermelho nas frases traduzidas que requerem revisão.
</Aside>
...
Algumas frases podem conter formas plurais. Depending on the language, the number of plural forms may vary. For example, Chinese has one plural form, English has two plural forms, and other languages may have up to six plural forms. Crowdin works with plural forms according to the CLDR Language Plural Rules.
