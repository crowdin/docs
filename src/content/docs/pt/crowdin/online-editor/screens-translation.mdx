...
This view is enabled by a project manager in the project's [**Settings > General > Project Language Page View**](/project-settings/#project-language-page-view) section. When enabled, the screenshots will be displayed on the project's language page instead of the traditional file list.
...
* **Works with Mockups**: You can translate from static designs or mockups even before the application is built (e.g., using designs uploaded via the Crowdin plugins for [Figma](/figma-plugin/), [Sketch](/sketch-plugin/), or [Adobe XD](/adobe-xd-plugin/)), allowing localization to happen earlier in the development process.
...
<CardGrid>
  <LinkCard title="Capturas de Tela" description="Learn how managers can upload and tag screenshots." href="/screenshots/" />
  <LinkCard title="Plug-in para Figma" description="Learn how managers can upload tagged designs for translation directly from Figma." href="/figma-plugin/#uploading-tagged-screenshots-to-crowdin" />
  <LinkCard title="Definições do Projeto" description="Learn how managers configure the Language Page View to enable this feature." href="/project-settings/#project-language-page-view" />
