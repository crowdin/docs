...
<CardGrid>
  <LinkCard title="Pré-Tradução" description="Speed up the translation process and ease the work of translators." href="/pre-translation/" />
  <LinkCard title="Definições do Projeto" description="Configure machine translation settings for your project." href="/project-settings/machine-translation/" />
</CardGrid>
