---
title: Configurando integrações VCS Online
...
<Image src={configuringSpreadsheets} alt="Configurar Folhas de Cálculo" class="width-2xl crowdin-modal" />
...
<Image src={configuringXml} alt="Configurar Ficheiros XML" class="width-2xl crowdin-modal" />
