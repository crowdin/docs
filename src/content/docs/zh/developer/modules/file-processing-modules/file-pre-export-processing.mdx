  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <p><strong>Description:</strong> 用于文件导出前源字符串及其对应翻译的参数。 <code>strings</code> - 字符串数组。 <code>stringsUrl</code> - 包含字符串的 <a href="https://github.com/ndjson/ndjson-spec" target="_blank">换行符分隔 JSON</a> 的公共 URL。<br />可使用这两个参数中的任意一个。<Aside title="Limitations">最大请求载荷限制为 5 MB。</Aside></p>
      </td>
    </tr>
  </tbody>
</table>
