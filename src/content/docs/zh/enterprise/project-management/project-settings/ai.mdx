...
对于每个选项，您可以从下拉菜单中选择现有提示词，或点击 <Icon name="mdi:plus" class="inline-icon" /> 创建新的提示词。
...
* 点击提示词上的 <Icon name="mdi:dots-vertical" class="inline-icon" /> 可**使用提示词**（仅适用于**自动翻译和 AI 建议**提示词）、**编辑**、**克隆**或**删除**该提示词。
