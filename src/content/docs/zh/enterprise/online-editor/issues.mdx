...
为了更高效地处理问题，尤其是在大型或复杂项目中，您可以使用集成和自动化来扩展 Crowdin Enterprise 的功能：
...
* 使用 [Webhooks](/zh/webhooks/) 在 Crowdin Enterprise 中创建、更新、删除或恢复问题时触发自定义工作流。
* 使用 [Crowdin Enterprise API](/zh/developer/api/) 构建自定义问题处理自动化，例如将问题转发到内部工具或触发电子邮件提醒。
...
<Aside type="tip">
  您还可以通过 Zapier 将 Crowdin Enterprise 与 Trello、Asana、ClickUp 和 GitHub 等平台集成，将报告的问题转换为项目管理工具中的可执行任务。
</Aside>
