...
slug: zh-CN/enterprise/integrations
sidebar:
  label: 概述
  order: 0
---
...
<CardGrid>
  <LinkCard title="Figma" href="/zh/enterprise/figma-plugin/" />
  <LinkCard title="Sketch" href="/zh/enterprise/sketch-plugin/" />
  <LinkCard title="Adobe XD" href="/zh/enterprise/adobe-xd-plugin/" />
...
<Steps>
  1. 在您的 Crowdin Enterprise 项目中打开应用。
  2. 在访问限制页面上，点击**删除集成**。
</Steps>
...
<CardGrid>
  <LinkCard title="CDN 分发" href="/enterprise/cdn-distributions/" />
  <LinkCard title="Jira" href="/zh/enterprise/jira-integration/" />
  <LinkCard title="Google Play（谷歌应用商店）" href="/zh/enterprise/google-play-integration/" />
  <LinkCard title="Slack" href="/zh/enterprise/account-notifications/#slack-集成" />
</CardGrid>
