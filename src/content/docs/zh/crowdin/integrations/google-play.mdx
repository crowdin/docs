...
<Aside>
  您需要先在 Crowdin 账户中[安装 Google Play 集成](https://store.crowdin.com/google-play)，然后才能进行设置和使用。
</Aside>
...
<Steps>
  ...
  3. 可用的译文将根据配置的[导出选项](/zh/project-settings/export/)显示。 查看所有译文是否完好，并清除您不想发布的语言旁边的复选框。 点击**下一步**以继续。 <Image src={integrationSelectLanguages} alt="选择发布语言" class="width-lg" />
...
<Aside>
  出于安全原因，包含您的服务账号凭据的文件不会存储在 Crowdin 中，因此每次您想要将译文发布到 Google Play 时都需要上传此文件。
</Aside>
