...
<CardGrid>
  ...
  <LinkCard title="Crowdin Apps SDK" description="The framework for building a self-hosted Crowdin app that processes files." href="/zh/developer/crowdin-apps-sdk/" />
