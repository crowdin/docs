...
slug: zh-CN/project-settings/ai
sidebar:
  order: 9
  label: AI
---
...
<LinkCard title="配置 AI 提示词" href="/zh/crowdin-ai/#配置-ai-提示词" />

在项目设置中配置 AI 提示词之前，项目所有者还需要[配置 AI 提供商](/zh/crowdin-ai/#配置-ai-提供商)。
...
在默认提示词设置下方，**提示词**部分列出了项目可用的所有 AI 提示词。 此界面与您账户设置中的主提示词列表功能完全相同。

在此，您可以执行以下几项操作：

* 点击**添加提示词**以创建新提示词（该提示词将被添加到您的账户级别列表中）。
* 使用**搜索**字段和**筛选器**查找特定提示词。
* 点击提示词上的 <Icon name="mdi:dots-horizontal" class="inline-icon" /> 以**使用**（仅适用于**自动翻译与 AI 建议**提示词）、**编辑**、**克隆**或**删除**该提示词。
