...
## Processeur secondaire mises à jour

Avant d'engager des sous-processeurs, nous effectuons un contrôle préalable afin d'évaluer leurs pratiques en matière de confidentialité, de sécurité et de confidentialité, et nous signons un accord avec eux mettant en œuvre leurs obligations.

When we bring on a new vendor or other sub-processor who handles our Users' Personal Information, or remove a sub-processor, or we change how we use a sub-processor, we will update this page. Si vous avez des questions ou des préoccupations concernant un nouveau sous-processeur, nous serons heureux de vous aider. Aussi, si vous souhaitez être averti lorsque nous ajoutons un nouveau processeur secondaire, veuillez communiquer avec nous et nous vous ajouterons à la liste d’email. Please contact us at [privacy@crowdin.com](mailto:privacy@crowdin.com)
