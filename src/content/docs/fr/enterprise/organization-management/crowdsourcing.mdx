---
title: Production participative
...
<LinkCard title="Aperçu du flux de travail" href="/enterprise/workflows/" />
...
<LinkCard title="Set Up Custom Domain" description="Learn how to publish your Crowdin Enterprise organization on your own domain." href="/enterprise/organization-settings/#custom-domain" />
...
<CardGrid>
  <LinkCard title="Translation Goals app" description="With this app, you can set a goal for the number of translations you expect a volunteer to translate, and the app will suggest how many contributors you, as a manager, should find." href="https://store.crowdin.com/translation-goals" target="_blank" />
  <LinkCard title="Volunteer Certificates app" description="Motivate your community by offering official recognition. This app allows volunteers to generate verifiable certificates for their contributions, providing professional credentials for their translation and proofreading efforts." href="https://store.crowdin.com/volunteer-certificates" target="_blank" />
</CardGrid>
