---
title: Aperçu du flux de travail
...
<Steps>
  ...
  6. Connect steps in the order in which the content should flow between them. Steps can be connected in parallel or subsequently.
  7. (Optional) Add target languages to each step and assign contributors to them. This can be skipped when creating a template, as you might want to add different languages and assignees for different projects.
...
### Traduction par fournisseur API
