...
<img src={screenshotsTextRecognition.src} alt="Reconnaissance de texte" />
...
<Steps>
  1. Open the screenshot with a double click or right-click on the screenshot and select **Edit**.
  2. Trier et filtrer les chaînes listées. You can select all or specific files and search strings by text or context.
...
<CardGrid>
  <LinkCard title="Paramètres du projet" description="Configure your project's Language Page View to enable screenshot translation." href="/enterprise/project-settings/#project-language-page-view" />
