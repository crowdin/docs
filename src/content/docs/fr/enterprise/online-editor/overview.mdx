...
<LinkCard title="Éléments de syntaxe d'expressions" description="Learn how to build and use verbal expressions with practical examples." href="/enterprise/expression-syntax-elements/" />
