---
title: Autoriser les applications OAuth
...
### Paramètres {#request-authorization-code-parameters}
...
### Paramètres {#redirect-parameters}
...
### Paramètres {#refresh-token-parameters}
