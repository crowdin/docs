...
## Gestion de la localisation dans un projet unique

Traduire des fichiers iOS et Android dans un projet Crowdin. Use one of the options suggested below, depending on your project specifications.
