...
| Strength      | Visual Indicator | Statut       | Description                                                                                                             |
| :------------ | :--------------- | :----------- | :---------------------------------------------------------------------------------------------------------------------- |
...
<Image src={sudoModeConfirmingCredentials} alt="Confirmant des informations d'identification" class="width-md" />
...
<Image src={tokens} alt="Jetons d'accès personnels" />
