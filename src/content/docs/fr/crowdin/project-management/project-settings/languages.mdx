...
### Ajout de codes de langue personnalisés
...
<LinkCard title="Langues prises en charge" description="Explore the list of languages supported by Crowdin." href="/developer/language-codes/" />
