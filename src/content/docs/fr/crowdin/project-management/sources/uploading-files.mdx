...
<CardGrid>
  <LinkCard title="Importer des traductions existantes" description="Learn how to upload existing translations to your project." href="/uploading-translations/" />
  <LinkCard title="Gestion des fichiers" description="Manage and configure source files in your project." href="/file-management/" />
