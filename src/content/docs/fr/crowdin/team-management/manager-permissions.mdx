---
title: Permissions du gestionnaire
...
<Steps>
  ...
  3. In the appeared dialog, specify the manager’s email or username. <Image src={inviteManager} alt="Invite manager" class="width-lg crowdin-modal" />
...
<Steps>
  1. Open your profile home page and select **Managers** on the left sidebar.
  2. Click **Add Manager**. <Image src={managersSection} alt="Managers section" />
  3. In the appeared dialog, specify the manager’s email or username. <Image src={inviteManagerTm} alt="Invite manager" class="width-lg crowdin-modal" />
  4. (Optional) Enter a message your invitee will receive.
...
<Steps>
  ...
  3. In the appeared dialog, modify the manager’s permissions according to your preferences. <Image src={managersEditPermissions} alt="Edit permissions" class="crowdin-modal width-lg" />
  4. Click **Save**.
</Steps>
