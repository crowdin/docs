...
<CardGrid>
  <LinkCard title="Captures d'écran" description="Learn how managers can upload and tag screenshots." href="/screenshots/" />
  ...
  <LinkCard title="Paramètres du projet" description="Learn how managers configure the Language Page View to enable this feature." href="/project-settings/#project-language-page-view" />
