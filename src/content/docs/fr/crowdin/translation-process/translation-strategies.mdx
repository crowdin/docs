---
title: Stratégies de traduction
...
<CardGrid>
  <LinkCard title="Services Linguistiques Crowdin" description="Crowdin Language Services is a solution that allows you to order professional translations and proofreading services in a few clicks." href="/crowdin-language-services/" />
  <LinkCard title="Intégration BLEND" description="Integrate your Crowdin projects with the BLEND agency and allow BLEND translators to work with translation files in Crowdin Editor." href="/blend-integration/" />
</CardGrid>
