...
<LinkCard title="Continuous Fine-tuning" description="Automate the fine-tuning process with incremental updates to your AI models based on new translations in Crowdin projects." href="https://store.crowdin.com/continuous-fine-tuning" target="_blank" />
