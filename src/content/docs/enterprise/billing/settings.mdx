...
You can open the FastSpring account management page from Crowdin Enterprise: go to **Organization Settings > Billing** and click **Update payment details** in the **Payment Method** row.
