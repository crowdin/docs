...
import startToCreateProject from '!/enterprise/project-management/start_to_create_project.png';
...
<Steps>
  1. Open your organization's **Workspace**, hover over the <Icon name="mdi:plus" class="inline-icon" /> button at the bottom right, and select **Create a project**. <Image src={startToCreateProject} alt="Start to create a project" />
  1. Enter the project name. <Image src={provideProjectName} alt="Provide the project name" width="500" />
  1. Select the source language and target languages. The source language is the language you’re translating from, and the target languages are the ones you’re translating into. <Image src={chooseLanguages} alt="Choose the languages" width="500" />
  ...
  1. *(Optional)* Assign a workflow or [create a new one](/enterprise/workflows).
      ...
      Alternatively, remove the workflow to create a project without a workflow. <Image src={chooseWorkflow} alt="Choose a workflow" width="500" />
...
- [Uploading Files for Localization](/enterprise/uploading-files)
- [Uploading Existing Translations](/enterprise/uploading-translations)
- [Project Settings](/enterprise/project-settings)
- [Inviting People to Project](/enterprise/inviting-people)
