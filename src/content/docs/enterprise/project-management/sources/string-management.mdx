...
You can add strings directly to files that support [online editing](#formats-that-support-online-editing). This feature allows you to add new content without modifying source files outside Crowdin Enterprise.
...
<Steps>
  ...
  3. In the appeared dialog, enter the necessary details for the string:
      ...
      * *(Optional)* File-specific identifiers &ndash; specify unique keys for each file format when adding the string to multiple files, as formats may have different identifier requirements.
