...
* Use [CLI](https://crowdin.github.io/crowdin-cli/commands/crowdin-branch) or [API](/developer/api/) to add new branches.
...
To create a branch via API, use the [Add Branch](/developer/enterprise/api/v2/#operation/api.projects.branches.post) method.
