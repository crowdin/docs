...
After uploading a translation file, a summary appears with the results of the import. Depending on the file content and your project settings, you may see one of the following outcomes:
...
* **Partially imported** – Some translations were imported, while others were skipped. The summary lists the specific reasons for skipped translations, such as being identical to the source text, hidden strings, or failed QA checks. If translations were skipped due to QA issues, the summary provides a detailed breakdown of each QA issue type (e.g., *Duplicate translation*, *Numbers mismatch*, etc.) based on the QA checks configured in [**Settings > QA Checks**](/enterprise/project-settings/qa-checks/#qa-check-parameters).
* **All translations skipped** – None of the translations were imported. The summary provides a detailed list of reasons. For failed QA checks, you'll see a breakdown of the specific issues that caused the translations to be skipped.
