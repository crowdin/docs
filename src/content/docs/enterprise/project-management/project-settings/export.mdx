...
import exportSettings from '!/enterprise/project-management/settings/export_settings.png';

By default, when exporting translations, Crowdin Enterprise fills untranslated strings with source text to avoid exporting empty files. You can change this behavior in the project settings.
