...
import sourceStrings from '!/enterprise/project-management/settings/source_strings.png';
import assignCustomPlaceholder from '!/enterprise/project-management/settings/custom_placeholders_assign.png';

## Source Strings

Learn how to optimize your Crowdin Enterprise project by unifying placeholders, handling duplicate strings, and configuring word counts. These settings will help improve translation consistency and streamline your workflow.
...
<Steps>
  ...
  1. Click **Save**. <Image src={assignCustomPlaceholder} alt="Assign Custom Placeholder" width="600" />
</Steps>
