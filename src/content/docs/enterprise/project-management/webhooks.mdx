...
<Aside title="Permissions">
  To manage webhooks in a project, you must have the Admin, Group/Project Manager, or Translation Requestor / Developer role. See [Inviting People](/enterprise/inviting-people/) for more information.
</Aside>
