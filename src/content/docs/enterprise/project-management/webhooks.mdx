...
* The URL where the callback should be sent. Redirects for webhook URLs are not supported. The endpoint must respond directly to Crowdin Enterprise’s request.
