...
To configure webhooks in Crowdin Enterprise, open your project and go to **Tools** > **Webhooks** on the left panel. Click **Create** to start configuring your new webhook.
