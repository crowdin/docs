...
To personalize your workspace in the Editor, you can reorder the sections in the right panel (e.g., AI Assistant, Context & Translations, Comments, etc.) by dragging their icons.
