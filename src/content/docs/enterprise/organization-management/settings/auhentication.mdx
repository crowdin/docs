...
<Steps>
  1. Click on the user icon in the top menu bar and select **Organization Settings**. <Image src={organizationSettingsMenuItem} alt="Organization Settings Menu Item" />
...
<Steps>
  1. Click on the user icon in the top menu bar and select **Organization Settings**.
  2. Switch to the **Authentication** page on the left menu bar.
