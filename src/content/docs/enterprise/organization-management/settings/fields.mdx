...
import { Steps, Icon, LinkCard } from '@astrojs/starlight/components';
...
<Steps>
  ...
  2. Click **New field**. <Screenshot src="/organization-management/fields_add_new.png" alt="New Field" enterprise />
  ...
  4. Click **Save**. <Screenshot src="/organization-management/fields_details.png" alt="Field Details" enterprise />
</Steps>

## Managing Fields via API

Fields can be created using API methods from the [Fields category](https://developer.crowdin.com/enterprise/api/v2/#tag/Fields).

Once a field is created, you can use it with the preconfigured entities with the Patch and Get API methods:

* [List Projects](https://developer.crowdin.com/enterprise/api/v2/#operation/api.projects.getMany)
* [Edit Project](https://developer.crowdin.com/enterprise/api/v2/#operation/api.projects.patch)
* [List Tasks](https://developer.crowdin.com/enterprise/api/v2/#operation/api.projects.tasks.getMany)
* [Edit Task](https://developer.crowdin.com/enterprise/api/v2/#operation/api.projects.tasks.patch)
* [List Users](https://developer.crowdin.com/enterprise/api/v2/#operation/api.users.getMany)
* [Edit User](https://developer.crowdin.com/enterprise/api/v2/#operation/api.users.patch)
* [List Files](https://developer.crowdin.com/enterprise/api/v2/#operation/api.projects.files.getMany)
* [Edit File](https://developer.crowdin.com/enterprise/api/v2/#operation/api.projects.files.patch)
* [List Strings](https://developer.crowdin.com/enterprise/api/v2/#operation/api.projects.strings.getMany)
* [Edit String](https://developer.crowdin.com/enterprise/api/v2/#operation/api.projects.strings.patch)
...
Below you can view the list of supported entities and their respective locations the fields can be added to. Locations marked with <Icon name="approve-check" class="inline-icon" /> icon in the Editable column provide a possibility for users to edit field values there.
...
<Screenshot src="/organization-management/fields_project_labels.png" alt="Fields in the UI" enterprise />

---

<LinkCard
  title="Seeking Assistance"
  description="Need help working with Fields or have any questions? Contact Support Team"
