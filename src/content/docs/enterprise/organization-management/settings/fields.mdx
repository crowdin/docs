...
import fieldsAddNew from "!/enterprise/organization-management/fields_add_new.png";
...
<Steps>
  ...
  2. Click **New field**. <Image src={fieldsAddNew} alt="New Field" />
  ...
  4. Click **Save**. <Image src={fieldsDetails} alt="Field Details" />
</Steps>
