...
You can manage Custom QA checks in the **Organization Settings**. There are two possible ways to add new Custom QA checks in your organization: create your own custom QA checks specifying a code snippet from scratch or add them from the Crowdin [Store](https://store.crowdin.com/).
...
<Steps>
  ...
  1. Switch to the **Custom QA checks** page on the left menu bar and click **Create custom QA check**.
...
| `sourceLanguage`                 | [Crowdin’s code](https://developer.crowdin.com/language-codes/) for the project source language                                |
| `targetLanguage`                 | [Crowdin’s code](https://developer.crowdin.com/language-codes/) for the project target language                                |
| `source`                         | Source text                                                                                                                    |
