...
In the **Public Organization** section, you can manage how your organization is presented to the public. Add a public description, select the preferred project view (List or Grid), and choose up to six featured projects to showcase on your organization's public page.

A public page is automatically created once you publish at least one project with the Crowdsourcing workflow step. This public page is visible to volunteer translators or anyone with the link, providing an overview of your organization’s work.
...
Manage agents for custom applications that interact with Crowdin Enterprise. Agents allow applications to perform specific actions on your behalf within the platform. Control and adjust agent permissions to limit or extend the application’s access as needed.
