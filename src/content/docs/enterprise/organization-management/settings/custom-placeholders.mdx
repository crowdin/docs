...
<Steps>
  ...
  1. In the appeared dialog, specify a custom placeholder expression using the Expressions syntax elements and click **Create**. <Image src={customPlaceholderExpression} alt="Custom Placeholder Expression" width="600" />
</Steps>
