...
<Steps>
  ...
  2. Switch to the **Vendors** tab and click **Invite** on the Gengo vendor. <Image src={storeInviteVendor} alt="Invite vendor dialog" />
  3. Go back to your organization's **Workspace**, select **Vendors** on the left sidebar, and click on Gengo.
