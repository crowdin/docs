...
<Image src={configuringTranslationByVendor} alt="Configuring Translation by Vendor" width="300" class="m-auto" />
...
<Image src={configuringProofreadingByVendor} alt="Configuring Proofreading by Vendor" width="300" class="m-auto" />
