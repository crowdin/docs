...
* **Input** – Select which strings will be available for translation by the vendor.
    ...
    * **Untranslated or auto-translated strings** – Sends all strings that do not have translations added by a person (i.e., untranslated strings and strings translated by AI, MT, or TM).
