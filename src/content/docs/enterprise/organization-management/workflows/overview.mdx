...
The AI Auto-Translation step uses advanced AI models to auto-translate your content. Unlike other auto-translation methods, AI Auto-Translation considers context at multiple levels, resulting in improved translation quality. You can integrate AI models from providers like OpenAI, Google Gemini, Microsoft Azure OpenAI, and more. Similar to MT Auto-Translation, you can select specific AI prompts for the languages you want to auto-translate. This step reduces manual translation efforts and helps maintain consistency across your project.
