...
To get started, open your project and select **Crowdsourcing** on the left sidebar. In the *General* section, you can change the public project name, logo, and description. You can also change the public project URL, which you'll share with the community.
