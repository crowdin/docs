...
Once you’ve configured all Crowdsourcing project settings, click **Publish** to make your project public and visible on your [organization's public page](#public-organization-settings).
