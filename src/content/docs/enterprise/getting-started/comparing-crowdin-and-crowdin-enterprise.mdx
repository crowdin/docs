...
* **Crowdin:** AI features are managed at the **user-account level** from the owner's personal profile. Key features include AI pre-translation, in-editor AI suggestions, and AI-powered QA checks.
