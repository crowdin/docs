...
To access the AI Assistant, click on the AI Assistant tab in the right sidebar of the Editor.

<Aside>
  If the AI Assistant tab is not displayed in the Editor, it means that Crowdin AI has not been configured for the project yet. Contact the project owner for more details on the matter.
</Aside>
