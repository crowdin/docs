...
<div style="margin-top: 1.5rem; position: relative; width: 100%; height: 0; padding-bottom: 56.25%; box-shadow: 0 5px 20px rgb(0 0 0 / 10%); border-radius: 6px;overflow:hidden;">
  <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" height="100%" width="100%" src="https://www.youtube.com/embed/rmlI3QtpAbA" allow="autoplay; encrypted-media"></iframe>
</div>
