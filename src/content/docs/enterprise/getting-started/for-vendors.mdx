...
To check the resources available for the project, open the needed project and go to **Settings > Translation memories** or **Settings > Glossaries**.
...
Client labels are shared with your project when they are assigned to strings your workflow step holds. You can filter by them in the **Sources** section, when creating tasks, and in reports. Shared labels carry the **Shared** badge and are managed by the client.

You can also create your own labels and use them alongside the shared ones.

<ReadMore>
  Read more about [Label Settings](/enterprise/project-settings/labels/).
</ReadMore>
