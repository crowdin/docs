...
<LinkCard
  ...
  href="/enterprise/account-settings/#notifications"
/>
...
<Steps>
  1. In the upper-right corner, click on your profile picture and select **Account Settings**.
  2. In the *Notifications* section select **Slack**, then click **Connect**.
...
* Pass information to the third-party services with the specific request requirements (e.g., сontent type, headers, payload).
...
<Steps>
  1. Open your **Account Settings** and go to the **Notifications** page.
...
Optionally, you can add special headers to your custom notifications. They can be used for additional security, as an authorization method, and more. For example, if you add headers, your custom notification endpoint can verify them and ensure that information is coming from Crowdin Enterprise.
...
<Image src={customNotificationsSetUp} alt="Setting Up Custom Notifications" />
...
<ReadMore>
  Read more about [IP Addresses](https://developer.crowdin.com/ip-addresses).
</ReadMore>

### Custom Payloads

You can modify the custom notification payload to add and organize the elements the way your system requires. To get informative and user-friendly notifications, make sure to include the `{{notification-message}}` placeholder in your payload.
...
#### Configuring Custom Notifications Channel {#configuring-custom-notifications-channel-discord}

<Steps>
  1. Open your **Account Settings > Notifications**.
  1. Click **Custom notifications**.
  ...
  1. Paste the following payload in the **Payload** field:
      ...
      ```
  1. Click **Test notification** to receive a test message from Crowdin Enterprise to your Discord channel.
  1. Once finished with the configuration, click **Save**.
</Steps>

### Configuring for Google Chat
...
#### Configuring Custom Notifications Channel {#configuring-custom-notifications-channel-google-chat}
...
<Steps>
  ...
  1. Paste the following payload in the **Payload** field:
      ...
      ```
  1. Click **Test notification** to receive a test message from Crowdin Enterprise to your Google Chat channel.
  1. Once finished with the configuration, click **Save**.
</Steps>
...
#### Configuring Custom Notifications Channel {#configuring-custom-notifications-channel-microsoft-teams}
...
<Steps>
  ...
  1. Paste the following payload in the **Payload** field:
      ...
      ```
  1. Click **Test notification** to receive a test message from Crowdin Enterprise to your Microsoft Teams channel.
  1. Once finished with the configuration, click **Save**.
</Steps>
...
#### Configuring Custom Notifications Channel {#configuring-custom-notifications-channel-telegram}
...
<Steps>
  ...
  1. Click **Test notification** to receive a test message from Crowdin Enterprise to your Telegram channel.
  1. Once finished with the configuration, click **Save**.
</Steps>
...
<Steps>
  ...
  1. In Crowdin Enterprise, open your **Account Settings** and go to the **Notifications** tab.
  1. Click **Custom notifications**.
