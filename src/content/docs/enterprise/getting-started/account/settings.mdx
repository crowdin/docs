...
To reorder the menu items, hover over <Icon name="material-symbols:drag-indicator" class="inline-icon" /> next to the item you want to move, then click and drag it to the preferred position in the list.

### Toggling Item Visibility

To hide or show a menu item, clear the checkbox next to its name to hide it, or select it to make it visible.

<Aside>
  The **Workspace** item is always displayed and can't be hidden. Content in hidden items remains safe and accessible.
</Aside>
