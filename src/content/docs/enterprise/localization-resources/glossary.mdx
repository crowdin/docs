...
import assigning from '!/enterprise/localization-resources/glossary_assigning.png';
import changingDefaultGlossary from '!/enterprise/localization-resources/glossary_changing_default_glossary.gif';
...
<Steps>
  ...
  2. Select the needed glossaries from the list. <Image src={assigning} alt="Assigning Glossary" width="744px" />
</Steps>
...
<Steps>
  1. Open your project and go to **Settings > Glossaries**.
  2. Click the star icon next to the needed glossary in the list. <Image src={changingDefaultGlossary} alt="Changing Default Glossary" width="744px" />
</Steps>
