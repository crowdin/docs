...
By default, all glossary concepts and terms are displayed in the Concepts and Terms pages.
...
To filter the concepts or terms displayed, click <Icon name="mdi:filter-variant" class="inline-icon" /> and use the available filter options:
