...
Auto-translation via TM allows you to leverage a configurable (40% to 100% match ratio) and Perfect matches.
...
<Aside type="tip">
  You can also [configure the TM Auto-Translation workflow step](/enterprise/workflows/#tm-auto-translation) for new content in your project.
</Aside>
...
Once you enable the TM auto-substitution, you can leverage improved TM suggestions during [auto-translation](/enterprise/auto-translation/). Be sure to set a minimum match ratio to 100%. This will result in including 100% TM matches along with the ones improved to 100% by TM auto-substitution.
