...
import prioritizingTm from '!/enterprise/localization-resources/tm_prioritizing_tm.png';
import changingDefaultTm from '!/enterprise/localization-resources/tm_changing_default_tm.gif';
...
import assigningTm from '!/enterprise/project-management/settings/tm_assigning.png';
...
<Steps>
  ...
  6. Click **Save**. <Image src={addTranslationUnitDialog} alt="Add Translation Unit Dialog" width="600px" />
</Steps>
...
<Steps>
  1. Open your project and go to **Settings > Translation memories**.
  2. In the **Priority** column, set the preferred priority for assigned TMs. <Image src={prioritizingTm} alt="Prioritizing TM" />
</Steps>
...
<CardGrid>
  <LinkCard
    title="Read more about how TM matches are calculated"
...
<Steps>
  1. Open your project and go to **Settings > Translation memories**.
  2. Select **Auto-Substitution** in the **Translation memories** section. <Image src={tmSettings} alt="Translation Memory Settings" width="744px" />
</Steps>

### Auto-substitution for Pre-translation

Once you enable the TM auto-substitution, you can leverage improved TM suggestions during [pre-translation](/pre-translation). Be sure to set a minimum match ratio to 100%. This will result in including 100% TM matches along with the ones improved to 100% by TM auto-substitution.
