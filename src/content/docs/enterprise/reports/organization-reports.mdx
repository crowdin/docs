...
import addCustomRatesTranslationCost from '!/enterprise/reports/organization_reports_translation_cost_add_custom_rates.png';
...
The Organization Summary section provides a comprehensive visual analysis of your organization's translation progress using the following graphs: Translation activity, Proofreading activity, Source strings activity, and Translation savings.

There are four periods available: Last week, Last 30 days, Last 24 hours, and Last year. The graphs are generated based on the text unit type selected for the **Organization Size** section.
...
- [Project Reports](/enterprise/project-reports)