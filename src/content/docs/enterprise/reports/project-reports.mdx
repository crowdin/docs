...
import overview from '!/enterprise/reports/project_reports_overview.png';
import sourceStringActivity from '!/enterprise/reports/project_reports_source_string_activity.png';
...
import addIndividualRates from '!/enterprise/reports/reports_cost_estimate_add_individual_rates.png';
...
import addMtMatchType from '!/enterprise/reports/reports_translation_cost_add_mt_match_type.png';
import addIndividualRatesTranslationCost from '!/enterprise/reports/reports_translation_cost_add_individual_rates.png';
import translationCostGenerated from '!/enterprise/reports/reports_translation_cost_generated.png';
import preTranslationEfficiencyGenerated from '!/enterprise/reports/reports_pre_translation_efficiency_generated.png';
import topMembersSorted from '!/enterprise/reports/project_reports_top_members_sorted.png';
import archiveViewing from '!/enterprise/reports/project_reports_archive_viewing.png';

To view your project status along with existing issues, assess the effectiveness of pre-translation methods, estimate and count the translation cost, keep track of the most active members, and view historical data of previously generated reports, open your project and go to the **Reports** tab.
...
<Image src={overview} alt="Project Reports Overview" />

*QA check issues* are defined by QA checks parameters configured in the project's [Settings > Quality assurance](/project-settings/qa-checks). QA issues can be checked and resolved by proofreaders in the [Editor](/online-editor).
...
You can find all unresolved issues in the [Editor](/online-editor) using the *With Unresolved Issues* filter option.

<div class="alert alert-info">
  <b>Note:</b> Wrong translation issues belong to both <i>QA check</i> and <i>Unresolved</i> issues.
</div>
...
- *Translation Activity* &ndash; the general number of all translated texts along with separate numbers of translations done with Machine Translations (MT) and Translation Memory (TM)
- *Proofreading Activity* &ndash; the exact numbers of all approvals and votes
...
<Image src={sourceStringActivity} alt="Source String Activity" />

Click on the parameter title to hide a section from the graph and to bring it back when needed. Use this option to analyze just specific parameters on the graph. You can also highlight a specific section on the graph by hovering over the parameter title.
...
* **Total** &ndash; general cost estimate for all languages.
* **Subtotals** &ndash; cost estimate for each language which includes TM savings, translations and proofreading costs.
...
To download the Pre-translation Efficiency report, click **Export** and select the preferred export format (CSV, XLSX, or JSON).

<Image src={preTranslationEfficiencyGenerated} alt="Pre-translation Efficiency Generated" />

## Contribution Raw Data Report

In addition to the Translation Cost report, which is based on the Contribution Raw Data and grouped by languages, you can retrieve this detailed contribution raw data using the [Generate Report](https://developer.crowdin.com/enterprise/api/v2/#operation/api.projects.reports.post) (Contribution Raw Data schema) or via the [Raw Report Data](https://store.crowdin.com/raw-report) app available on the Crowdin Store. This allows you to generate your own custom report according to your specific requirements.
...
<table>
  ...
  <tr>
    ...
    <td>
      <p><strong>Type:</strong> <code>integer</code></p>
      <p>The highest match value of the translation with other TM suggestions, if any.<br/>Read more about [TM Match Calculation](/enterprise/translation-memory/#tm-match-calculation).</p>
    </td>
  </tr>
  <tr>
...
<CardGrid>
  <LinkCard
    title="AI Section (File-based)"
    description="Manage Reports Archive using API methods."
    href="https://developer.crowdin.com/enterprise/api/v2/#tag/Reports"
    target="_blank"
  />
  <LinkCard
    title="AI Section (String-based)"
    description="Manage Reports Archive using API methods."
    href="https://developer.crowdin.com/enterprise/api/v2/string-based/#tag/Reports"
    target="_blank"
  />
</CardGrid>
...
- [Organization Reports](/enterprise/organization-reports)
