...
*QA check issues* are defined by QA checks parameters configured in the project's [Settings > Quality assurance](/enterprise/project-settings/qa-checks/#configure-qa-checks). QA issues can be checked and resolved by proofreaders in the [Editor](/enterprise/online-editor).
...
You can find all unresolved issues in the [Editor](/enterprise/online-editor) using the *With Unresolved Issues* filter option.
...
#### Adding Individual Rates {#individual-rates-cost-estimate}
...
#### Adding Individual Rates {#individual-rates-translation-cost}
...
Besides UI, you can also manage Reports Archive using the API methods from the Reports sections:

<CardGrid>
  <LinkCard
    title="Manage Reports Archive using API methods (File-based)"
    href="https://developer.crowdin.com/enterprise/api/v2/#tag/Reports"
    target="_blank"
  />
  <LinkCard
    title="Manage Reports Archive using API methods (String-based)"
