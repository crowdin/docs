...
*QA check issues* are defined by QA checks parameters configured in the project's [Settings > Quality assurance](/enterprise/project-settings/qa-checks/#configure-qa-checks). QA issues can be checked and resolved by proofreaders in the [Editor](/enterprise/online-editor/#for-proofreaders).
...
There are four periods available: Last week, Last 30 days, Last 24 hours, and Last year. The graphs are generated based on the text unit type selected for the **Project Size** section.
...
* Time period: All time, Today, Yesterday, Last 7 days, Last 30 days, or Custom range.
* Files: All files (including deleted) or Selected files (excluding deleted).
* Language: All or specific target language.
* Users: one or a few specific users.
