...
* **Use category-based approval rates:** Calculates proofreading costs by treating approvals as submitting an identical translation at the 100% match rate of the corresponding [Net Rate Scheme](#net-rate-schemes-my-activity) category (TM, MT, AI, or Other). When disabled, all approvals use the flat base proofread rate.
