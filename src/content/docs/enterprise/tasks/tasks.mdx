...
<Steps>
  1. Open your project and select **Tasks** on the left sidebar.
  1. In the **Board** or **All tasks** section, click <Icon name="mdi:dots-vertical" class="inline-icon" /> (or right-click) on the task you want to change and select **Edit**. Alternatively, open the task and select **Edit** from the <Icon name="mdi:dots-vertical" class="inline-icon" /> menu in the upper-right corner of the task details view.
