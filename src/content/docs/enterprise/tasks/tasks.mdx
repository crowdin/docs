...
### Auto-translating Task Content

You can apply auto-translation to the strings included in a translation task. Open the task, click <Icon name="mdi:dots-vertical" class="inline-icon" /> in the upper-right corner, and select **Auto-Translate**. The task defines both the strings to process and the target language.

<ReadMore>
  Read more about [Auto-Translation](/enterprise/auto-translation/#auto-translating-task-content).
</ReadMore>
