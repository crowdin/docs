...
Once you open your project and select **Members** on the left sidebar, you can view and search for project members.
...
By default, all project members are displayed in the **Members** section. To filter members displayed, click <Icon name="mdi:filter-variant" class="inline-icon" /> and use the available filter options:
