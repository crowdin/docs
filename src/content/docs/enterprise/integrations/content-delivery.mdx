...
<Steps>
  ...
  1. Click **Next**.
  1. Copy <Icon name="material-symbols:file-copy" class="inline-icon" /> the distribution hash so that you can use it for integration.
...
<Aside>
  The CDN caches all the translations in release for up to 1 hour, and even when new translations are released in Crowdin Enterprise, the CDN may return them with a delay.
</Aside>
