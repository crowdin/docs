...
<Aside>
  ...
  - [Bitbucket integration](https://store.crowdin.com/bitbucket) &ndash; for repositories hosted on Bitbucket Cloud.
  - [Bitbucket Server & Data Center integration](https://store.crowdin.com/bitbucket-server) &ndash; for a self-hosted Bitbucket instance.
</Aside>
