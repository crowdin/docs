...
<Aside>
  ...
  - [GitLab integration](https://store.crowdin.com/gitlab) &ndash; for repositories hosted on GitLab.com.
  - [GitLab Self-Managed integration](https://store.crowdin.com/gitlab-server) &ndash; for a self-hosted GitLab instance.
</Aside>
