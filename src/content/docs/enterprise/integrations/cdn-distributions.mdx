...
In the **CDN Distributions** usage section, you can see the total amount spent during the current billing cycle (one month). This includes a detailed breakdown of requests and data transfer with their respective prices. CDN usage fees are included in your primary Crowdin Enterprise subscription and charged during the next billing cycle.
