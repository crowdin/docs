...
Managers can also invite Translation Requestor/Developers, who will gain similar permissions but cannot further invite other users to manage the app. Admin and Owner roles can also be invited with full permissions.
