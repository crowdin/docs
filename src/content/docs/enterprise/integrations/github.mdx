...
<Aside>
  Before setting up the integration in your Crowdin Enterprise organization, install the one that fits your setup:

  - [GitHub integration](https://store.crowdin.com/github) &ndash; for repositories hosted on GitHub.com.
  - [GitHub Enterprise integration](https://store.crowdin.com/github-server) &ndash; for a self-hosted GitHub Enterprise instance.
</Aside>
