...
If you don't want some files to be translated, click **Add ignored pattern**, specify the pattern for those files, and Crowdin Enterprise will not upload those files for translation.
...
<Steps>
  1. Click **Save Changes** to preview the created configuration. <Image src={filesListFilter} alt="Save configuration"  width="600" />
