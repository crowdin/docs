...
<Steps>
  ...
  3. In the appeared dialog, set the prompt parameters:
      * Select **Enabled**
      * Select the prompt type (i.e., Pre-translate, AI in editor, Alignment (available only for the Business [subscription plan](https://crowdin.com/pricing#enterprise-plans)), or Create custom type)
