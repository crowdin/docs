...
<Steps>
  ...
  4. Choose your credential type:
      * To use the [Managed by Crowdin service](/enterprise/crowdin-managed-services/), select **\{Provider} managed by Crowdin**. In this case, you'll need to [add funds to your account balance](#adding-funds-to-account-balance).
