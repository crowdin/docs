...
<Steps>
  ...
  3. In the appeared dialog, set the prompt parameters:
      ...
      * Visibility &ndash; Select projects where a prompt can be used:
          ...
          * Selected Projects &ndash; The prompt is available only in the projects you select. If no projects are selected for the Selected Projects option, the prompt will not be available in any project.
      <Aside type="tip">
