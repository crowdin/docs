...
import promptActions from '!/enterprise/translation-process/crowdin_ai_prompt_actions.png';
import configuringProvider from '!/enterprise/translation-process/crowdin_ai_configuring_provider.png';
import topUpBalance from '!/enterprise/translation-process/crowdin_ai_top_up_balance.png';
import aiSettings from '!/enterprise/translation-process/crowdin_ai_settings.png';
...
import addingPromptProjectSettings from '!/enterprise/translation-process/crowdin_ai_adding_prompt_project_settings.png';
import aiPreTranslate from '!/enterprise/translation-process/crowdin_ai_pre_translate_ai.png';
...
<Steps>
  ...
  3. In the appeared dialog, set the prompt parameters:
      ...
      * Additional context (Basic mode) &ndash; specify which data will be included in the prompt using the following fields:
          ...
          * File context &ndash; allows AI to consider a textual description of the file added in the file settings. <ReadMore>Read more about [File context](/enterprise/file-management/#file-context).</ReadMore>
...
<Image src={promptActions} alt="AI Prompt Actions" />
...
<Image src={configuringProvider} alt="Configuring AI Provider" width="600px" />
...
**Prompt to be used in editor** &ndash; select the default AI prompt that will be used in the Editor for all projects in your organization. If needed, this default setting can be overridden for each project individually in the project's **Settings > AI > Settings**.
...
<Steps>
  ...
  2. Click **Pre-translation** and select **via AI**. <Image src={aiPreTranslate} alt="Pre-translate via AI" />
...
<Image src={aiEditorSettings} alt="Configuring AI Prompts in Project Settings" width="500" />
...
<Image src={addingPromptProjectSettings} alt="Configuring AI Prompts in Project Settings" />

Besides configuring prompts in the project settings, you can also change the [default AI settings](#ai-settings-for-the-organization) applied from the porganization's AI settings.
...
<CardGrid>
  <LinkCard
    ...
    description="Manage AI Providers and AI Prompts using API methods."
    href="https://developer.crowdin.com/enterprise/api/v2/#tag/AI"
  />
  <LinkCard
    title="AI Section (String-based)"
    description="Manage AI Providers and AI Prompts using API methods."
    href="https://developer.crowdin.com/enterprise/api/v2/string-based/#tag/AI"
  />
</CardGrid>
