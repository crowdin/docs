...
Besides UI, you can also manage AI Providers and AI Prompts using the API methods from the AI sections:

<CardGrid>
  <LinkCard
    title="Managing AI using API methods (File-based)"
    href="https://developer.crowdin.com/enterprise/api/v2/#tag/AI"
    target="_blank"
  />
  <LinkCard
    title="Managing AI using API methods (String-based)"
