...
description: Manage your Crowdin Enterprise projects using natural-language AI commands.
slug: enterprise/crowdin-mcp-server
sidebar:
  order: 1
---
...
### Configuring MCP Client for Agentic AI

To set up the MCP client in Agentic AI, follow these steps:

<Steps>
  1. Open your project and select a language.
  2. Open the necessary file in the Editor.
  3. Click on the Agentic AI section in the right panel.
  4. Click <Icon name="mdi:cog" class="inline-icon" /> in the upper-right corner to open the Agentic AI settings.
...
1.  **Add New Source Files:** When a new feature is ready, the developer adds the source text files to the localization project.
  ```
