...
<Steps>
  ...
  1. Click **Pre-translation** and select the preferred method (i.e., via Translation Memory, via Machine Translation, or AI). <Image src={preTranslateMethod} alt="Pre-Translation Method" width="400px" />
