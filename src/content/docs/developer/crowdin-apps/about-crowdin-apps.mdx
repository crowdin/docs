...
description: Build apps for all the teams already using Crowdin or Crowdin
...
import developerHero from '~/assets/images/crowdin-developer-bg@2x.png';
import integratingWithCrowdin from '~/assets/images/crowdin_apps_integrating_with_crowdin.svg';

<Image src={developerHero} alt="Crowdin Developer" class="hero-image-bg absolute top-0 right-0 -z-50 no-shadow !w-6/12 xl:!w-4/12 md:!max-w-[480px] xl:!max-w-[1020px] invisible lg:visible opacity-80" />
