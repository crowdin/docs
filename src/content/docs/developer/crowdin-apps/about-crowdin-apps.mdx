...
import heroImage from '~/assets/images/crowdin-developer-bg@2x.png';
import integratingWithCrowdin from '~/assets/images/crowdin_apps_integrating_with_crowdin.svg';

<Image
  src={heroImage}
  alt="Crowdin Developer"
  class="absolute top-0 right-0 -z-50 no-shadow !max-w-lg 2xl:!max-w-2xl invisible lg:visible opacity-80"
/>
