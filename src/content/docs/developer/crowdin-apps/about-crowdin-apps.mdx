...
hero:
  ...
  image:
    html: <img src="/src/assets/images/crowdin-developer-bg@2x.png" class="hero-image-bg absolute top-0 right-0 -z-50 no-shadow !w-6/12 xl:!w-4/12 md:!max-w-[480px] xl:!max-w-[1020px] invisible lg:visible opacity-80" />
...
import integratingWithCrowdin from '~/assets/images/crowdin_apps_integrating_with_crowdin.svg';
...
<Image src={integratingWithCrowdin} alt="Integrating with Crowdin Diagram" class="no-shadow" />
...
<CardGrid>
  <LinkCard
    title="API Reference (File-based)"
    description="crowdin.com"
    href="/developer/api/v2/"
    target="_blank"
  />
  <LinkCard
    title="API Reference (String-based)"
    description="crowdin.com"
  ...
  <LinkCard
    title="API Reference (File-based)"
    description="Crowdin Enterprise"
