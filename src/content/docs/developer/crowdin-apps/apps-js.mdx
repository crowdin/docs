...
<table>
  ...
  <tr>
    ...
    <td>
      The event emitted when a source asset file is selected in the Editor.<br/>
      <div>
        ```json
        {
          "project_id": "15",
  ...
  <tr>
    ...
    <td>
      The event emitted when a suggestion asset file is selected in the Editor.<br/>
      <div>
        ```json
        {
          "project_id": "15",
          ...
          "editor": {
            ...
            "task_id": null,
            "file": 26574,
            "fileData": { // Contains detailed information about the asset file
            }
          },
          "suggestion": { // Contains detailed information about the asset suggestion
          }
        }
        ```
      </div>
