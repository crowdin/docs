...
An AI coding agent can [build the app for you](/developer/crowdin-apps-quick-start/), or you can run the CLI yourself. The CLI scaffolds the app, runs it locally, and publishes it.
