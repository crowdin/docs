...
The GraphQL API limit is quite different compared to the rate limits set for [REST API](https://developer.crowdin.com/api/v2/#section/Introduction/Rate-Limits).
