...
* [Branch fully translated](#branch-fully-translated) &ndash; all content in a branch is translated into one of the target languages
* [Branch fully reviewed](#branch-fully-reviewed) &ndash; all translations in a branch are approved for one of the target languages
