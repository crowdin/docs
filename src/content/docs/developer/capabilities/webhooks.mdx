...
To configure webhooks for your project, follow these steps:

<Steps>
  1. Open your project and go to the **Tools** tab.
  2. Click on **Webhooks** in the Tools list.
</Steps>

To configure webhooks for your Crowdin account, follow these steps:

<Steps>
  1. Open your **Account Settings** and go to the **Webhooks** tab.
  2. In the **Webhooks** section, click **Add Webhook**.
</Steps>

To configure webhooks for your Crowdin Enterprise organization, follow these steps:

<Steps>
  1. Open your **Organization Settings** and select **Webhooks** on the left sidebar.
  2. On the **Webhooks** page, click **Create**.
</Steps>

- [Crowdin](/webhooks/)
- [Crowdin Enterprise](/enterprise/webhooks/)
