...
import editor from '!/developer/in_context_editor.png';
...
<Image src={editor} alt="In-Context Editor" />

## Quick Demo

<div style="margin-top: 1.5rem; position: relative; width: 100%; height: 0; padding-bottom: 56.25%; box-shadow: 0 5px 20px rgb(0 0 0 / 10%); border-radius: 6px;overflow:hidden;"><iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" height="100%" width="100%" src="https://www.youtube.com/embed/ktfw7UsW3qw" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe></div>
...
<Image src={tab} alt="In-Context Tab" />
<Image src={tabE} alt="In-Context Tab" />

<Aside>
  If you use CSP, ensure to add the following rules to the policy: for loading the In-Context resource files, for CORS requests to &lt;organization_domain&gt;.crowdin.com
</Aside>
...
<table>
  ...
  <tr>
    <td>status_obj</td>
    <td>Object. The <i>status_obj.status</i> may be "ok", "error" or "corrected".
    In case of error, <i>status_obj.message</i> contains error description.
    When status is "corrected", <i>status_obj.correction</i> contains the corrected translation</td>
  </tr>
</table>
...
<QuestionAnswer title="Can I use In-Context with the Reactjs app?">
