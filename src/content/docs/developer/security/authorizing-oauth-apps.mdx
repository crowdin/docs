...
<table>
  ...
  <tr>
    ...
    <td>string</td>
    <td><strong>Strongly recommended.</strong> The method used to derive the <code>code_challenge</code>. Crowdin only supports <code>S256</code>. Required if <code>code_challenge</code> is provided.</td>
  </tr>
  </tbody>
</table>
