...
<Aside type="caution">
  The below-mentioned IP addresses are changed periodically.
</Aside>
...
## Webhooks and MT Engines

Crowdin uses the following IP addresses to send the webhooks and to interact with MT engines:
