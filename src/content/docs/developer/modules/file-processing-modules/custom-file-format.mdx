  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Either of these two parameters can be used.<Aside>Maximum request payload limit is 5 MB.</Aside></p>
      </td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Either of these two parameters can be used.<Aside>Maximum response payload limit is 5 MB.</Aside></p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <p><Aside>HTML preview won't be displayed in the Crowdin Editor if the app passes strings with plurals.</Aside></p>
      </td>
    </tr>
    <tr>
