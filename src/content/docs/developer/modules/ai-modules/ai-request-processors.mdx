...
* **Post-parse** – executed after the response has been parsed into structured Crowdin data. Used to adjust the final result based on the action, such as auto-translation or QA checks.
...
## Communication between AI Request Processor App and Crowdin
