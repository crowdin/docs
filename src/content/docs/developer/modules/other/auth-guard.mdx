...
<Aside>
  * The `{domain}` placeholder represents the Crowdin Enterprise organization's unique domain name. You can retrieve this value from the `domain` claim in the JWT token.
