...
This module allows for the integration of advanced AI-powered QA checks, enabling verification of translations for nuanced issues that cannot be detected by [default QA checks](/enterprise/project-settings/qa-checks/) or JavaScript-based [Custom QA checks](/enterprise/custom-qa-checks/).
...
```json {"Optional; only applicable if running the QA check synchronously":9-16}
{
  "data": {
    "validations": [
      {
