...
During the app installation process, a unique secret called the [`app_secret`](/developer/crowdin-apps-installation/#:~:text=the%20app%20descriptor.-,app_secret,-Type%3A%20string) is provided to your app. This secret is used to generate the webhook signature using the HMAC algorithm with SHA-256.
