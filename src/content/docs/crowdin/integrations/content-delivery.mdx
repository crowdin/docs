...
import distributionHash from '!/crowdin/integrations/content_delivery_distribution_hash.png';
...
6. Select one of the following export options:
    * Default &ndash; export translations in the original format of the selected files.
    * Bundle &ndash; export translations in the selected format regardless of the original format of the selected files.

7. Click **Next**. <Image src={addDistribution} alt="Over-the-Air Content Delivery" width="500" />

8. Copy the distribution hash so that you can use it for integration. <Image src={distributionHash} alt="Over-the-Air Content Delivery" width="500" />
...
<ReadMore>
  Read more about the [Crowdin OTA JavaScript client](https://github.com/crowdin/ota-client-js).
</ReadMore>
