...
import integrationEdit from '!/crowdin/integrations/google_play_integration_edit.png';
...
import integrationSetUp from '!/crowdin/integrations/google_play_integration_set_up.png';
...
<Aside>
  You will need to [install the Google Play integration](https://crowdin.com/store/apps/google-play) in your Crowdin account before you can set it up and use it.
</Aside>
...
<Steps>
  ...
  2. Click **Add Integration** and find **Google Play** in the list.

  3. Click **Install** and follow the instructions to complete the installation.

  4. After installing, click on **Google Play** in the Integrations List.

  5. Enter the package name and click **Set Up Integration**. <Image src={integrationSetUp} alt="Google Play Integration Set Up" />
</Steps>

You can edit the package name if you entered it incorrectly and delete the integration if needed.

<Image src={integrationEdit} alt="Google Play Integration Edit Package Name" />
...
<Steps>
  ...
  2. Click **Preview & Publish Translations**. <Image src={integrationPublish} alt="Publish Translations" width="600" />

  3. Available translations will appear accordingly to the configured [Export options](/project-settings/export/). See whether all translations look good and clear the checkbox next to the languages you don't want to publish. Click **Next** to proceed. <Image src={integrationSelectLanguages} alt="Selecting Languages for Publishing" width="500" />

  4. Upload a file with your [service account credentials](#creating-service-account-credentials) and click **Publish**. <Image src={integrationServiceAccountCredentials} alt="Service Account Credentials" width="500" />

  5. You can track the publishing progress in the next dialog. Once the translations are uploaded, click **Close**. <Image src={integrationPublishingProgress} alt="Publishing Progress" width="500" />
</Steps>
...
<Steps>
  ...
  2. Generate service account credentials:
     ...
     - Select **JSON** and click **Create**. <Image src={integrationServiceAccountKeyType} alt="Key Type" width="500" />
  ...
  3. Grant access to your service account:
     ...
     - In the **Account permissions** tab, select the following permissions:
       ...
       - Manage store presence <Image src={integrationPermissions} alt="Permissions" width="600" />
     - Click **Invite user**.
</Steps>
