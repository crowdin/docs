...
import pseudoLocalization from '!/crowdin/integrations/figma_plugin_pseudo_localization.png';
import selectBranch from '!/crowdin/integrations/figma_plugin_select_branch.png';
import selectContentType from '!/crowdin/integrations/figma_plugin_select_content_type.png';
...
import uploadedTranslations from '!/crowdin/integrations/figma_plugin_uploaded_translations.png';
...
<Image src={settings} alt="Figma Plugin Selecting Crowdin Project" />
...
<Image src={selectContentType} alt="Figma Plugin Selecting Content Type" />

Select the specific branch your content will be uploaded to. If your Crowdin project doesn't have branches, leave it empty.

<Image src={selectBranch} alt="Figma Plugin Selecting Branch" />
...
<Image src={pseudoLocalization} alt="Figma Plugin Pseudo-localization" />
...
<Image src={uploadedTranslations} alt="Figma Plugin Uploaded Translations" />
