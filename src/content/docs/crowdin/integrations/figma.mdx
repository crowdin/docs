...
<Steps>
  ...
  3. *(Optional)* Select the specific **branch** your content will be uploaded to. If your Crowdin project doesn't have branches, leave it empty.
</Steps>
...
<Steps>
  ...
  7. In the next dialog page, select the preferred options:
      ...
      * Merge duplicates &ndash; link identical text elements to a single new string in Crowdin. It's useful in the following cases:
