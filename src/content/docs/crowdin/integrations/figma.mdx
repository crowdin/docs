...
<Steps>
  ...
  4. In the next screen, select one or more languages you want to import translations from. You can track the translation progress for each language directly in this list.
