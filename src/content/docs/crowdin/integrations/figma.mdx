...
<Steps>
  ...
  4. In the **Select target languages** dialog, select the languages for which the uploaded frames will be available for translation in Crowdin. By default, **All languages** is selected.
  5. Click **Send All Frames** (or **Send Selected Frames**).
</Steps>
...
<Steps>
  ...
  4. In the **Select target languages** dialog, select one or more languages you want to import translations from. You can track the translation progress for each language directly in this list.
  5. Click **Import All Frames** (or **Import Selected Frames**).
</Steps>
...
<Steps>
  ...
  3. In the **Figma to Crowdin** section, click **Selected Assets**. Select the target languages in the dialog that opens and click **Send Selected Assets**.
  4. Once translations are ready, go to the **Crowdin to Figma** section and click **Selected Assets**. Select the target languages to import and click **Import Selected Assets** to apply the translations.
</Steps>
