...
import appLink from '!/crowdin/integrations/jira_app_link.png';
import deleteIntegration from '!/crowdin/integrations/jira_delete_integration.png';
import editSettings from '!/crowdin/integrations/jira_edit_settings.png';
import fields1 from '!/crowdin/integrations/jira_fields_1.png';
import fields2 from '!/crowdin/integrations/jira_fields_2.png';
import openSettings from '!/crowdin/integrations/jira_open_settings.png';
import setUp from '!/crowdin/integrations/jira_set_up.png';
import settings from '!/crowdin/integrations/jira_settings.png';
...
3. Enter the Base URL of your Jira project and click **Set Up Integration**.
    <Image src={setUp} alt="Base URL" />
...
4. Configure an **Application Link** in Jira:
    ...
    1. Enter your Crowdin URL and click **Create new link**.
        <Image src={openSettings} alt="Jira administration" />
    ...
    1. Fill in all the required fields in dialog windows and click **Continue** to finish configuring the link:
        ...
        - Select **Create incoming link** and click **Continue** <Image src={fields1} alt="Create a link" width="500" />
        - Consumer Key: Crowdin
        - Consumer Name: Crowdin
        - Public Key: copy it from the **Providing Access to Your Jira Project** dialog in Crowdin <Image src={fields2} alt="Link applications" width="500" />
        Click **Continue** to finalize the Application Link setup.

5. Go back to Crowdin and click **Next** in the **Providing Access to Your Jira Project** dialog. <Image src={appLink} alt="Providing Access to Your Jira Project" />
...
8. Click **Save**. <Image src={settings} alt="Jira settings" width="400" />
</Steps>
...
<Image src={editSettings} alt="Edit settings" />
...
<Image src={deleteIntegration} alt="Delete integration" />
