...
import connectingAzureRepos from '!/crowdin/integrations/azure_repos_integration_connecting_azure_repos.png';
import authorizationAzureRepos from '!/crowdin/integrations/azure_repos_integration_authorization.png';
import unconfigured from '!/crowdin/integrations/azure_repos_integration_unconfigured.png';
import unconfiguredSb from '!/crowdin/integrations/azure_repos_integration_unconfigured_sb.png';
...
<Steps>
  ...
  3. Click **Set Up Integration** and select **Source and translation files mode** or **Target file bundles mode** from the drop-down list to integrate via your Azure Repos account. <Image src={connectingAzureRepos} alt="Connecting Azure Repos" />
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Image src={unconfigured} alt="Azure Repos Integration Unconfigured" width="600" />
  ...
  <TabItem label="String-based project">
    <Image src={unconfiguredSb} alt="Azure Repos Integration Unconfigured" width="600" />
  </TabItem>
</Tabs>
...
<Image src={translationImportOptions} alt="Integration Translation Import Options" />
...
<Image src={syncSettings} alt="Integration Sync Settings" />
...
<Steps>
  1. Open your project and go to the **Integrations** tab.
  2. Click on **Azure Repos** in the Integrations list.
  3. Click **Add Repository**. <Image src={multipleRepositories} alt="Integration Multiple Repositories" />
...
<Image src={syncBranch} alt="Integration Sync Branch" />
