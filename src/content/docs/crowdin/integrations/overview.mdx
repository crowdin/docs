...
<Steps>
  ...
  3. Select existing project members from the user list or enter the invitee's email to invite them as a new project manager. You can invite users with the following roles:
      * Owner
      * Managers
      * Translation Requestors / Developers
...
Managers can also invite Translation Requestors / Developers, who will gain similar permissions but cannot further invite other users to manage the app. Owner roles can also be invited with full permissions.
