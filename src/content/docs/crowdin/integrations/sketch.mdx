...
import addStringToMultipleFiles from '!/crowdin/integrations/sketch_plugin_add_string_to_multiple_files.png';
...
<Image src={addStringToMultipleFiles} alt="Sketch Plugin Add String To Multiple Files" />
