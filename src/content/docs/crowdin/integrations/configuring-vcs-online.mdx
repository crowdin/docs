...
<Steps>
  ...
  1. Click **Add Mapping** to add another custom code. <Image src={languageMapping2} alt="Language mapping" width="400" />
  1. Click **Save**.
</Steps>
...
<Steps>
  1. Click **Save** to preview the created configuration. <Image src={filesListFilter} alt="Save configuration"  width="600" />
  ...
  1. Click **Save** to save the created configuration. <Image src={filesList} alt="Apply filters to all translatable branches"  width="600" />
</Steps>
