...
<Steps>
  ...
  1. Click **Continue**. <Image src={loadConfiguration} alt="Load Configuration" class="width-2xl crowdin-modal" />
</Steps>
...
<Steps>
  ...
  1. Click **Save** to save the created configuration. <Image src={filesList} alt="Apply filters to all translatable branches"  class="width-2xl crowdin-modal" />
</Steps>
