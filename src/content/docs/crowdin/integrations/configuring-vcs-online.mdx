...
<Steps>
  ...
  1. Click **Continue**. <Image src={loadConfiguration} alt="Load Configuration" class="width-2xl" />
</Steps>
...
<Steps>
  1. Click **Save** to preview the created configuration. <Image src={filesListFilter} alt="Save configuration" class="width-2xl" />
