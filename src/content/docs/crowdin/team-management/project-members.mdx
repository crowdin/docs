...
<Steps>
  ...
  1. Select a new role.
  1. Click **Save**. <Image src={changeMemberRole} alt="Changing Member Role" width="600" />
</Steps>
...
<Steps>
  ...
  1. Click **Save**. <Image src={configureLanguagePermissions} alt="Configuring Language Permissions" width="600" />
</Steps>
