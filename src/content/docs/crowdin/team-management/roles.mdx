...
Owner is a person who created a project and has complete control over it. The owner can invite users to the project and manage their access, manage resources like AI providers, MT engines and more, create projects, upload source and translation files to the project, set up integrations, etc.
...
Managers have similar rights to the project owner and are responsible for the management of their assigned projects. Within those projects, they can manage project members, tasks, resources, and more, but cannot manage some of the owner's resources (e.g., configuration of AI providers, MT engines, etc.) and delete projects.
