...
<Aside>
  Project ownership can't be transferred.
</Aside>

<ReadMore>
  Read more about [Migrating a Project to Another Crowdin Account](/migrating-to-crowdin/#migrating-a-project-to-another-crowdin-account).
</ReadMore>
