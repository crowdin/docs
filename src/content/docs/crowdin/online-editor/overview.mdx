...
Use the **Comments** section to report problems with source strings or translations, ask questions, or request additional context.
...
<Aside type="tip">
  You can also [filter unresolved issues](#filtering-strings) to keep track of what still needs attention.
</Aside>
