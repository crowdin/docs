...
<Steps>
  ...
  2. Configure settings for pre-translation:
      * Scope &ndash; selected strings (Specific to **Side-by-Side** and **Multilingual** modes), filtered strings, file, or all files.
      * Translation Engine or AI Prompt &ndash; select the MT engine (Specific to Pre-translation via MT) or AI prompt (Specific to Pre-translation via AI).
      * Pre-translation parameters &ndash; minimum match ratio (Specific to Pre-translation via TM), strings for translation, approval options.
