...
* Strings with variables enclosed in double curly brackets: `then "{%raw%}{{{%endraw%}", range "a,z", then ".", range "a,z", then "{%raw%}}}{%endraw%}"`
...
*File Context* tab can contain additional context or instructions for translators to better understand how to translate a particular file. File context can be added in the [File Settings](/files-management/#file-context) as plain text or Markdown by either an owner or a project manager.
