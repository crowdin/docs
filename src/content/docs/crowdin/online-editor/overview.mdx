...
Verbal expressions allow you to search for strings that match specific patterns, such as formatting, punctuation, or variable placement. This feature is available in the [Advanced Filter](#advanced-filter).
