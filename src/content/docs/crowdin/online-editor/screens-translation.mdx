...
Translating directly from screenshots offers several advantages:

* **Enhanced Context**: Seeing strings in their visual UI context removes ambiguity, leading to clearer and more accurate translations.
* **Streamlined Review**: Screenshots provide a straightforward way to review translations in context, which is particularly helpful when reviewing AI-generated suggestions.
* **Efficient Workflow**: Translating screenshot by screenshot eliminates the need to search for context or guess where a string might appear, speeding up the process.
...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/figma-plugin/#uploading-tagged-screenshots-to-crowdin"
  />
  <LinkCard
