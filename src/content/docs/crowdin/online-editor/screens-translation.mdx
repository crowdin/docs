...
This view is enabled by a project manager. When enabled, the screenshots will be displayed on the project's language page instead of the traditional file list.
