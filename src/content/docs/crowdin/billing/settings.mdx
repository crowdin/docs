...
You can open the FastSpring account management page from Crowdin: go to **Account Settings > Billing** and click **Update Payment Details** in the **Payment Method** row.
