...
Communicate with translation project members using *Conversations*. Create one-to-one conversations or invite as many users as needed. Each conversation has its Subject, so you can easily navigate between several conversations.
