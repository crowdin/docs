...
import privateProfilePrivacy from '!/crowdin/getting-started/account/account_settings_private_profile_privacy.png';
import migrationToCrowdinEnterprise from '!/crowdin/getting-started/account/account_settings_migration_to_crowdin_enterprise.png';
import removeAccount from '!/crowdin/getting-started/account/account_settings_remove_account.png';
...
import changePassword from '!/crowdin/getting-started/account/account_settings_change_password.png';
import createPassword from '!/crowdin/getting-started/account/account_settings_create_password.png';
import twoFactorAuthentication from '!/crowdin/getting-started/account/account_settings_2fa.png';
...
import oauthConnections from '!/crowdin/getting-started/account/account_settings_oauth_connections.png';
import sessions from '!/crowdin/getting-started/account/account_settings_sessions.png';
import apiNewToken from '!/crowdin/getting-started/account/account_settings_api_new_token.png';
import apiTokenGranularAccess from '!/crowdin/getting-started/account/account_settings_api_token_granular_access.png';
import apiTokenRevoke from '!/crowdin/getting-started/account/account_settings_api_token_revoke.png';
import oauthApplications from '!/crowdin/getting-started/account/account_settings_oauth_applications.png';
import betaFeatures from '!/crowdin/getting-started/account/account_settings_beta_features.png';
import securityLog from '!/crowdin/getting-started/account/account_settings_security_log.png';
...
<Steps>
  ...
  1. Select **Private Profile**. <Image src={privateProfilePrivacy} alt="Hide Projects and Activity tabs" />
</Steps>
...
<Image src={migrationToCrowdinEnterprise} alt="Migration to Crowdin Enterprise" />
...
<Steps>
  ...
  1. Click **Remove Account**. <Image src={removeAccount} alt="Remove Account" />
</Steps>
...
<Image src={changePassword} alt="Changing Password" />
...
<Image src={createPassword} alt="Creating Password" />
...
<Steps>
  ...
  2. Enable **Two-Factor Authentication**. <Image src={twoFactorAuthentication} alt="Two-factor authentication" width="744" />
  3. Using the **Google Authenticator** app on your mobile device, scan the QR code on the screen.
  4. Enter the 6-digit verification code generated by your authenticator app, then click **Next**. <Image src={twoFactorAuthenticationQRCode} alt="Authenticator app" width="500" />
  5. Download recovery codes, so you can use them if you can't access your mobile device. <Image src={twoFactorAuthenticationRecoveryCodes} alt="Recovery codes" width="500" />
</Steps>
...
<Image src={oauthConnections} alt="OAuth Connections" />
...
<Image src={sudoModeConfirmingCredentials} alt="Confirming credentials" width="400" />
...
You can enable the desired channel by selecting the checkbox under the channel's name, either In-App, Email, Slack, or Custom. Customize notifications for each of the channels.

Select the checkboxes next to the events you’d like to be notified of:
...
<Steps>
  ...
  1. Click **New Token**. <Image src={apiNewToken} alt="New Token" />
  ...
  1. Click **Select projects**, **Select glossaries**, **Select TMs**, and respectively select the needed resources. <Image src={apiTokenGranularAccess} alt="Granular Access" width="500" />
  1. Click **Create**.
</Steps>
...
<Steps>
  1. Open your **Account Settings** and go to the **API** tab.
  1. Find the necessary token in the list and click **Revoke** next to it to delete a personal access token and remove its access. <Image src={apiTokenRevoke} alt="Revoke Token" />
</Steps>
...
<Image src={securityLog} alt="Security Log" />
...
<Image src={oauthApplications} alt="OAuth Applications tab" />

Some of the most common uses for this feature include:

- OAuth apps allow you to make authorized requests to the [Crowdin API](https://developer.crowdin.com/api/v2/).
...
<Steps>
  ...
  1. In the appeared dialog, specify the following information:
     ...
     * Select the access your app needs from the list of available [Scopes](https://developer.crowdin.com/understanding-scopes/).
  1. Click **Create**. <Image src={oauthAppsNewApp} alt="Create OAuth App" width="400" />
</Steps>
...
* **Edit** &ndash; update the application name, description, URLs, and scopes. Access Client ID and Client Secret of the created application.
  <Image src={oauthAppsEdit} alt="Oauth App info" width="400" />
...
<Image src={betaFeatures} alt="Beta Features" />
