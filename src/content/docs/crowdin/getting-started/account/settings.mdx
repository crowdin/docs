...
import globalNotificationSettings from '!/crowdin/getting-started/account/global_notification_settings.png';
...
<Image src={globalNotificationSettings} alt="Notification Events" />
