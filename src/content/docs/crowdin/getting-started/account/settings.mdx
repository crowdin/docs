...
In the **Profile** tab, you can manage manage your personal details, language preferences, appearance settings, and privacy options.
...
Manage agents for custom applications that interact with Crowdin. Agents allow applications to perform specific actions on your behalf within the platform. You can add Agents from the [Crowdin Store](https://store.crowdin.com/tags/agents) and manage their permissions to projects and resources as needed.
...
* **Edit** &ndash; update the application name, description, URLs, and scopes. Access Client ID and Client Secret of the created application.
  <Image src={oauthAppsEdit} alt="Oauth App info" class="width-md crowdin-modal" />
