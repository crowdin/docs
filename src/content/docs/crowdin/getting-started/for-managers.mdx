...
If you decide to [invite your own team of translators](/inviting-people), open your project and go to the **Members** tab. You can invite people to your project using their Crowdin username or email address and via the invitation link. When inviting new people, you can assign them the following roles: Manager, Language Coordinator, Proofreader, and Translator. You can [change the assigned role](/project-members/#changing-role) for any project member at any time.
