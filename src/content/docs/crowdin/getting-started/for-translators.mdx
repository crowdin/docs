...
You can customize your workspace view by clicking **Pin/Unpin menu** <Icon name="material-symbols:dock-to-right" class="inline-icon" /> in the lower-left corner of the sidebar. Unpinning the sidebar will move the main navigation items to the top of the page.
