...
Click the profile picture in the upper-right corner and select *Settings* to access your [Account Settings](/account-settings) where you can view and manage your personal information, profile security, notifications, define preferred languages, etc.
...
<LinkCard
  title="Read more about Online Editor"
  href="/online-editor"
/>
