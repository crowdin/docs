...
import assigning from '!/crowdin/localization-resources/glossary_assigning.png';
import changingDefaultGlossary from '!/crowdin/localization-resources/glossary_changing_default_glossary.gif';
...
<Steps>
  ...
  5. Click **Create**. <Image src={createGlossaryDialog} alt="Create glossary dialog" class="dialog" />
</Steps>
...
<Steps>
  ...
  7. Click **Create**. <Image src={addConceptDialog} alt="Add Concept Dialog" width="744px" />
</Steps>
...
To view only terms in a source language, clear **All languages**.

<Image src={termsView} alt="Terms View" />

By default, all glossary concepts and terms are displayed in the Concepts and Terms pages. To filter the concepts or terms displayed, click <Icon name="mdi:filter-variant" class="inline-icon" /> and use the available filter option:
...
If you upload a glossary in CSV or XLS/XLSX file formats, select the language for each column and the column value (term, description, or part of speech) in the configuration dialog. <Image src={configureImport} alt="Configure Glossary Import" />
...
<Steps>
  1. Open your project and go to **Settings > Glossaries**.

  2. In the **Assigned Glossaries** section, select the needed glossaries from the list. <Image src={assigning} alt="Assigning Glossary" width="744px" />
</Steps>
...
<Steps>
  ...
  2. In the **Assigned Glossaries** section, click the star icon next to the needed glossary in the list. <Image src={changingDefaultGlossary} alt="Changing Default Glossary" width="744px" />
</Steps>
