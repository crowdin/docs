...
You can assign a TM to your project in the project **Settings > Translation Memories**.

<LinkCard
  title="Read more about Assigning TM"
...
You can prioritize TMs assigned to your project in the project **Settings > Translation Memories**.

<LinkCard
  title="Read more about Prioritizing TM"
...
You can change your project's default TM in the project **Settings > Translation Memories**.

<LinkCard
  title="Read more about Changing Default TM"
  href="/project-settings/glossaries/#changing-default-tm"
  target="_blank"
/>
...
<Include file="tm-autosubstitution-non-translatable-elements-table.mdx" />
