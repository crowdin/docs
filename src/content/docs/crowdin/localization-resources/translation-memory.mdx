...
Using the shared TMs, you can auto-translate any of the projects you own. Also, TM suggestions from all TMs will appear in the Editor.
...
Auto-translation via TM allows you to leverage a minimum of 100% and Perfect matches.
...
<Aside type="tip">
  You can also [configure the automatic Auto-translation via TM](/project-settings/auto-translate/#tm-auto-translate) for new content in your project.
</Aside>

### Prioritizing TM Suggestions during the Auto-translation via TM

During the auto-translation via TM, the system considers multiple parameters to select the most relevant TM suggestion. If the system finds only one suitable TM suggestion for a string, it will be applied during the auto-translation via TM. If the system finds two or more TM suggestions for one string, they will be sorted based on multiple parameters and applies the most suitable one.
...
### Auto-substitution for Auto-translation

Once you enable the TM auto-substitution, you can leverage improved TM suggestions during [auto-translation](#applying-translation-memory-via-auto-translation). Be sure to set a minimum match ratio to 100%. This will result in including 100% TM matches along with the ones improved to 100% by TM auto-substitution.
