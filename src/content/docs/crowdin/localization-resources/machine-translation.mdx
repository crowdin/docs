...
<Steps>
  ...
  2. Click <Icon name="mdi:dots-horizontal" class="inline-icon" /> toward the needed MT engine and select **Edit**. Alternatively, just double-click on the needed MT engine.
  3. Enter the credentials for the preferred translation engine.
  4. Click **Update**.
</Steps>
...
Alternatively, you can also [get your MT engine IDs via API](https://developer.crowdin.com/api/v2/#tag/Machine-Translation-Engines/operation/api.mts.getMany).
