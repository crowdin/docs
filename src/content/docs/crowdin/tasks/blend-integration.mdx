...
<Steps>
  1. Go to **Store > Vendors** on your profile home page and click <Icon name="mdi:cog" class="inline-icon" /> on the **BLEND** tile.<br/>Alternatively, click on the tile to open the vendor's page and then click <Icon name="mdi:cog" class="inline-icon" /> **Settings**.
  2. Enter *Public Key* and *Secret Key* from the BLEND [API keys](https://app.getblend.com/profile/#apikeys) tab. Click **Submit Keys**.
</Steps>
...
<Steps>
  ...
  3. Set the task parameters:
      ...
      * *Translation Vendor* &ndash; select *BLEND* from the list.
        <Aside type="tip">
          Click <Icon name="mdi:cog" class="inline-icon" /> next to the vendor dropdown to manage your BLEND connection, or <Icon name="mdi:store" class="inline-icon" /> to view the vendor in the Store.
        </Aside>
...
To manage the integration, open **Store > Vendors** and click <Icon name="mdi:cog" class="inline-icon" /> on the **BLEND** tile, or click on the tile to open the vendor's page and then click <Icon name="mdi:cog" class="inline-icon" /> **Settings**.

You can **Switch Account** to change the connected account, or **Disconnect Account** to remove the integration. Once your account is connected, you can also track your current balance on the BLEND side directly from this dialog.
