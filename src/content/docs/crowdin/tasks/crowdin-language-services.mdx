...
<Steps>
  ...
  2. You can also initiate a task from the **Store**:
     ...
     2. Click on the **Crowdin Language Services** tile to open the vendor page.
...
When ordering translation or proofreading, you can choose from the following payment options. To configure **Managed by Crowdin balance** as your default payment method, open **Store > Vendors** and click <Icon name="mdi:cog" class="inline-icon" /> on the **Crowdin Language Services** tile. Alternatively, click on the tile to open the vendor's page and then click <Icon name="mdi:cog" class="inline-icon" /> **Settings**.
