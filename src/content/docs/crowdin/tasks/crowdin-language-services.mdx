...
This option allows you to pay for tasks after they are completed. If you select **Post Payment**, payments will be processed by the vendor (i.e., Alconost Inc.). This option becomes available once the total value of your completed Crowdin Language Services orders reaches $3000. The value of the task you are currently creating counts toward this cumulative threshold.
