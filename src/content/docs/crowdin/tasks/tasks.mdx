...
To quickly find specific members, use the **Search users** field or click <Icon name="mdi:filter-variant" class="inline-icon" /> to filter the list by project role.
...
<Steps>
  ...
  1. In the task details view, click <Icon name="mdi:dots-horizontal" class="inline-icon" /> in the upper-right corner and select **Edit**. <Image src={edit} alt="Editing Task" />
...
You can apply auto-translation to the strings included in a translation task. Open the task, click <Icon name="mdi:dots-horizontal" class="inline-icon" /> in the upper-right corner, and select **Auto-Translate**. The task defines both the strings to process and the target language.

<ReadMore>
  Read more about [Auto-Translation](/auto-translation/#auto-translating-task-content).
</ReadMore>
...
To close the task when it's finished, move it to the **Done** column and click **Close** at the bottom of the task card.
