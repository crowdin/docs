  ...
  <TabItem label="File-based project">
    <Steps>
      ...
      1. Set the task parameters:
          ...
          * *[Create Cost Estimate Report](#generating-cost-estimate-report-for-tasks)* &ndash; automatically generate a cost estimate based on selected content and the rates template.
