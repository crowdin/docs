...
<Steps>
  ...
  3. In the *File* menu, select **Download** or **Export in XLIFF**.
     ![Download File](./_assets/download_files_3.png)
</Steps>
...
<Steps>
  ...
  3. Select **Download** or **Export in XLIFF**.
     ![Download File](./_assets/download_files_2.png)
</Steps>
...
<Steps>
  ...
  3. Select **Download translations** or **Export in XLIFF**.
     ![Download All Files](./_assets/download_files.png)
</Steps>
...
<Steps>
  ...
  4. In the *File* menu, select **Export Filtered in XLIFF**.
     ![Download Filtered Strings](./_assets/download_files_export_filtered.png)
</Steps>
...
<Steps>
  ...
  3. In the *File* menu, select **Upload Translations**.
     ![Upload Translations via Editor](./_assets/upload_translations_editor.png)
...
<Steps>
  ...
  3. Select **Upload Translations**
     ![Upload Translations via Language Page](./_assets/upload_translations_language_page.png)
...
<Steps>
  ...
  3. Select **Upload XLIFF Translations**.
     ![Upload Translations in XLIFF](./_assets/upload_translations_xliff.png)
