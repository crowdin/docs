...
<Steps>
  ...
  3. In the *File* menu, select **Download** or **Export in XLIFF**. <Screenshot src="/translation-process/download_files_3.png" alt="Download File" />
</Steps>
...
<Steps>
  ...
  3. Select **Download** or **Export in XLIFF**. <Screenshot src="/translation-process/download_files_2.png" alt="Download File" />
</Steps>
...
<Steps>
  ...
  3. Select **Download translations** or **Export in XLIFF**. <Screenshot src="/translation-process/download_files.png" alt="Download All Files" />
</Steps>
...
<Steps>
  ...
  4. In the *File* menu, select **Export Filtered in XLIFF**. <Screenshot src="/translation-process/download_files_export_filtered.png" alt="Download Filtered Strings" />
</Steps>
...
<Steps>
  ...
  3. In the *File* menu, select **Upload Translations**. <Screenshot src="/translation-process/upload_translations_editor.png" alt="Upload Translations via Editor" />
...
<Steps>
  ...
  3. Select **Upload Translations**. <Screenshot src="/translation-process/upload_translations_language_page.png" alt="Upload Translations via Language Page" />
...
<Steps>
  ...
  3. Select **Upload XLIFF Translations**. <Screenshot src="/translation-process/upload_translations_xliff.png" alt="Upload Translations in XLIFF" />
