...
import promptActions from '!/crowdin/translation-process/crowdin_ai_prompt_actions.png';
...
import addingPromptProjectSettings from '!/crowdin/translation-process/crowdin_ai_adding_prompt_project_settings.png';
import aiPreTranslate from '!/crowdin/translation-process/crowdin_ai_pre_translate_ai.png';
...
<CardGrid>
  <LinkCard
    ...
    href="https://developer.crowdin.com/api/v2/#tag/AI"
  />
  <LinkCard
    title="AI Section (String-based)"
    description="Manage AI Providers and AI Prompts using API methods."
    href="https://developer.crowdin.com/api/v2/string-based/#tag/AI"
  />
</CardGrid>
