...
<Steps>
  ...
  1. In the **Prompts** tab, click **Add prompt**. Alternatively, you can go ahead with creating prompt samples clicking **Try a sample**. Crowdin allows you to quickly set up pre-configured prompts that are ready to perform effectively from the moment they are created. While these samples are designed to work good initially, you can customize them to your personal preferences.
  
  1. In the appeared dialog, set the prompt parameters:
      * Select **Enabled**
      ...
      * Additional context (Basic mode) &ndash; specify which data will be included in the prompt using the following fields:
          ...
          * Screenshots &ndash; allows AI to consider a visual context in the form of screenshots where the strings are tagged. This enhances accuracy and context awareness. <ReadMore>Read more about [Screenshots](/adding-screenshots).</ReadMore>
...
<Steps>
  ...
  1. In the **Prompts** tab, click <Icon name="mdi:dots-horizontal" class="inline-icon" /> toward the needed prompt and select **Edit**.

  1. Modify the prompt as needed and click **Update** to save changes.
</Steps>
...
<Steps>
  ...
  1. In the **Prompts** tab, click <Icon name="mdi:dots-horizontal" class="inline-icon" /> toward the needed prompt and select **Clone**.

  1. As a result, a copy of the prompt will appear in the prompt list.
</Steps>
...
<Steps>
  ...
  1. In the **Prompts** tab, click <Icon name="mdi:dots-horizontal" class="inline-icon" /> toward the needed prompt and select **Remove**.
...
<Steps>
  ...
  1. In the **Providers** tab, click <Icon name="mdi:dots-horizontal" class="inline-icon" /> toward the needed provider and select **Edit**. Alternatively, just double-click on the needed provider.

  1. Select **Enabled**.

  1. *(Optional)* Select the **\{Provider} managed by Crowdin** option if you'd like to use the providers managed by Crowdin. In this case, you'll need to [top up your account balance](#topping-up-account-balance).

  1. Specify your own AI provider API key. Follow AI provider instructions on how to generate an API key.

  1. AI providers like Google Gemini and Microsoft Azure Open AI have slightly different configuration options compared to others:
  ...
  1. Click the **Advanced settings** to access the model-related settings:
...
<Steps>
  ...
  1. In the **Providers** tab, click <Icon name="mdi:dots-horizontal" class="inline-icon" /> toward the needed provider and select **Disable**. Alternatively, double-click on the needed provider and clear **Enabled** in the provider's settings.
</Steps>
...
<Steps>
  ...
  1. Click **Pre-translation** and select **via AI**.
  ![Pre-translate via AI](./_assets/crowdin_ai_pre_translate_ai.png)

  1. Select the preferred AI prompt.

  1. Select the target languages and files you want to pre-translate.

  1. *(Optional)* You can specify labels in the **Filter by labels** and **Exclude by labels** fields to filter strings, including or excluding them during pre-translation.

  1. Click **Pre-translation via AI**.
</Steps>

<Aside>
This feature can be applied only to untranslated strings.
</Aside>
...
<Steps>
  ...
  1. Click <Icon name="mdi:plus" class="inline-icon"/> **Add shortcut**.

  1. Specify a shortcut name and a prompt it will be using.
...
<Image src={aiAssistantEditorSettings} alt="Configuring AI Prompts in Project Settings" class="dialog"/>
