...
<Steps>
  ...
  1. In the appeared dialog, set the prompt parameters:
      ...
      * Additional context (Basic mode) &ndash; specify which data will be included in the prompt using the following fields:
          ...
          * File context &ndash; allows AI to consider a textual description of the file added in the file settings. <ReadMore>Read more about [File context](/files-management/#file-context).</ReadMore>
