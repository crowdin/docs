...
<Aside type="tip">
  You can also [configure an automatic AI Pre-translate](/pre-translate/#ai-pre-translate) for new content in your project.
</Aside>
...
<Image src={aiEditorSettings} alt="Configuring AI Prompts in Project Settings" class="dialog" />
