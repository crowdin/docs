...
<Screenshot src="/translation-process/vendors_list.png" alt="Vendors" class="no-shadow mb-8" />
...
Register at <a href="https://app.getblend.com/auth/register" target="_blank">BLEND</a> and <a href="https://gengo.com/auth/form/signup/" target="_blank">Gengo</a> if you don't already have an account.
...
<Steps>
  ...
  4. Click **Connect Account**. <Screenshot src="/translation-process/blend_connect.png" alt="Connect BLEND" />

  5. Enter *Public Key* and *Secret Key* from the BLEND <a href="https://app.getblend.com/profile/#apikeys" target="_blank">API keys</a> tab or the Gengo <a href="https://gengo.com/account/api_settings/" target="_blank">API settings</a>. Click **Submit Keys**.
</Steps>
...
<Steps>
  1. Click **Create Task** using the project's **Tasks** tab or straight from the vendor page via **Store > Vendors** being logged in as a project owner. Ensure to select the project from the drop-down list when creating a task via **Store > Vendors**. <Screenshot src="/translation-process/blend_create_task.png" alt="Create Task" />
...
<Steps>
  ...
  5. Click **View**. <Screenshot src="/translation-process/vendor_view.png" alt="Vendor View" />

  6. Select a project you'd like to translate.

  7. Click **Create Task**.
     Alternatively, click **Create Task** using the [Tasks](/tasks) tab in your project.
...
| **Files** or **Branches** (required)             | Depending on your project type, select the files or branches that should be translated                                           |
