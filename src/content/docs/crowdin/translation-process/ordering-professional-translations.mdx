...
<Steps>
  1. Go to **Store > Vendors** on your profile home page and click <Icon name="mdi:cog" class="inline-icon" /> on the **BLEND** or **Gengo** tile.<br/>Alternatively, click on the tile to open the vendor's page and then click <Icon name="mdi:cog" class="inline-icon" /> **Settings**.
  2. Enter *Public Key* and *Secret Key* from the BLEND [API keys](https://app.getblend.com/profile/#apikeys) tab or the Gengo [API settings](https://gengo.com/account/api_settings/). Click **Submit Keys**.
</Steps>

### Managing BLEND and Gengo Connections

To manage the connection, open **Store > Vendors** and click <Icon name="mdi:cog" class="inline-icon" /> on the **BLEND** or **Gengo** tile, or click on the tile to open the vendor's page and then click <Icon name="mdi:cog" class="inline-icon" /> **Settings**.

For BLEND and Gengo, you can **Switch Account** to change the connected account, or **Disconnect Account** to remove the integration. Once your account is connected, you can also track your current balance on the vendor's side directly from this dialog.

<Aside>
  Only the project owner can connect, switch, and disconnect the vendor account. If you disconnect the integration or switch to another account, the existing tasks (if any) will remain synchronized.
</Aside>
