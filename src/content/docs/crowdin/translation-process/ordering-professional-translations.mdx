...
import vendors_list from './_assets/vendors_list.png';
...
<Image src={vendors_list} alt="Vendors list" class="no-shadow mb-8" />
...
<Steps>
  ...
  4. Click **Connect Account**.
     ![Connect BLEND](./_assets/blend_connect.png)
...
<Steps>
  1. Click **Create Task** using the project's **Tasks** tab or straight from the vendor page via **Store > Vendors** being logged in as a project owner. Ensure to select the project from the drop-down list when creating a task via **Store > Vendors**.
     ![Create Task](./_assets/blend_create_task.png)
...
<Steps>
  ...
  5. Click **View**.
     ![Vendor View](./_assets/vendor_view.png)
