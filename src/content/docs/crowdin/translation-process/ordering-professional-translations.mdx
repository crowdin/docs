...
<Steps>
  1. Click **Create Task** using the project's **Tasks** tab or straight from the vendor page via **Store > Vendors** being logged in as a project owner. Ensure to select the project from the drop-down list when creating a task via **Store > Vendors**. <Image src={blendCreateTask} alt="Create Task" />
