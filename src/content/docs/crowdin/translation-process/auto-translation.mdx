...
<Aside type="tip">
  Use the [Auto-Translation Accuracy](/project-reports/#auto-translation-accuracy) report to test which auto-translation methods work the best for your content.
</Aside>
...
<Steps>
  ...
  2. Click **Auto-Translation**. <Image src={preTranslation} alt="Auto-Translation Button" />
  3. In the auto-translate dialog, configure the following parameters:
      ...
      * **AI Prompts** (Specific to auto-translation via AI) – select the prompt that will guide the AI model's behavior. Click the **Manage prompts** link to edit or add new prompts, or click <Icon name="mdi:eye" class="inline-icon" /> to preview and edit the currently selected prompt.
  ...
  6. In the **Files** section (Specific to [file-based projects](/creating-project/#file-based-project)) or **Branches** section (Specific to [string-based projects](/creating-project/#string-based-project)), select the content you want to auto-translate. Use the search bar to quickly locate specific items.
      <Aside type="caution">
...
<Aside>
  If the [TM Auto-substitution](/translation-memory/#tm-auto-substitution) feature is enabled when auto-translating via TM, TM suggestions improved to 100% will be treated as regular 100% matches.
</Aside>
...
<Steps>
  ...
  2. Click <Icon name="mdi:dots-horizontal" class="inline-icon" /> on the needed file or folder and select **Auto-Translate**.
...
<Steps>
  ...
  3. In the task details view, click <Icon name="mdi:dots-horizontal" class="inline-icon" /> in the upper-right corner and select **Auto-Translate**.
...
## Auto-Translate New Content Automatically
...
<ReadMore>
  Read more about [Auto-Translate New Content Automatically](/project-settings/auto-translate/).
</ReadMore>
...
When using auto-translation via TM and the **Share TMs** option is enabled, Crowdin applies translations from translation memories based on a specific priority order. This priority ensures that translations come from the most relevant source, optimizing translation consistency and quality.
