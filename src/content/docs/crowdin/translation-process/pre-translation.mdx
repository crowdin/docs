...
<Steps>
  ...
  2. Click **Pre-translation** and select **via MT**. <Screenshot src="/translation-process/pre_translate_mt.png" alt="MT Pre-Translate" />

  3. Select the preferred translation engine.

  4. Select the target languages and files you want to pre-translate.

  5. Click **Pre-translation via MT**. <Screenshot src="/translation-process/pre_translate_mt_2.png" alt="MT Pre-Translate" />
</Steps>
