...
You can automate the Pre-translation via MT in the project **Settings > Pre-translate**. In this case, each time you upload new content to your project, the system will automatically trigger the Pre-translation via MT and apply translations to untranslated content.

<ReadMore>
  Read more about [Automated Pre-translation via MT](/project-settings/pre-translate/#mt-pre-translate).
</ReadMore>
