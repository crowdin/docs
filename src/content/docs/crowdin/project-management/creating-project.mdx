...
<Aside type="caution" title="Limitations">
  Some connectors have limited support, and certain features (e.g., [In-Context](/developer/in-context-localization/) and [Pseudo-localization](/developer/pseudolocalization/)) may not be available in string-based projects.
</Aside>
