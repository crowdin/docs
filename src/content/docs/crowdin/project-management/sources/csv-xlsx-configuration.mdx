...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      2. Click **Configure** next to the file to open the configuration window. <Image src={csvFileConfigure} alt="Configure File" />
    </Steps>
    <Aside type="tip">
      You can also configure multiple files at once by right-clicking on the desired files and selecting **Configure Files**ю Additionally, to configure all CSV or all XLSX files simultaneously, click **Configure All**.
    </Aside>
  </TabItem>
  <TabItem label="String-based project">
    <Steps>
      ...
      3. Click **Configure** next to the file to open the configuration window. <Image src={csvFileConfigureSb} alt="Configure File (String-based)" />
    </Steps>
  </TabItem>
</Tabs>
