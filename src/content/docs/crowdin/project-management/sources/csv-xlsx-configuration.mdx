...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      2. Click **Configure** next to the file to open the configuration window. <Screenshot src="/project-management/sources/csv_file_configure.png" alt="Configure File" />
    </Steps>
    <Aside type="tip">
  ...
  <TabItem label="String-based project">
    <Steps>
      ...
      3. Click **Configure** next to the file to open the configuration window. <Screenshot src="/project-management/sources/csv_file_configure_sb.png" alt="Configure File (String-based)" />
    </Steps>
  </TabItem>
</Tabs>
...
<Screenshot src="/project-management/sources/xlsx_configuration_options.png" alt="XLSX Configuration Options" />
...
<Screenshot src="/project-management/sources/csv_file_configuration.png" alt="CSV Configuration" />
