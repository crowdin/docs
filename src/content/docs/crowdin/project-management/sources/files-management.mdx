...
<Image src={filesSettings} alt="Files settings" />
...
<Image src={filesParserConfiguration} alt="File Parser Configuration" />
...
<Image src={filesFileTargetLanguages} alt="File Target Languages" />
...
<Image src={filesFileContext} alt="File Context" />
...
<Image src={filesManagementProgresses} alt="File Progress" />
...
<Image src={filesUpdating2} alt="File Updating Options" />
...
<Image src={filesRestore} alt="File Restoring" />
