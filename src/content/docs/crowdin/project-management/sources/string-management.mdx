...
You can add strings directly to files that support [online editing](#formats-that-support-online-editing). This feature allows you to add new content without modifying source files outside Crowdin.
