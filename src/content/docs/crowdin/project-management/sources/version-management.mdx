...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    * [Add Branch](https://support.crowdin.com/developer/api/v2/#tag/Source-Files/operation/api.projects.branches.post)
  </TabItem>
  <TabItem label="String-based project">
    * [Add Branch](https://support.crowdin.com/developer/api/v2/string-based/#tag/Branches/operation/api.projects.branches.post)
  </TabItem>
</Tabs>
...
<Steps>
  ...
  2. Click <Icon name="mdi:dots-horizontal" class="inline-icon" /> (or right-click), and select **Rename**.
