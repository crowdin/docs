...
import branchesWorkflow from './_assets/branches_workflow.png';
import branchesStructure from './_assets/branches_structure.png';
import branchMerging from './_assets/branch_merging.png';
import branchTranslationVerification from './_assets/branch_translation_verification.png';
...
![Duplicates](./_assets/versions_duplicate_strings.png)
...
<Image src={branchTranslationVerification} alt="Branch Translation Verification" class="no-shadow mb-8" />
