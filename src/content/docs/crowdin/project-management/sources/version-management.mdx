...
<Screenshot src="/project-management/sources/branches_structure.png" alt="Branch Structure" class="no-shadow" />
...
* Create branches [manually](/files-management/#branches-and-folders).
...
<Screenshot src="/project-management/sources/versions_duplicate_strings.png" alt="Duplicates" />
...
<Screenshot src="/project-management/sources/branches_workflow.png" alt="Branches Workflow" class="no-shadow mb-8" />
...
<Screenshot src="/project-management/sources/branch_merging.png" alt="Merging Branches" class="no-shadow mb-8" />
...
<Screenshot src="/project-management/sources/branch_translation_verification.png" alt="Branch Translation Verification" class="no-shadow" />
