...
Once you've [created a project](/creating-project), the next step would be preparing source files for upload. Crowdin supports a wide range of [file formats](/supported-formats), including Android XML, iOS Strings, JSON, etc.

Usually, this task is accomplished by developers. You can [invite your colleague developer](/team-management) to assist you with this step.
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    ...
    2. Drag and drop files from your machine, or click **Upload Files**. You can upload ZIP archives if you want a set of folders and files to be added.

    <Screenshot src="/project-management/sources/upload_files.png" alt="Files tab in the project settings" />
  </TabItem>
  ...
  <TabItem label="String-based project">
    ...
    6. Click **Upload** to finish uploading the source content.

    <Screenshot src="/project-management/sources/upload_files_sb.png" alt="Files tab in the project settings" />
  </TabItem>
</Tabs>
...
* [Parser Configuration](/project-settings/parsers-configuration)

<Aside type="caution">
  XML files are not supported in string-based projects.
</Aside>
...
<Screenshot src="/project-management/sources/base_html_editor.png" alt="HTML file with a base tag displayed in the Editor" />

<Aside type="caution">
  HTML files are not supported in string-based projects.
</Aside>
...
After you add source content to Crowdin, you can [upload existing translations](/uploading-translations).

#### See Also

- [File Management](/files-management)
- [Versions Management](/version-management)
