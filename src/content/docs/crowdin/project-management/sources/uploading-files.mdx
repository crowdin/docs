...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    ...
    ![Files tab in the project settings](./_assets/upload_files.png)
  </TabItem>
  ...
  <TabItem label="String-based project">
    ...
    ![Files tab in the project settings](./_assets/upload_files_sb.png)
  </TabItem>
</Tabs>
...
![HTML file with a base tag displayed in the Editor](./_assets/base_html_editor.png)
