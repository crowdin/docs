...
<Image src={stringHide} alt="Changing visibility" />
...
<Image src={stringEdit} alt="String Editing" />
...
<Steps>
  ...
  2. Select needed labels in the *Labels* field. <Image src={labelsAdding1} alt="Add Labels" />
...
<Steps>
  ...
  3. Select needed labels in the *Labels to be added* field. <Image src={labelsAdding2} alt="Add Labels" />
