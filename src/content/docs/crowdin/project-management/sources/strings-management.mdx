...
<Screenshot src="/project-management/sources/string_hide.png" alt="Changing visibility" />
...
<Screenshot src="/project-management/sources/string_filter.png" alt="Filter Strings" />
...
<Screenshot src="/project-management/sources/string_edit.png" alt="String Editing" />
...
<Steps>
  ...
  2. Select needed labels in the *Labels* field. <Screenshot src="/project-management/sources/labels_adding_1.png" alt="Add Labels" />
...
<Steps>
  ...
  3. Select needed labels in the *Labels to be added* field. <Screenshot src="/project-management/sources/labels_adding_2.png" alt="Add Labels" />
