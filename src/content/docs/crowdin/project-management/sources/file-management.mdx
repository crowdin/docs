...
To quickly run auto-translation for one or more files or folders, right-click on the necessary item or click <Icon name="mdi:dots-horizontal" class="inline-icon" /> next to it and select **Auto-Translate**.

<ReadMore>
  Read more about [auto-translating selected files or folders](/auto-translation/#auto-translating-files-and-folders-via-context-menu).
</ReadMore>
