...
<Image src={webhooksAdd} alt="Add Webhook" class="width-xl" />
...
<ReadMore>
  Read more about [IP Addresses](/developer/ip-addresses#webhooks-and-mt-engines).
</ReadMore>
...
<Image src={webhooksCallsHistory} alt="Calls History" />
...
As soon as you create and configure your Slack app, you'll have a Webhook URL that should be used for the Webhooks configuration in your Crowdin project.
