...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    ...
    2. Click **Upload existing translations** to expand the respective section. <Screenshot src="/project-management/translations/upload_translations.png" alt="Upload Translations" />
    ...
    4. Crowdin automatically matches uploaded translations with appropriate source files and languages. Check it manually to make sure everything is matched correctly. <Screenshot src="/project-management/translations/upload_translations_2.png" alt="Match Files" />
  ...
  <TabItem label="String-based project">
    ...
    5. Click **Upload** to apply translations to the source strings. <Screenshot src="/project-management/translations/upload_translations_sb.png" alt="Upload Translations" />
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    ...
    2. Click <Icon name="heroicons:arrows-up-down-solid" class="inline-icon"/> and select **Upload XLIFF Translations**. <Screenshot src="/project-management/translations/upload_translations_xliff.png" alt="Upload Translations XLIFF" />
  </TabItem>
  <TabItem label="String-based project">
    ...
    3. Go to **File > Upload Translations**. <Screenshot src="/project-management/translations/upload_translations_xliff_sb.png" alt="Upload Translations XLIFF" />
  </TabItem>
</Tabs>
