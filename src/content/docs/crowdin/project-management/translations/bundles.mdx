...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      7. Once you've selected all the needed bundles in the **Add distribution** dialog, click **Next**. <Image src={contentDelivery} alt="Configure Bundle File Format" width="500" />
  ...
  <TabItem label="String-based project">
    <Steps>
      ...
      6. Once you've selected all the needed bundles in the **Add distribution** dialog, click **Next**. <Image src={contentDeliverySb} alt="Configure Bundle File Format" width="500" />
