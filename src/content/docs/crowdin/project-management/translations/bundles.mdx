...
import configureFormat from '!/crowdin/project-management/translations/bundles_configure_format.png';
import translationsBundles from '!/crowdin/project-management/translations/translations_bundles.png';
import translationsBundlesSb from '!/crowdin/project-management/translations/translations_bundles_sb.png';
import bundlesVcs from '!/crowdin/project-management/translations/bundles_vcs.png';
import contentDelivery from '!/crowdin/project-management/translations/bundles_content_delivery.png';
import contentDeliverySb from '!/crowdin/project-management/translations/bundles_content_delivery_sb.png';
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      7. Select the file format you'd like your strings to be exported in. To add other formats, install the respective applications from [Crowdin Store](https://store.crowdin.com/tags/string-exporter).
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      3. Click **Download** toward the needed bundle. <Image src={translationsBundles} alt="Download Bundle" />
    </Steps>
  </TabItem>
  <TabItem label="String-based project">
    <Steps>
      1. Open your project and go to the **Download** tab.
      2. Click **Target File Bundles** to expand the respective section.
      3. Click **Download** toward the needed bundle. <Image src={translationsBundlesSb} alt="Download Bundle" />
    </Steps>
  </TabItem>
</Tabs>
...
<Steps>
  ...
  6. To complete the VCS integration configuration, click **Save** in the dialog where you selected your repo and branches. <Image src={bundlesVcs} alt="VCS Target File Bundles Mode" />
</Steps>
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      7. Once you've selected all the needed bundles in the **Add distribution** dialog, click **Next**. <Image src={contentDelivery} alt="Configure Bundle File Format" class="width-lg" />
  ...
  <TabItem label="String-based project">
    <Steps>
      ...
      6. Once you've selected all the needed bundles in the **Add distribution** dialog, click **Next**. <Image src={contentDeliverySb} alt="Configure Bundle File Format" class="width-lg" />
      7. Copy <Icon name="mdi:content-copy" class="inline-icon" /> the **Distribution Hash** and **Distribution Manifest**. The manifest is a JSON file containing key distribution details (e.g., files, languages, paths) that can be used in your integration.
    </Steps>
  </TabItem>
</Tabs>
