...
![Screenshots in Editor](./_assets/screenshots_in_editor.png)
...
![Screenshots List](./_assets/screenshots_list_in_project_settings.png)
...
<Steps>
  ...
  3. Once the strings are tagged on the screenshot, click **Save**.
     ![Auto tag](./_assets/screenshots_auto_tag.png)
</Steps>
...
![Text Recognition](./_assets/screenshots_text_recognition.gif)
...
![Manual Tagging](./_assets/screenshots_manual_tagging.png)
...
<ReadMore>
  Read more about [porject labels](/project-settings/).
</ReadMore>
...
![Adding Labels to Single Screenshot](./_assets/screenshots_adding_labels_to_single_screenshot.png)
...
![Adding Labels to Multiple Screenshots](./_assets/screenshots_adding_labels_to_multiple_screenshots.png)
