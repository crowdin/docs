...
<LinkCard
  ...
  href="https://developer.crowdin.com/in-context-localization/#adding-screenshots-via-in-context"
  target="_blank"
/>
...
<Steps>
  ...
  4. Drag the needed string from the list in the right panel to the corresponding text on the screenshot.
     Alternatively, click on the strings to tag them in the screenshot without specifying the exact place where they should appear.
...
<Steps>
  ...
  3. In the appeared screen, add new labels and edit or remove existing ones.
</Steps>

<ReadMore>
  Read more about [project labels](/project-settings/).
</ReadMore>
