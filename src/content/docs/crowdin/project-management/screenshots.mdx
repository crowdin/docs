...
<CardGrid>
  <LinkCard
    ...
    description="Configure your project's Language Page View to enable screenshot translation."
    href="/project-settings/#project-language-page-view"
  />
  <LinkCard
    title="Screens Translation"
    description="Learn how to translate strings directly from your tagged screenshots in the Editor."
    href="/screens-translation/"
  />
</CardGrid>
