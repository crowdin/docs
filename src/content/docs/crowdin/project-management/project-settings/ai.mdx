...
In your project's **Settings > AI** section, you can configure and manage AI prompts and select default prompts for features like auto-translation, AI suggestions in the Editor, and AI-powered QA checks.

By default, prompts are inherited from the AI settings of the project owner's account. If defaults in the project owner's AI settings are not configured to apply automatically to all projects, select prompts in the project settings to activate auto-translation, AI suggestions, and AI-powered QA checks.
...
* Click <Icon name="mdi:dots-horizontal" class="inline-icon" /> on a prompt to **Use** (only for **Auto-Translation & AI Suggestion** prompts), **Edit**, **Clone**, or **Delete** it.
