...
[//]: # (https://support.crowdin.com/project-settings/#import + https://support.crowdin.com/enterprise/duplicated-strings/)

import {Steps, Aside, LinkCard, Tabs, TabItem, Icon} from '@astrojs/starlight/components';
