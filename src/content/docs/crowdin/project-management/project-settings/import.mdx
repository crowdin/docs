...
Crowdin will transform the translation placeholders back to the original format on export. This option only applies to iOS strings, iOS XLIFF, Apple Strings Catalog, and Android XML formats.
