...
![Filter Strings](./assets/string_filter.png)
...
![String Editing](./assets/string_edit.png)
...
<Steps>
  ...
  2. Select needed labels in the *Labels* field.
     ![Add Labels](./assets/labels_adding_1.png)
...
<Steps>
  ...
  3. Select needed labels in the *Labels to be added* field.
     ![Add Labels](./assets/labels_adding_2.png)
...
<Aside>
  String labels added to the project with an initial CSV/XLSX file upload aren't overwritten or removed during the following file updates.
</Aside>
