...
<Aside>
  The Overview report shows information about all the translations made in the project (including duplicate translations made by the same translator, removed translations, etc.).
</Aside>
...
Also, the Overview report provides a comprehensive visual analysis of the project's translation progress using the following graphs: Translation Activity, Proofreading Activity, Source Strings Activity, and Translation Savings.

The graphs are generated based on the text unit type selected for the Overview report.
