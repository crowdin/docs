...
Also, the Overview report provides a comprehensive visual analysis of the project's translation progress using the following graphs: Translation Activity and Proofreading Activity.

You can use this report to compare your contribution to overall project activity. The graphs are generated based on the text unit type selected for the Overview report.
