...
* **Use category-based proofread rates** (enabled by default): Treats each approval as an identical translation at the 100% match rate of its [Net Rate Scheme](#net-rate-schemes-my-contribution) category (TM, MT, AI, or Other). When disabled, all approvals use the flat **Proofread** base rate.
