...
This report tracks the overall translation and proofreading activity in the project. You can filter the data by **Date Range**. The report is split into two main parts: **Translation** and **Proofreading**.
