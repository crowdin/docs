---
title: Introduction
description: Get started with Crowdin and learn about its core features
slug: introduction
---

import { CardGrid, Card, LinkCard } from '@astrojs/starlight/components';

> These Docs will help you to start with Crowdin smoothly. You will find here all the necessary information about Crowdin and how to use it.
...
<CardGrid stagger>
  ...
  <Card title="Custom Variables">
    Specify variables that should not be translated. Custom variables will be highlighted in the source strings to translators. Contact us at [
  </Card>
</CardGrid>
