...
<LinkCard title="Hesap Ayarları" href="/account-settings/" />
...
* **Etkinlik** &ndash; tüm [Proje Etkinliği](/project-activity/)’nin gösterildiği sayfa. Örneğin, yorumlar, yeni katılan kullanıcılar, çevrilmiş ve düzeltilmiş dizgiler.
...
<LinkCard title="Çevrimiçi Düzenleyici" href="/online-editor/" />
...
Eğer zaten doğru bir öneri olduğunu görürseniz, çeviriyi beğendiyseniz *artı* <Icon name="mdi:plus" class="inline-icon" /> işaretini, çevirinin doğru olmadığını düşünüyorsanız *eksi* <Icon name="mdi:minus" class="inline-icon" /> işaretini tıklayarak öneriye oy verin. En olumlu oyu alan çeviriler daha yüksek bir derecelendirmeye sahip olacak ve dizgi için mevcut tüm çevirilerin en üstünde görünecektir.
