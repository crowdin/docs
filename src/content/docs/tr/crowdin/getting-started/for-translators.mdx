...
Kenar çubuğunun sağ üst kısmındaki **Menüyü sabitle/sabitlemeyi kaldır** <Icon name="mdi:pin" class="inline-icon" /> seçeneğine tıklayarak çalışma alanı görünümünüzü özelleştirebilirsiniz. Kenar çubuğunu sabitlemeyi kaldırmak, ana gezinme öğelerini sayfanın en üstüne taşıyacak.
