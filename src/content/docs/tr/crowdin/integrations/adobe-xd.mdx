...
Tasarımlarınızda Crowdin’deki kaynak dizgileri kullandıktan sonra, metin alanlarıyla bağlantılı hale gelirler ve Adobe XD’de bu dizgiler için [çevirileri önizleyebilir](#dizgileri-önizleme) ve bunlar için Crowdin projenize [ekran görüntülerini yükleyebilirsiniz](#etiketli-ekran-görüntülerini-crowdine-yükleme).
...
Tasarımınızda Crowdin’den gerekli ICU dizgisini [kullandıktan](#adobe-xdde-crowdinden-kaynak-dizgileri-kullanma) sonra, yer tutucularının değerlerini yapılandırabilirsiniz.
