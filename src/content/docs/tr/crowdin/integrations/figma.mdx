...
If your designs use [Figma variables](https://help.figma.com/hc/en-us/articles/15339657135383-Guide-to-variables-in-Figma) for UI copy, you can translate String variables in the **Variables** tab. In a variable collection, the default mode holds the source text, and each target language gets its own mode. Eklenti, varsayılan kip değerlerini kaynak dizgiler olarak Crowdin’e gönderir ve çevirileri tekrar dil kiplerine yazar. Bu değişkenleri kullanan tasarımlar daha sonra Figma’da yerel olarak çevrilmiş herhangi bir dile geçirilebilir.
