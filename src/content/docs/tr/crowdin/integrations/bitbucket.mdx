---
title: Bitbucket Bütünleştirmesi
description: Bitbucket deponuz ile Crowdin arasında dosyaları eşitleyin
slug: tr/bitbucket-integration
sidebar:
  order: 3
---
...
Bitbucket bütünleştirmesi, dosyaları Bitbucket deponuz ve Crowdin projeniz arasında eşitlemenizi sağlar.

<Aside>
  Ayarlamadan ve kullanmadan önce Crowdin hesabınıza [Bitbucket bütünleştirmesini yüklemeniz](https://store.crowdin.com/bitbucket) gerekecek.
</Aside>

Dosya tabanlı projelerde seçebileceğiniz iki olası Bitbucket bütünleştirme kipi vardır:

* **Kaynak ve çeviri dosyaları kipi** &ndash; kaynak ve çeviri dosyalarını Bitbucket deponuz ve Crowdin projeniz arasında eşitleyin.
* **Hedef dosya paketleri kipi** &ndash; Crowdin projesinden seçilen biçimde çeviri dosyaları oluşturun ve Bitbucket deponuza yollayın. Bu kipte bütünleştirme, çeviri dosyalarını yollar ve deponuzdan kaynakları eşitlemez. Crowdin projenizde bir kaynak metin incelemesi yaptığınız ve güncellenmiş kaynak metinleri deponuza almak istediğiniz durumlarda, çevirilerle birlikte deponuza yollanacak olan bir kaynak dili hedef dil olarak ekleyebilirsiniz.
...
## Bitbucket Hesabını Bağlama

<Steps>
  1. Projenizi açın ve **Bütünleştirmeler** sekmesine gidin.
  2. Bütünleştirmeler listesinde **Bitbucket**’a tıklayın.
  3. **Bütünleştirmeyi Ayarla**’ya tıklayın ve Bitbucket hesabınız aracılığıyla bütünleştirmek için açılır listeden **Kaynak ve çeviri dosyaları kipi** veya **Hedef dosya paketleri kipi**’ni seçin. <Image src={setUpIntegrationDropdown} alt="Bitbucket’ı Bağlama" class="width-sm" />
     <Aside>Dizgi tabanlı projelerde, Bitbucket bütünleştirmesi özellikle **Hedef dosya paketleri kipinde** çalışır.</Aside>
...
<Tabs syncKey="projectType">
  <TabItem label="Dosya tabanlı proje">
    <Image src={unconfigured} alt="Bitbucket Bütünleştirmesi Yapılandırılmama" class="crowdin-modal" />
  ...
  <TabItem label="Dizgi tabanlı proje">
    <Image src={unconfiguredSb} alt="Bitbucket Bütünleştirmesi Yapılandırılmama" class="crowdin-modal" />
  </TabItem>
</Tabs>
...
Bütünleştirmeyi ayarladığınızda, Crowdin projesine eklenen mevcut depo dallarını seçersiniz. Bitbucket’dan Crowdin’e ileride dalları otomatik olarak eklemek amacıyla bütünleştirme ayarlarında dal adları için bir model oluşturun.

Örneğin, Bitbucket bütünleştirmesi ayarlarına \**özellik* şeklinde bir model ekleyin. Bu durumda, başlığın sonunda bu kelimeyi içeren gelecekteki dallar projeye eklenecektir.

Dal adlarına bir şekil eklemek için şu adımları izleyin:

<Steps>
  1. Bitbucket bütünleştirmesi bölümünde **Düzenle**’ye tıklayın.
...
Çevirmek istediğiniz her ayrı dal ile birlikte `crowdin.yml` yapılandırma dosyası Bitbucket deposunda saklanmalıdır, böylece Crowdin çeviriler için tam olarak hangi dosyaların gönderilmesi gerektiğini bilir.
...
Bütünleştirme ayarlandıktan sonra, ilgili tüm bilgiler **Bütünleştirmeler > Bitbucket** içinde saklanır.
...
<Image src={syncNow} alt="Bitbucket Şimdi Eşitleyin" />
...
<Image src={uploadTranslations} alt="Bitbucket Çevirileri Yükleyin" />
