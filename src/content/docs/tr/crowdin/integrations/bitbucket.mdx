...
Alternatif olarak, eğer sadece bir dalı ayrı ayrı eşitlemeniz gerekiyorsa, gereken dalda <Icon name="mdi:dots-horizontal" class="inline-icon" /> simgesine tıklayın ve **Dalı eşitle**’yi seçin.
