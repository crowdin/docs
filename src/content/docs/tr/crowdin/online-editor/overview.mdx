...
* Tutarlılığı sağlamak için [sözlük](/glossary/) terimleri.
...
| <Icon name="mdi:image-outline" class="inline-icon" /> **Screenshots**                  | The string has screenshots attached.                          | **Bağlam ve Çeviriler** panelini ve [ekran görüntüsü görüntüleyicide](#ekran-görüntüsü-görüntüleyici) ilk ekran görüntüsünü açar. |
...
Çeviri kalitesini korumanıza ve yaygın hataları önlemenize yardımcı olmak için Düzenleyici, Kalite Güvencesi (KG) denetimlerini otomatik olarak gerçekleştirir. Bu denetlemeler, noktalama işaretleri tutarsızlıkları, boşluk uyuşmazlıkları, eksik yer tutucular veya tutarsız terminoloji gibi sorunları tarar.
...
YZ, ÇB ve MÇ önerileri tek bir daraltılabilir **Otomatikleştirilmiş Öneriler** bölümünde gruplandırılır.
...
When working in the Editor, you can view the TM suggestions displayed in the Automated Suggestions section and in the right sidebar found through the Search TM section. ÇB önerilerinin yanlışlıklar içerdiği veya güncellenmesi gereken durumlar olabilir.
...
Some terms may already have translations, which help maintain consistency across the project. Çevrilmiş bir terimi yeniden kullanmak için altı çizili metne tıklayın ve çevirisi otomatik olarak çeviri alanında görünecektir. Alternatif olarak, altı çizili metnin üzerine gelin, ardından kartta ihtiyacınız olan terim çevirisinin üzerine gelin ve **Ekle**’ye tıklayın. Terimin birden fazla çevirisi varsa ve belirli bir çeviri istiyorsanız bunu kullanın.

Eğer terimin henüz bir çevirisi yoksa, altı çizili metne tıklamak, sözlüğü yöneten proje üyeleri için **Kavramı Düzenle** ileti öğesini açar. Diğer proje üyeleri için Terminoloji bölümünü açar.

Her terim bir kart olarak gösterilir. Daraltılmış bir kart; terimi, konusunu ve çevirilerini durumlarıyla birlikte gösterir. Genişletmek için karta veya <Icon name="mdi:chevron-down" class="inline-icon" /> simgesine tıklayın. Genişletilmiş bir kart aynı zamanda kapsam tanımını, notu, görseli ve başvuru bağlantısını da gösterir. Her terim için herhangi bir açıklama, not ve başvuru bağlantısıyla birlikte dili, sözcük türünü, türü, cinsini ve durumunu gösterir.

Tüm kartları aynı anda genişletmek veya daraltmak için listenin yukarısındaki <Icon name="mdi:unfold-more-horizontal" class="inline-icon" /> simgesine tıklayın. Bu ayar bütün bölüme uygulanır ve Düzenleyiciyi bir sonraki açışınızda hatırlanır.

Kartın alt kısmında terimin geldiği sözlük gösterilmektedir. Sözlüğü yöneten proje üyeleri, sözlük kavramlarını açmak için ada tıklayabilir.

Proje sözlüğüne erişimi olan proje üyeleri terminolojiyi doğrudan bu bölümden yönetebilirler. Bir kavram eklemek için arama alanının yanındaki <Icon name="mdi:playlist-plus" class="inline-icon" /> simgesine tıklayın. Bir terimi düzenlemek için kartın üzerine gelin ve **Kavramı Düzenle** ileti öğesini açmak için <Icon name="mdi:pencil" class="inline-icon" /> simgesine tıklayın.

<Image src={terms} alt="Terminoloji" />

<ReadMore>
  [Sözlük Kavramlarını ve Terimleri Yönetme](/glossary/#sözlük-kavramlarını-ve-terimleri-yönetme) hakkında daha fazlasını okuyun.
</ReadMore>
...
* *Çeviri hizalama* &ndash; eğer etkinleştirildiyse, projede zaten çevirileri bulunan kaynak kelimelerin altını kesik çizgiyle çizer. Önceki çevirilerini ve her birinin kaç kez kullanıldığını görmek için altı çizili kelimenin üzerine gelin. [Çeviri Tutarlılığı](/translation-consistency/) hakkında daha fazlasını okuyun.
