...
<CardGrid>
  <LinkCard title="Ekran Görüntüleri" description="Learn how managers can upload and tag screenshots." href="/tr/screenshots/" />
  <LinkCard title="Figma Eklentisi" description="Learn how managers can upload tagged designs for translation directly from Figma." href="/tr/figma-plugin/#etiketli-ekran görüntülerini-crowdine-yükleme" />
  <LinkCard title="Proje Ayarları" description="Learn how managers configure the Language Page View to enable this feature." href="/tr/project-settings/#proje-dili-sayfa-görünümü" />
