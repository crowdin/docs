...
Alternatif olarak, yapılandırılabilir ayrıştırıcı ayarlarına sahip biçimler için aynı ayarları [**Paket oluştur**](/tr/bundles/#paketleri-yapılandırma) veya [**Paketi düzenle**](/tr/bundles/#paketleri-düzenleme) ileti öğesinde hedef biçimin yanındaki <Icon name="mdi:cog" class="inline-icon" /> simgesine tıklayarak açabilirsiniz.
