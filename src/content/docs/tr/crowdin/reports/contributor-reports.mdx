...
Bu rapor, projedeki genel çeviri ve düzeltme okuması etkinliğini izler. Verileri **Tarih Aralığı** ve **Dil**’e göre süzebilirsiniz. Rapor iki ana bölüme ayrılmıştır: **Çeviri** ve **Düzeltme Okuması**.
...
Bu bölüm, onaylanan metnin hacmini ve oylama etkinliğini gösterir. Görüntülenen ana ölçüm *Onaylanan* kelimelerdir.

**Düzeltme Okuması** grafiği zaman içindeki onay ve oylama etkinliğini iki farklı çizgiyle görselleştirir: *Onaylanan Kelimeler* ve *Oylar*. Veri noktalarının üzerine gelerek hem onaylanan metinlerin hem de kullanılan oyların günlük veya aylık toplamlarını görüntüleyebilirsiniz.
...
<Image src={costEstimateGenerating} alt="Maliyet Tahmini Oluşturma" />
...
* **Tam çeviri** &ndash; bir kişi tarafından yapılan her çeviri için.
  <Aside>Eğer dizgide aynı kişi tarafından yapılmış birden çok çeviri varsa, sadece biri sayılır. Eğer dizginin farklı kişiler tarafından yapılmış birden fazla çevirisi varsa, her biri belirli bir çevirmen olarak sayılır.</Aside>
* **Düzeltme** &ndash; onaylanan her çeviri için.
...
* **101 (mükemmel)** &ndash; Mükemmel eşleşme ÇB önerileri kullanılarak yapılan çeviriler için (kaynak dizgiler, metin ve içerik olarak ÇB önerisiyle birebir aynıdır).
* **100** &ndash; %100 eşleşen ÇB önerileri kullanılarak yapılan çeviriler için (kaynak dizgiler sadece metin olarak ÇB önerisiyle birebir aynıdır).
...
<Steps>
  1. Net Fiyat Şemaları bölümünde <Icon name="mdi:cog" class="inline-icon" /> simgesine tıklayın.
  2. Görünen <Icon name="mdi:plus" class="inline-icon" /> düğmesine tıklayın.
  3. ÇB eşleşme aralığını ve tam çeviri fiyatı yüzdesini belirtin.
  4. Ayarları kaydetmek için <Icon name="mdi:cog" class="inline-icon" /> simgesine tıklayın.
</Steps>
...
* **Alt toplamlar** - Her görev için maliyet tahmini:
  * **Çeviri** – Yeni veya güncellenmiş çeviriler gerektiren dizgilerin maliyeti (yüksek yüzdeli eşleşme avantajı yok).
  * **Düzeltme Okuması** – Çevirileri gözden geçirme maliyeti.
  * **ÇB Tasarrufları** – Varolan çevirilerden (ÇB’de veya proje dahilinde) yapılan tasarruflar.
  * **Ağırlıklı Kelimeler / Dizgiler / Karakterler / Boşlukları Olan Karakterler** – ÇB/dahili eşleşme indirimleri uygulandıktan sonra maliyet hesaplamaları için son kelime sayısı.
