...
<CardGrid>
  ...
  <LinkCard title="Varsayılan ÇB’yi Değiştirme" href="/tr/project-settings/translation-memories/#varsayılan-çbyi-değiştirme" />
</CardGrid>
...
3. Atanmış ÇB Önceliği &ndash; ÇB önerisinin depolandığı ÇB’nin önceliği. <ReadMore>[ÇB’yi Önceliklendirme](/tr/project-settings/translation-memories/#çbyi-önceliklendirme) hakkında daha fazlasını okuyun.</ReadMore>
