...
<CardGrid stagger>
  <Card title="Invite users">
    Invitar a la gente a tus proyectos y definir su nivel de acceso: gerente, traductor, revisor. Additionally, you can configure access for translators and proofreaders to specific target languages.
  </Card>
  <Card title="Informes básicos">
...
<CardGrid stagger>
  ...
  <Card title="CLI">
    Integra fácilmente Crowdin con tu servidor CI, GIT, SVN, Mercurial y más. Connect cross-platform Crowdin CLI directly to your code repository.
  </Card>
  <Card title="API">
  ...
  <Card title="Formatos de archivo personalizados">
...
<CardGrid stagger>
  <Card title="Memoria de Traducción (TM)">
    TM es una base de datos que almacena las cadenas de contenido que se han traducido anteriormente. Reuse translations for the same or similar content you add. Use project-based TM (available only to the assigned project) or global TM (stores translations contributed by all of the open projects).
  </Card>
  ...
  <Card title="Capturas de pantalla">
...
<CardGrid stagger>
  ...
  <Card title="Traducción sin conexión">
    Enable translators to download source files and make translations offline on their machines.
  </Card>
  <Card title="Texto oculto">
    Los textos ocultos no deben ser traducidos. They are visible only to the project owner and managers.
  </Card>
...
<LinkCard title="Servicios de soporte adicionales" description="Need help with translations, project setup, or other services? Check out our additional support services." href="/additional-support-services/" />
