...
<LinkCard title="Expresión de los Elementos Sintácticos" description="Learn how to build and use verbal expressions with practical examples." href="/expression-syntax-elements/" />
