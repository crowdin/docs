...
<CardGrid>
  <LinkCard title="Capturas de pantalla" description="Learn how managers can upload and tag screenshots." href="/screenshots/" />
  <LinkCard title="Plugin Figma" description="Learn how managers can upload tagged designs for translation directly from Figma." href="/figma-plugin/#uploading-tagged-screenshots-to-crowdin" />
  <LinkCard title="Ajustes del Proyecto" description="Learn how managers configure the Language Page View to enable this feature." href="/project-settings/#project-language-page-view" />
