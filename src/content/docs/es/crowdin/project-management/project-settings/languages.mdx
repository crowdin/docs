...
<Image src={languageMapping} alt="Mapeo de idioma" />

## See Also

<LinkCard title="Idiomas soportados" description="Explore the list of languages supported by Crowdin." href="/developer/language-codes/" />
