...
<CardGrid>
  <LinkCard title="Subida de Traducciones Existentes" description="Learn how to upload existing translations to your project." href="/uploading-translations/" />
  <LinkCard title="Gestión de archivos" description="Manage and configure source files in your project." href="/file-management/" />
