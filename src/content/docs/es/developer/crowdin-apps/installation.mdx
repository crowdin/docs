...
<Image src={installPermissions} alt="Permisos" class="width-md m-auto crowdin-modal" />
...
<Image src={installPermissionsEnterprise} alt="Permisos" class="width-md m-auto" />
