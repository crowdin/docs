...
* **Design Tools Integration:** Send strings from design tools (Figma, Sketch, Adobe XD) directly to Crowdin Enterprise and export translations in development-ready formats using bundles.
* **Offline Translation:** Export specific string sets in XLIFF format for offline translation and [upload finished translations](/enterprise/offline-translation/#uploading-translations) back to Crowdin Enterprise.

<CardGrid>
  <LinkCard title="Custom Bundle Generator" description="The app allows you to generate resource files from translated Crowdin strings." href="https://store.crowdin.com/custom-bundle-generator" target="_blank" />
  <LinkCard title="Custom Bundle Builder" description="Create your own script to build files from bundles." href="https://store.crowdin.com/custom-export" target="_blank" />
</CardGrid>
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      9. Click **Create**. <Image src={createBundle} alt="Create Bundle" />
    </Steps>
  </TabItem>
  <TabItem label="String-based project">
    <Steps>
      ...
      5. *(Optional)* Set **String filters**:
         * **Include labels**: Only export strings containing specific labels.
         * **Exclude labels**: Skip strings containing specific labels.
         * You can adjust the logic for multiple labels (e.g., *All selected labels* (AND) vs *Any selected label* (OR)). <ReadMore>Read more about [Labels](/enterprise/string-management/#labels).</ReadMore>
      6. Configure **Languages**:
         * **All target languages**: Selected by default. This option is dynamic and will automatically include any new languages added to the project in the future.
         * **Source language**: Select to include the source language content in the bundle.
         * **In-context pseudo-language**: Select to export your files with the metadata required for the [In-Context](/developer/in-context-localization/) integration.
      ...
      7. Configure **Target files** (Right Panel):
         ...
         * *(Optional)* Set a **Source language export pattern**.
      8. Check the **Preview** panel to ensure the structure looks correct.
      9. Click **Create**. <Image src={createBundleSb} alt="Create Bundle" />
    </Steps>
  </TabItem>
</Tabs>
...
<Steps>
  ...
  3. Click <Icon name="mdi:dots-vertical" class="inline-icon" /> next to the format you want to configure and select **Edit**. Alternatively, just click on the needed format.
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      1. Open your project and select **Translations** on the left sidebar.
      2. Expand the **Downloads** section.
      3. Click <Icon name="mdi:dots-vertical" class="inline-icon" /> next to the bundle and select **Edit**. Alternatively, just double-click on the needed bundle.
  ...
  <TabItem label="File-based project">
    <Steps>
      ...
      3. Delete the bundles using one of the following methods:
         * **Single bundle**: Click <Icon name="mdi:dots-vertical" class="inline-icon" /> next to the bundle and select **Delete**.
...
<LinkCard title="Configuring CDN Distributions" description="Learn how to create distributions, manage releases, and check usage statistics." href="/enterprise/cdn-distributions/" />
...
<CardGrid>
  <LinkCard title="Bundles in CLI" href="https://crowdin.github.io/crowdin-cli/commands/crowdin-bundle/" target="_blank" />
  <LinkCard title="Bundles in API" href="/developer/api/v2/#tag/Bundles" />
</CardGrid>
