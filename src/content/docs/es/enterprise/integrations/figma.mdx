...
* Deje de usar 'Lorem Ipsum', agregue textos reales de Crowdin Empresa a sus prototipos. Strings added from Crowdin Enterprise become linked to the text fields in Figma.
* Cree y cargue cadenas de origen de sus diseños a su proyecto de Crowdin Empresa. Created strings become linked to text fields in Figma. This way, developers could use uploaded strings, reducing time spent on development.
