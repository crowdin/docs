...
<Image src={stringSearch} alt="Búsqueda de cadenas" />
...
La frase de búsqueda está limitada a 128 caracteres. If you use a search phrase longer than 128 characters, it will be automatically truncated to the maximum allowed length.
...
<Aside type="caution" title="Permisos">
...
<LinkCard title="Expresión de los Elementos Sintácticos" description="Learn how to build and use verbal expressions with practical examples." href="/enterprise/expression-syntax-elements/" />
