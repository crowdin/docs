...
<Image src={organizationSettingsMenuItem} alt="Ajustes de Organización" />
...
<Steps>
  ...
  2. Specify a language name and choose the main language if a custom language is a dialect.
