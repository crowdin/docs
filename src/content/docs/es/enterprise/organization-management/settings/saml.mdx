...
## Configuración de SAML SSO para Google Workspace {#google-workspace}
...
## Configurando SAML SSO para Microsoft Azure {#microsoft-azure}
...
#### Asignar usuarios {#assign-users-azure}
...
## Configurando SAML SSO para Okta {#okta}
...
#### Asignar usuarios {#assign-users-okta}
...
## Configurando SAML SSO para OneLogin {#onelogin}
...
#### Asignar usuarios {#assign-users-onelogin}
...
## Configurando SAML SSO para Auth0 {#auth0}
