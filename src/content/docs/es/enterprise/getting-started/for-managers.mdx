...
<Image src={screenshotsListInProjectSettings} alt="Capturas de pantalla" />
...
<Image src={createWorkflow} alt="Flujo de trabajo" />
...
<Image src={reportsTab} alt="Informes del proyecto" />
