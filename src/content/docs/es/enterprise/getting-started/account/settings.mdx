...
<Image src={introAccountSettings} alt="Ajustes de la cuenta" class="width-2xl" />
...
Cambia tu contraseña actual, gestiona la autenticación de dos factores para la cuenta, y mira las aplicaciones vinculadas. Puedes también controlar la autentificación de servicios externos y cerrar sesión en todos los dispositivos.
...
| Strength      | Visual Indicator | Estado       | Descripción                                                                                                             |
| :------------ | :--------------- | :----------- | :---------------------------------------------------------------------------------------------------------------------- |
...
<Image src={sudoModeConfirmingCredentials} alt="Confirmación de credenciales" class="width-md" />
...
<Image src={tokens} alt="Tokens de Acceso Personal" />
