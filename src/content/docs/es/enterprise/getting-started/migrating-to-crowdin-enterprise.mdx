---
title: Migrando a Crowdin Enterprise
...
Crowdin Enterprise proporciona funciones de cooperación en equipo (por ejemplo, invitar a usuarios del proyecto, definir niveles de permisos, tareas, mensajes, etc.), automatización y personalización del flujo de trabajo, integraciones y complementos, y muchas más funciones que necesitaría para una traducción eficiente del proyecto.

La migración a Crowdin Enterprise es muy simple y directa. For example, if your projects share most of the settings and configurations, you can create and configure one project and then, using the [Project Duplicator](https://store.crowdin.com/create-project-app) application, create all other projects based on the initial project settings, later changing some settings where needed. Según el proyecto y el número de recursos, la migración completa se puede realizar en varias horas.

## Envío de textos para traducción a Crowdin Empresa {#from-other-tools}

Para comenzar su migración, puede usar las siguientes instrucciones de migración paso a paso.
...
<LinkCard title="Para administradores" description="Read our quick guide for a seamless localization setup." href="/enterprise/for-managers/" />

## Selección del proyecto de Crowdin Empresa {#from-crowdin}
...
<Steps>
  1. **Inviting the translation team**.<br />
     In Crowdin Enterprise you can choose your translation strategy based on the content you're localizing. Elija una y combine varias estrategias de traducción: envíe una solicitud a un proveedor de traducción integrado con Crowdin Empresa, traiga una agencia de traducción con la que ya trabaja, invite a su comunidad, use la pretraducción a través de la traducción automática o la memoria de traducción, etc.

  2. **Integration with external services**.<br />
     In Crowdin Enterprise, you can use system integrations (e.g., integrations with GitHub, GitLab, BitBucket, Azure Repos, etc.) to synchronize your source and translation files, install additional applications from the [Crowdin Store](https://store.crowdin.com/) to add new features and integrate with even more services. Incluso si no hay integración con algunos servicios/plataformas que utiliza, puede crear su integración personalizada mediante el desarrollo de aplicaciones de Crowdin.
</Steps>

<CardGrid>
  <LinkCard title="Estrategias De Traducción" href="/enterprise/translation-strategies/" />
  <LinkCard title="Aplicaciones de Crowdin" href="/developer/crowdin-apps-about/" />
</CardGrid>

## Assistance from Our Team

Si necesita ayuda durante el proceso de migración, nuestro equipo está listo para ayudarlo con cualquier paso. For any guidance, feel free to [contact us](https://crowdin.com/contacts).
