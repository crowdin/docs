...
**Last revised on September 23, 2026.** Previous versions of this document are available on [GitHub](https://github.com/crowdin/docs/commits/main/src/content/docs/docs/terms.mdx).
...
The Crowdin Services are provided on a subscription basis for the period selected by the Client (the "Initial Term"). To ensure continuity of services, the subscription shall renew upon expiration of the current term as follows, unless canceled by the Client or otherwise terminated in accordance with these Terms.
...
The Supplier will process data on behalf of the Client until the termination of the Crowdin Services in accordance with these Terms. Upon termination, Crowdin will retain the Client’s data in active production databases for a period of sixty (60) days (unless otherwise agreed in writing with the Client), during which the Client shall be permitted to extract and export Client Data in accordance with clause 5.4 of these Terms. Following the expiration of this sixty (60) day period, the Supplier shall delete or anonymize Client Data from active databases. Any residual copies stored in system backups shall be securely overwritten or deleted in accordance with Supplier’s standard backup retention schedule, unless longer storage is required by applicable laws.
...
- use the Crowdin Services, Content, Client Data, or any parts or derivatives thereof to train, test, develop, tune, or validate any artificial intelligence models, machine learning algorithms, or large language models (LLMs) without Supplier’s explicit prior written consent;
...
Client will defend Supplier against any claim, demand, suit, or proceeding made or brought against Supplier by a third party alleging that the Client Data infringes or misappropriates the intellectual property rights of a third party, and shall indemnify Supplier for any damages, attorney fees, and legal costs finally awarded against Supplier as a result of such claim; provided that Supplier (a) promptly gives Client written notice of the claim; (b) gives Client sole control of the defense and settlement of such claim; and (c) provides to Client all reasonable assistance.
...
- immediately by either party if the other party breaches its obligations, as applicable under sections 12 **Intellectual Property Rights** and 16 **Indemnification** of these Terms.
...
Upon termination or expiration of these Terms, Supplier shall deactivate and permanently delete the Account within sixty (60) days of the effective date of termination, unless otherwise agreed in writing with the Client as specified in clause 5.4 and clause 9.2. If the Client has specifically requested for an earlier deletion of the Account, Supplier shall fulfill such request within 1 month of its receipt of such request.
...
The Client undertakes that during the subscription term and for a period of twelve (12) months following its termination or expiration, the Client shall not, directly or indirectly, solicit, hire, recruit, or retain as an employee, independent contractor, or service provider, any employee or active consultant of the Supplier, or induce or attempt to induce any such person to terminate or reduce the scope of their engagement with the Supplier.
