...
<Badge text="Effective date: July 7, 2026" variant="note" size="medium" class="mb-4" />
...
| Sub-processor            | Purpose and Description                                                              | Country of Origin        |
|--------------------------|--------------------------------------------------------------------------------------|--------------------------|
...
| Cloudflare, Inc.         | Cloud infrastructure services for application hosting and secure user authentication | United States of America |
