...
<span class="badge badge-info" style="font-size: 100%">Last revised on November 1, 2018</span>
...
If you need a signed Data Processing Addendum in addition to the Terms of Service and Privacy Policy, you can find the document signed on behalf of Crowdin [here](https://downloads.crowdin.com/docs/DPA-singed.pdf){: target="_blank"}.
