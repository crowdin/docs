...
Die GitLab-Integration ermöglicht es dir, Dateien zwischen deinem GitLab-Repository und deinem Crowdin-Projekt zu synchronisieren.

<Aside>
  Du musst die [GitLab-Integration installieren](https://store.crowdin.com/gitlab) in deinem Crowdin-Konto, bevor du sie einrichten und verwenden kannst.
</Aside>

In dateibasierten Projekten kannst du zwischen zwei möglichen GitLab-Integrationsmodi wählen:

* **Modus für Quell- und Übersetzungsdateien** &ndash; Synchronisiere Quell- und Übersetzungsdateien zwischen deinem GitLab-Repository und deinem Crowdin-Projekt.
* **Modus für Zieldateibundles** &ndash; Erstelle Übersetzungsdateien im ausgewählten Format aus dem Crowdin-Projekt und übertrage sie in dein GitLab-Repository. In diesem Modus überträgt die Integration Übersetzungsdateien und synchronisiert keine Quellen aus deinem Repository. Wenn du in deinem Crowdin-Projekt eine Überprüfung des Ausgangstexts durchführst und die aktualisierten Ausgangstexte in dein Repository übernehmen möchtest, kannst du eine Ausgangssprache als Zielsprache hinzufügen. Diese wird zusammen mit den Übersetzungen in dein Repository übertragen.
...
<Aside type="tip" title="Verwendest du GitLab CI/CD?">
...
<Steps>
  ...
  3. Klicke auf **Integration einrichten** und wähle in der Dropdown-Liste **Modus für Quell- und Übersetzungsdateien** oder **Modus für Zieldateibundles** aus, um dein GitLab-Konto zu verbinden. <Image src={setUpIntegrationDropdown} alt="GitLab-Integration – GitLab verbinden" class="width-sm" />
     <Aside>In stringbasierten Projekten arbeitet die GitLab-Integration ausschließlich im **Modus für Zieldateibundles**.</Aside>
  4. Autorisiere anschließend die Verbindung mit Crowdin auf der GitLab-Seite: <Image src={authorization} alt="GitLab-Integration – Autorisierung" class="width-sm" />
</Steps>
...
<Tabs syncKey="projectType">
  <TabItem label="Dateibasiertes Projekt">
    <Image src={unconfigured} alt="GitLab-Integration nicht konfiguriert" class="crowdin-modal" />
  ...
  <TabItem label="Zeichenfolgenbasiertes Projekt">
    <Image src={unconfiguredSb} alt="GitLab-Integration nicht konfiguriert" class="crowdin-modal" />
  </TabItem>
</Tabs>
...
<Aside type="tip">
  Wir empfehlen, den Branch `l10n_` nach dem Zusammenführen des Merge Requests aus deinem Repository zu löschen, um mögliche Konflikte zu vermeiden. Crowdin erstellt den Service-Branch automatisch neu, sobald neue Übersetzungen zur Synchronisierung bereit sind.
</Aside>
...
Beim Einrichten der Integration wählst du vorhandene Repository-Branches aus, die dem Crowdin-Projekt hinzugefügt werden sollen. Um zukünftige Branches aus GitLab automatisch zu Crowdin hinzuzufügen, erstelle in den Integrationseinstellungen ein Muster für die Branch-Namen.
...
<Image src={syncNow} alt="GitLab-Integration jetzt synchronisieren" />
...
<Image src={uploadTranslations} alt="Übersetzungen der GitLab-Integration hochladen" />
