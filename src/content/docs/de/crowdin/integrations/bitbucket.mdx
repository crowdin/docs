...
Die Bitbucket-Integration ermöglicht es Ihnen, Dateien zwischen Ihrem Bitbucket-Repository und Ihrem Crowdin-Projekt zu synchronisieren.

<Aside>
  Du musst die [Bitbucket-Integration installieren](https://store.crowdin.com/bitbucket) in deinem Crowdin-Konto, bevor du sie einrichten und verwenden kannst.
</Aside>

Bei dateibasierten Projekten gibt es zwei mögliche Bitbucket-Integrationsmodi, zwischen denen Sie wählen können:

* **Modus für Quell- und Übersetzungsdateien** &ndash; Synchronisiere Quell- und Übersetzungsdateien zwischen deinem Bitbucket-Repository und deinem Crowdin-Projekt.
* **Modus für Zieldateibundles** &ndash; Erstelle Übersetzungsdateien im ausgewählten Format aus dem Crowdin-Projekt und übertrage sie in dein Bitbucket-Repository. In diesem Modus überträgt die Integration Übersetzungsdateien und synchronisiert keine Quellen aus deinem Repository. Wenn du in deinem Crowdin-Projekt eine Überprüfung des Ausgangstexts durchführst und die aktualisierten Ausgangstexte in dein Repository übernehmen möchtest, kannst du eine Ausgangssprache als Zielsprache hinzufügen. Diese wird zusammen mit den Übersetzungen in dein Repository übertragen.
...
<Tabs syncKey="projectType">
  <TabItem label="Dateibasiertes Projekt">
    <Image src={unconfigured} alt="Bitbucket-Integration unkonfiguriert" class="crowdin-modal" />
  ...
  <TabItem label="Zeichenfolgenbasiertes Projekt">
    <Image src={unconfiguredSb} alt="Bitbucket-Integration unkonfiguriert" class="crowdin-modal" />
  </TabItem>
</Tabs>
...
Beim Einrichten der Integration wählst du vorhandene Repository-Branches aus, die dem Crowdin-Projekt hinzugefügt werden sollen. Um zukünftige Branches aus Bitbucket automatisch zu Crowdin hinzuzufügen, erstellen Sie in den Integrationseinstellungen ein Muster für die Branch-Namen.
...
Die Konfigurationsdatei `crowdin.yml` sollte zusammen mit jedem separaten Branch, den du übersetzen möchtest, im Bitbucket-Repository gespeichert werden, damit Crowdin weiß, welche Dateien genau zur Übersetzung gesendet werden sollen.
...
<Image src={uploadTranslations} alt="Bitbucket Upload Übersetzungen" />
