...
<LinkCard title="Mitwirkendenberichte" description="Schätze und berechne den Preis deines Beitrags zum Projekt." href="Du kannst Übersetzungen aus deinem Crowdin-Projekt herunterladen, indem du verschiedene Optionen wie die Weboberfläche, den Console Client (CLI), die API und Integrationen kombinierst." />
