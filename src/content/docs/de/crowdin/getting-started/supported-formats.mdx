...
Unsere Entwickler können einen speziellen Prozessor erstellen, wenn Sie benutzerdefinierte Einstellungen für den Dateiexport konfigurieren möchten. Du lädst beispielsweise eine Schlüssel-Wert-Datei hoch, die standardmäßig keine [Zeichenfolgenbearbeitung](/string-management/#string-editing) unterstützt, und möchtest sie direkt in Crowdin bearbeiten. Wir können deine Datei vorübergehend in das CSV-Format konvertieren, damit du Zeichenketten online hinzufügen kannst. Die exportierte Datei bleibt im ursprünglichen Format.
