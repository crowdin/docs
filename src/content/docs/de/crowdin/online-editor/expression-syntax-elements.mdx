...
Im Editor kannst du verbale Ausdrücke im [Erweiterten Filter](/online-editor/#advanced-filter) verwenden, um nach Strings zu suchen, die bestimmten Mustern entsprechen, ähnlich wie reguläre Ausdrücke. Du kannst Verwende it zu Filtere Zeichenfolgen based auf patterns like punctuation, character Typen, length, und mehr.
