...
Im Editor kannst du verbale Ausdrücke im [Erweiterten Filter](/online-editor/#advanced-filter) verwenden, um nach Strings zu suchen, die bestimmten Mustern entsprechen, ähnlich wie reguläre Ausdrücke. You can use it to filter strings based on patterns like punctuation, character types, length, and more.
