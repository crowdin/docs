...
description: Mit dem Crowdin Editor produktiver arbeiten
slug: online-editor
sidebar:
  order: 0
---
...
Der Editor ist der zentrale Bereich in Crowdin, in dem Projektmitglieder an Übersetzungen arbeiten können. Damit können Benutzer online Übersetzungen vorschlagen, darüber abstimmen, sie prüfen und freigeben.
...
* Vorschläge mit [KI-Unterstützung](/crowdin-ai/#using-ai-in-the-editor), Vorschläge aus der [Translation Memory (TM)](/translation-memory/) und [maschinelle Übersetzung (MT)](/machine-translation/).
* [Glossar](/glossary/)-Begriffe zur Sicherstellung der Konsistenz.
...
Dieser Bereich zeigt die Liste der Zeichenfolgen ein, wobei die aktive Zeichenfolge hervorgehoben ist. Zeichenfolgen sind Textelemente, die aus einzelnen Wörtern, Ausdrücken oder Sätzen bestehen. Einige Zeichenfolgen können Ersetzungstoken enthalten (e.g., {0}, {1}, %1, etc.) oder Elemente der [ICU-Nachrichtensyntax](/icu-message-syntax/). Solche Elemente selbst sollten nicht übersetzt werden, sondern werden vom Website-Code verwendet, um dynamisch Informationen in Zeichenfolgen einzufügen. Um mit solchen Zeichenfolgen zu arbeiten, kopiere die Quellzeichenfolge und übersetze nur die eigentlichen Wörter.
...
<Aside>
  Stelle sicher, dass du [QA-Prüfungen](/project-settings/qa-checks/) aktivierst, damit du Strings findest, die überprüft werden müssen. Probleme gefunden wird sein hervorgehoben in red under der übersetzt Zeichenfolgen dass require revision.
</Aside>
...
* *ausgeblendet* &ndash; Zeige Zeichenfolgen dass sind ausgeblendet von Übersetzer. Strings können von Projektmanagern ausgeblendet oder von Crowdin automatisch ausgeblendet werden, wenn sie als Duplikate markiert sind.
...
Einige Zeichenketten könnten Pluralformen enthalten. Je nach der Sprache, der number von plural forms kann vary. Zum Beispiel, Chinese hat one plural form, English hat two plural forms, und other Sprachen kann haben up zu six plural forms. Crowdin verarbeitet Pluralformen gemäß den CLDR-Regeln für Sprachpluralformen.
...
* **Bestätigung entfernen** &ndash; Entfernt die Bestätigung einer Übersetzung und setzt ihren Status auf nicht bestätigt zurück. (verfügbar für Korrekturleser oder higher.)
...
* KI-Vorschläge (falls in den [Projekteinstellungen](/project-settings/ai/) aktiviert)
...
KI-, TM- und MT-Vorschläge werden in einem einzigen einklappbaren Bereich **Automatisierte Vorschläge** zusammengefasst.
...
Using der **Kommentare** Bereich, du kann discuss der meaning von der Quelle Zeichenfolge oder other related questions. It ist recommended zu Verwende ein Quelle Sprache von der Projekt so other Übersetzer kann understand it. Verwende der "@" character und ein username zu direct dein message zu der spezifisch person.
...
<LinkCard title="Probleme" description="Erfahre, wie du report und manage Übersetzung Probleme in der Editor." href="/issues/" />

### Suche TM

Im Bereich *TM durchsuchen* kannst du alle verfügbaren Übersetzungen aus der [Translation Memory](/translation-memory/) prüfen, dem Speicher für Übersetzungen, die von Projektmanagern in das System hochgeladen wurden. zu help du find der best Ergebnisse quickly, der Suche prioritizes und displays der most relevant matches bei der top von der Liste.
...
<ReadMore>
  Weitere Informationen zum [Verwalten von Glossarkonzepten und Begriffen](/glossary/#managing-glossary-concepts-and-terms).
</ReadMore>
...
Im Bereich *Dateikontext* kannst du Übersetzern zusätzliche Details bereitstellen, damit sie verstehen, wie eine bestimmte Datei übersetzt werden soll. Dateikontext kann als einfacher Text oder Markdown entweder direkt im Editor oder über die [Dateieinstellungen](/file-management/#file-context) von Projektmitgliedern mit Manager-Berechtigungen (oder höher) hinzugefügt werden. Für andere Projektmitglieder ist der Dateikontext schreibgeschützt.
...
* *Übersetzungsabgleich* &ndash; Wenn aktiviert, werden Quellwörter, für die bereits Übersetzungen im Projekt vorhanden sind, mit einer gestrichelten Linie unterstrichen. Bewege den Mauszeiger über ein unterstrichenes Wort, um seine früheren Übersetzungen und die jeweilige Verwendungshäufigkeit anzuzeigen. Weitere Informationen zur [Übersetzungskonsistenz](/translation-consistency/).
...
* *UI-Sprache* &ndash; Wähle deine bevorzugte Sprache für die Crowdin-Oberfläche aus. Die ausgewählte Sprache wird auf den Editor und andere Bereiche von Crowdin angewendet.
...
Der Pfad dient als visuelle Anzeige deines Standorts (Projektname, Zielsprache oder Dateiname) und liefert beim Darüberfahren schnelle Referenzinformationen:
...
<Aside type="caution" title="Berechtigungen">
  Die Verfügbarkeit der Option *Begriff erstellen* hängt von den von den Projektmanagern konfigurierten [Glossarzugriffseinstellungen](/project-settings/privacy-collaboration/#glossary-access-settings) ab.
</Aside>
...
<Steps>
  1. Wähle im Tab *Dashboard* des Projekts die gewünschte Sprache aus.
...
<ReadMore>
  Weitere Informationen zur [Auto-Übersetzungswarteschlange](/auto-translation/#auto-translation-queue).
</ReadMore>
...
* **Suchen in**: Wählen Sie aus, auf welchen Teil der Zeichenfolgen sich die Suche bezieht. Zu den Optionen gehören *Alles*, *Zeichenfolgen*, *Kontext*, *Alle Übersetzungen*, *Endgültige Übersetzungen* oder *Bezeichner (Schlüssel)*.
...
* **Duplikate**: Filtere Zeichenfolgen nach ihrem Duplikatstatus. Optionen include *Master-Zeichenfolges*, *Duplicates nur*, *Duplicates mit Shared Übersetzungen*, und *Duplicates mit Own Übersetzungen*. <Aside>Diese Option wird nur angezeigt, wenn [**Doppelte Strings**](/project-settings/import/#duplicate-strings) so konfiguriert ist, dass Duplikate automatisch übersetzt werden. Shared Übersetzungen come von der Master-Zeichenfolge, während own Übersetzungen sind entered direkt auf der duplicate.</Aside>
...
<LinkCard title="Syntaxelemente für Ausdrücke" description="Erfahre, wie du build und Verwende verbal expressions mit practical examples." href="/expression-syntax-elements/" />
