...
Diese Ansicht wird von einem Projektmanager im Bereich [**Einstellungen > Allgemein > Projekt-Sprachseitenansicht**](/project-settings/#project-language-page-view) des Projekts aktiviert. When enabled, the screenshots will be displayed on the project's language page instead of the traditional file list.
...
<Steps>
  ...
  6. Enter your translation in the text area and click <Icon name="mdi:content-save" class="inline-icon" /> **Save translation**.
  7. You can continue clicking other tags on the screenshot to translate them in order. <Image src={screenshotPreview} alt="Editor view with a screenshot preview" />
</Steps>
...
<CardGrid>
  <LinkCard title="Screenshots" description="Learn how managers can upload and tag screenshots." href="/screenshots/" />
  <LinkCard title="Figma Plugin" description="Learn how managers can upload tagged designs for translation directly from Figma." href="/figma-plugin/#uploading-tagged-screenshots-to-crowdin" />
  <LinkCard title="Projekteinstellungen" description="Learn how managers configure the Language Page View to enable this feature." href="/project-settings/#project-language-page-view" />
  <LinkCard title="Automating Screenshot Management" description="Learn how developers can automate screenshot generation using In-Context and Playwright." href="/developer/automating-screenshot-management/" />
</CardGrid>
