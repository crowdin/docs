...
<CardGrid>
  <LinkCard title="TM Match Calculation" href="#tm-match-calculation" />
  <LinkCard title="Vorübersetzung" href="/pre-translation/" />
</CardGrid>
...
<Aside>
  If the string was translated with an improved suggestion displayed, it would be counted as such. Regardless of whether the feature is enabled or disabled at the moment, the Translation Costs report is generated.
</Aside>
