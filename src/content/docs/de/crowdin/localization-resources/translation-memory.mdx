...
<Steps>
  ...
  5. Klicke auf **Erstellen**. <Image src={createTmDialog} alt="Dialog „TM erstellen“" class="width-xl crowdin-modal" />
</Steps>

<CardGrid>
  <LinkCard title="TM zuweisen" href="/project-settings/translation-memories/#assigning-tm" />
  <LinkCard title="TM priorisieren" href="/project-settings/translation-memories/#prioritizing-tm" />
  <LinkCard title="Changing Standard TM" href="/project-settings/translation-memories/#changing-default-tm" />
</CardGrid>
...
<Steps>
  ...
  6. Klicke auf **Erstellen**. <Image src={addTranslationUnitDialog} alt="Dialog „Übersetzungseinheit hinzufügen“" class="width-xl crowdin-modal" />
</Steps>
...
<Steps>
  ...
  5. Klicke auf **Speichern**. <Image src={editTranslationUnitDialog} alt="Dialog „Übersetzungseinheit bearbeiten“" class="width-xl crowdin-modal" />
</Steps>
...
<Aside type="caution" title="Einschränkungen">
  Die maximale Dateigröße beträgt 200 MB. Wenn deine Datei dieses Limit überschreitet, wird empfohlen, sie in mehrere kleinere Dateien aufzuteilen und diese nacheinander hochzuladen.
</Aside>
