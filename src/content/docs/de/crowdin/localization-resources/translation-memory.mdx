...
description: Erfahre, wie du Translation Memories in Crowdin verwaltest.
...
Für jedes Crowdin-Projekt wird automatisch ein Projekt-TM erstellt. Standardmäßig wird jede innerhalb des Projekts erstellte Übersetzung automatisch zum Projekt-TM hinzugefügt. Dieses Verhalten kannst du in den [Projekteinstellungen](/project-settings/translation-memories/) anpassen, sodass nur bestätigte Übersetzungen gespeichert werden.
...
<Steps>
  1. Öffne deine Profil-Startseite und wähle in der linken Seitenleiste **TM** aus.
  2. Klicke auf **TM erstellen**. <Image src={createTm} alt="TM erstellen" />
  ...
  4. *(Optional)* Weise das TM den benötigten Projekten zu. Du kannst diesen Schritt überspringen und das TM später zuweisen.
  5. Click **Create**. <Image src={createTmDialog} alt="Dialog „TM erstellen“" class="width-xl crowdin-modal" />
</Steps>

<CardGrid>
  <LinkCard title="Assigning TM" href="/project-settings/translation-memories/#assigning-tm" />
  <LinkCard title="Prioritizing TM" href="/project-settings/translation-memories/#prioritizing-tm" />
  <LinkCard title="Changing Default TM" href="/project-settings/translation-memories/#changing-default-tm" />
</CardGrid>
...
<LinkCard title="Translation Memory Generator" description="Verwende diese App, um ein TM basierend auf dem übersetzten Crowdin-Projekt zu erstellen." href="https://store.crowdin.com/tmg" target="_blank" />
...
<Steps>
  1. Öffne deine Profil-Startseite und wähle in der linken Seitenleiste **TM** aus. Alternativ kannst du dein Projekt öffnen und zu **Einstellungen > Translation Memories** gehen.
  ...
  6. Click **Create**. <Image src={addTranslationUnitDialog} alt="Dialog „Übersetzungseinheit hinzufügen“" class="width-xl crowdin-modal" />
</Steps>
...
<Steps>
  1. Öffne deine Profil-Startseite und wähle in der linken Seitenleiste **TM** aus. Alternativ kannst du dein Projekt öffnen und zu **Einstellungen > Translation Memories** gehen.
  2. Wähle das benötigte TM aus und klicke auf **Einträge anzeigen**. Alternativ kannst du auf **Alle Einträge** klicken, um die Übersetzungseinheiten aller verfügbaren TMs in einer Liste anzuzeigen. <Image src={editTranslationUnits} alt="Übersetzungseinheiten bearbeiten" />
  3. Öffne eine Übersetzungseinheit per Doppelklick oder klicke auf **Bearbeiten**.
  4. Bearbeite oder lösche im angezeigten Dialog die Segmente der benötigten Sprachen. Für jedes Segment kannst du zusätzliche Details wie Sprache, Erstellungsdatum, Datum der letzten Änderung und, falls verfügbar, den Namen des Mitwirkenden sehen, der die Übersetzung ursprünglich eingereicht hat.
  5. Click **Save**. <Image src={editTranslationUnitDialog} alt="Dialog „Übersetzungseinheit bearbeiten“" class="width-xl crowdin-modal" />
</Steps>

Neben der Bearbeitung von Übersetzungseinheiten über die Seite **Translation Memories** kannst du dies auch im Editor tun.

<ReadMore>
  Mehr über [TM-Vorschläge im Editor bearbeiten](/online-editor/#editing-tm-suggestions-in-the-editor) erfahren.
</ReadMore>
...
<Steps>
  ...
  5. Enter the word, phrase, or sentence you want to substitute and the text to replace it with. *(Optional)* Verwende die Optionen *Groß-/Kleinschreibung beachten* und *Exakte Übereinstimmung*, um die Suchergebnisse einzugrenzen.
  6. Klicke auf **Suchen**, um eine Vorschau der Segmente anzuzeigen, die ersetzt werden. <Image src={findReplace} alt="Vorschau" class="crowdin-modal" />
...
* Wenn du eine Übersetzungseinheit aus dem TM löschst, wird die zugehörige Übersetzung eines Strings in deinem Crowdin-Projekt nicht gelöscht.
* Wenn du die Übersetzungsaktivität eines Strings über den Tab **Aktivität** stornierst, wird die Übersetzung des Strings gelöscht, die zugehörige Übersetzungseinheit bleibt jedoch im TM erhalten.
...
<Steps>
  1. Öffne deine Profil-Startseite und wähle in der linken Seitenleiste **TM** aus. Alternativ kannst du dein Projekt öffnen und zu **Einstellungen > Translation Memories** gehen.
  2. Klicke beim benötigten TM auf **Einträge anzeigen**.
...
Der Projektinhaber und Manager können TMs in den folgenden Dateiformaten herunterladen und hochladen: TMX, XLSX oder CSV.

<Aside type="caution" title="Limitations">
  Die maximale Dateigröße beträgt 200 MB. If your file exceeds this limit, it is recommended to split it into several smaller files, and upload them one at a time.
</Aside>
...
Beim Herunterladen eines Translation Memories (TM) aus Crowdin im TMX-Format kannst du zusätzliche Metadaten erhalten, die für verschiedene Anwendungsszenarien mit Offline-Tools nützlich sein können.
...
* `creationid` &ndash; vollständiger Name und Benutzername des Übersetzungsautors in Crowdin.
...
* `usagecount` &ndash; Anzahl der Verwendungen des Übersetzungsvorschlags in Crowdin.
* `lastusagedate` &ndash; das Datum, an dem ein Übersetzungsvorschlag zuletzt in Crowdin verwendet wurde.

Übersetzungsdienstleister, die in Crowdin arbeiten, exportieren häufig TMs aus Projekten, um sie für ihre Kunden in verschiedenen Desktop-Anwendungen zu verwalten (z. B. um irrelevante Übersetzungen zu bereinigen und anschließend wieder in Crowdin zu importieren). Die oben aufgeführten TM-Attribute ermöglichen eine bessere Navigation und Filterung von TM-Segmenten anhand verschiedener Kriterien. Du kannst bereinigte und aktualisierte TMs auch verwenden, um MT-Engines ausschließlich mit produktspezifischen Daten zu trainieren und dadurch eine höhere Übersetzungsqualität zu erzielen.

## TMs teilen

Mit geteilten TMs kannst du beliebige Projekte, deren Inhaber du bist, automatisch übersetzen. Außerdem werden TM-Vorschläge aus allen TMs im Editor angezeigt.

Gehe folgendermaßen vor, um TMs zwischen allen Projekten zu teilen, deren Inhaber du bist:

<Steps>
  1. Öffne deine Profil-Startseite und wähle in der linken Seitenleiste **TM** aus.
  2. Wähle **TMs teilen** aus. <Image src={sharingTm} alt="TMs teilen" />
</Steps>
...
Mit der automatischen Übersetzung über TM kannst du mindestens 100-%- und perfekte Übereinstimmungen nutzen.

<CardGrid>
  <LinkCard title="TM-Übereinstimmungsberechnung" href="#tm-match-calculation" />
  <LinkCard title="Automatische Übersetzung" href="/auto-translation/" />
</CardGrid>

<Aside type="tip">
  Du kannst auch die [automatische Übersetzung über TM konfigurieren](/project-settings/auto-translate/#tm-auto-translate), damit sie auf neue Inhalte in deinem Projekt angewendet wird.
</Aside>
...
3. Zugewiesene TM-Priorität &ndash; die Priorität des TMs, in dem ein TM-Vorschlag gespeichert ist. <ReadMore>Mehr über [TM priorisieren](/project-settings/translation-memories/#prioritizing-tm) erfahren.</ReadMore>
...
Wenn die Option [**TM-Vorschläge für Dialekte**](/project-settings/translation-memories/) aktiviert ist, zeigt Crowdin im Editor TM-Vorschläge der Hauptsprache für Dialektsprachen an. Wenn du beispielsweise Spanisch und Spanisch, Argentinien als Zielsprachen hast und die Option aktiviert ist, zeigt der Editor TM-Vorschläge aus Spanisch für Spanisch, Argentinien an (in der Phase **Automatisierte Vorschläge** als „Englisch → Spanisch“ gekennzeichnet).
...
Crowdin berechnet die TM-Übereinstimmung, indem der zu übersetzende Quellstring mit den vorhandenen Segmenten des TMs verglichen wird.
...
Sobald du die TM-Auto-Substitution aktivierst, kannst du verbesserte TM-Vorschläge bei der [automatischen Übersetzung](#applying-translation-memory-via-auto-translation) nutzen. Stelle sicher, dass du ein Mindestübereinstimmungsverhältnis von 100 % festlegst. Dadurch werden 100-%-TM-Übereinstimmungen sowie solche einbezogen, die durch die TM-Auto-Substitution auf 100 % verbessert wurden.
...
<Aside>
  Um die minimale Ähnlichkeitsübereinstimmung der angezeigten TM-Vorschläge zu konfigurieren, gehe zu den [Editor-Einstellungen](/online-editor/#editor-settings).
</Aside>
...
<ReadMore>
  Mehr über [TM-Vorschlagsstrafen](/project-settings/translation-memories/#penalties) erfahren.
</ReadMore>

### Kostenberichte

Sobald die Funktion aktiviert ist, wirkt sie sich darauf aus, wie die Berichte [Kostenschätzung](/project-reports/#cost-estimate) und [Übersetzungskosten](/project-reports/#translation-cost) berechnet werden.
