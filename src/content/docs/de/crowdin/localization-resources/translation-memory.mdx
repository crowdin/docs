...
<Aside type="caution" title="Einschränkungen">
  Die maximale Dateigröße beträgt 200 MB. wenn dein Datei exceeds dies limit, it ist recommended zu split it in several smaller Dateien, und Lade hoch them one bei ein Zeit.
</Aside>
