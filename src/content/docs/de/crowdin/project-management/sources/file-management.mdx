...
Jedes Mal, wenn Sie eine Quelldatei aktualisieren, wird eine neue Version erstellt. To restore your file to the previous revision, click the number on the needed file in the *Revision* column. In the appeared dialog, select the revision you want to restore your file to and click **Restore** next to it.
...
Usually, branches in Crowdin are created automatically if you use GitHub, GitLab, or other VCS integration. Usually, branches in Crowdin Enterprise are created automatically if you use GitHub, GitLab, or other VCS integration.
