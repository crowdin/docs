...
Der Hauptbereich des Dialogs dient dazu, die Spalten deiner Datei dem entsprechenden Datentyp in Crowdin zuzuordnen. Die Oberfläche enthält direkt über der Spaltenzuordnung die folgenden Steuerelemente:
...
* **Übersetzungen importieren** – Standardmäßig importiert Crowdin alle in der Datei vorhandenen Übersetzungen. Deaktiviere dieses Kontrollkästchen, wenn du nur Quellstrings importieren möchtest.
...
* **Ausgeblendete Strings übersetzen** – Importiert Übersetzungen für Strings, die in Crowdin als ausgeblendet markiert sind. Ausgeblendete Strings sind im Editor normalerweise für Übersetzer nicht sichtbar und werden für Systemzwecke oder Platzhalter verwendet.
* **Zu TM hinzufügen** – Fügt die importierten Übersetzungen zum primären Translation Memory (TM) des Projekts hinzu.

<Aside>
  In string-basierten Projekten befinden sich einige der oben beschriebenen Übersetzungseinstellungen (**Übersetzung darf mit der Quelle übereinstimmen**, **Hinzugefügte Übersetzungen freigeben** und **Ausgeblendete Strings übersetzen**) in der rechten Seitenleiste des Upload-Tabs und nicht im Konfigurationsdialog selbst.
</Aside>
...
* Um deine aktuelle Konfiguration als Vorlage zu speichern, klicke auf **Vorlagen** > **Als Vorlage speichern**, gib einen Vorlagennamen ein und klicke auf **Speichern**.
...
Du möchtest möglicherweise CSV- oder XLSX-Dateien aktualisieren und das zunächst konfigurierte Schema ändern. Eine Aktualisierung des Schemas kann erforderlich sein, wenn du deinem Crowdin-Projekt eine neue Zielsprache hinzufügst.
