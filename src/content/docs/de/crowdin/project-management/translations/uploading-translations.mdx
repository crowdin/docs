...
<Tabs syncKey="projectType">
  <TabItem label="Dateibasiertes Projekt">
    <Steps>
      ...
      4. Crowdin gleicht hochgeladene Übersetzungen automatisch mit den entsprechenden Quelldateien und Sprachen ab. Prüfen Sie manuell, ob alles richtig abgestimmt ist. <Image src={uploadTranslationsConfigure} alt="Dateien abgleichen" class="width-xl" />
  ...
  <TabItem label="Zeichenfolgenbasiertes Projekt">
    <Steps>
      ...
      3. Crowdin versucht automatisch, die Zielsprache zu erkennen, in die du Übersetzungen hochlädst. Check it manuell zu Erstelle sure Ziel Sprachen sind matched correctly towards Übersetzung Dateien.
...
* **QA check** – der Übersetzung failed one oder mehr quality assurance checks. der report wird Zeige ein sub-Liste von der spezifisch QA Problem Typen (e.g., *Duplicate Übersetzung*, *Numbers mismatch*, etc.) basierend auf den in [**Einstellungen > QA-Prüfungen**](/project-settings/qa-checks/#qa-check-parameters) konfigurierten QA-Prüfungen.
