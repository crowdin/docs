...
Wenn die **anzeigen innerhalb ein Version Branch** Optionen (regular oder strict detection) sind ausgewählt, nur die master Strings das waren originally hochgeladen zu die System wird sein verfügbar für Übersetzung. Alle doppelten Zeichenfolgen übernehmen automatisch die Übersetzungen der Master-Zeichenfolgen und werden in allen [Versions-Branches](/version-management/) ausgeblendet.
...
Konfiguriere, wie Crowdin Wörter und Zeichen in deinem Projekt zählen soll. Specifically, dies Einstellung bestimmt whether HTML Tags sollte sein counted as regular words oder ignored. Standardmäßig betrachtet Crowdin HTML-Tags in den meisten unterstützten Formaten als reguläre Wörter, mit Ausnahme der folgenden: HTML, Front Matter HTML, HAML, MD, Front Matter MD, XML, WEBXML, IDML, XLIFF, XLIFF 2.0, ADOC, DOCX und DITA.
