...
You can set the parser configuration for all files of a certain format or single files. Parser configuration in a specific project is applied only to files stored in this project.
