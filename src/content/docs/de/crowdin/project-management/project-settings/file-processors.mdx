...
Mit Dateiverarbeitungen kannst du die Verarbeitung unterstützter Dateiformate anpassen. Dies kann hilfreich sein, wenn du den Dateiinhalt vor dem Import durch Crowdin bearbeiten möchtest.
...
<Steps>
  1. Öffne dein Projekt und gehe zum Tab **Einstellungen > Dateiprozessoren**.
  2. Klicke beim gewünschten Prozessor auf <Icon name="mdi:dots-horizontal" class="inline-icon" /> und wähle **Bearbeiten**.
