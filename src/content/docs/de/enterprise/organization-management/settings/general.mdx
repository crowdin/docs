...
Connect <a href="{{ site.baseurl }}{% link _docs_enterprise/creating-oauth-app.md %}">OAuth applications</a> through Crowdin Enterprise API. You can build custom integrations and give them access to use your account. Only organization admins will be able to modify its credentials or delete an OAuth app to revoke its access.
...
You can transfer ownership or delete your organization from Crowdin Enterprise. You’ll be able to export some organizational data as well as Invoices before deletion.
