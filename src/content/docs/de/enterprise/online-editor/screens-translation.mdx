...
<CardGrid>
  <LinkCard title="Screenshots" description="Erfahre, wie Manager Screenshots hochladen und mit Tags versehen können." href="/enterprise/screenshots/" />
  <LinkCard title="Figma Plugin" description="Erfahre, wie Manager markierte Designs zur Übersetzung direkt aus Figma hochladen können." href="/enterprise/figma-plugin/#uploading-tagged-screenshots-to-crowdin" />
  <LinkCard title="Projekteinstellungen" description="Erfahre, wie Manager die Ansicht der Sprachseite konfigurieren, um diese Funktion zu aktivieren." href="/enterprise/project-settings/#project-language-page-view" />
