...
<CardGrid>
  <LinkCard title="Screenshots" description="Learn how managers can upload and tag screenshots." href="/enterprise/screenshots/" />
  <LinkCard title="Figma Plugin" description="Learn how managers can upload tagged designs for translation directly from Figma." href="/enterprise/figma-plugin/#uploading-tagged-screenshots-to-crowdin" />
  <LinkCard title="Projekteinstellungen" description="Learn how managers configure the Language Page View to enable this feature." href="/enterprise/project-settings/#project-language-page-view" />
