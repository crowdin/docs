...
* Der Status einer Zeichenkette wird durch die folgenden Farben angezeigt: Optionen include *Master-Zeichenfolges*, *Duplicates nur*, *Duplicates mit Shared Übersetzungen*, und *Duplicates mit Own Übersetzungen*. <Aside>Diese Option wird nur angezeigt, wenn [**Duplikate von Zeichenketten**](/enterprise/project-settings/import/#duplicate-strings) so konfiguriert ist, dass Duplikate automatisch übersetzt werden. Shared Übersetzungen come von der Master-Zeichenfolge, während own Übersetzungen sind entered direkt auf der duplicate.</Aside>
