...
<Steps>
  1. Open the screenshot with a double click or right-click on the screenshot and select **Edit**.
  2. Sortieren und filtern Sie die aufgeführten Zeichenketten. You can select all or specific files and search strings by text or context.
...
<CardGrid>
  <LinkCard title="Projekteinstellungen" description="Configure your project's Language Page View to enable screenshot translation." href="/enterprise/project-settings/#project-language-page-view" />
