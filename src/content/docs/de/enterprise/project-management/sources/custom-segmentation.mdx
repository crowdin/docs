...
In this case, you can define your own segmentation rules for each source file individually using the <a href="https://www.gala-global.org/srx-20-april-7-2008" target="_blank" mark="crwd-mark">SRX 2.0 standard</a>. Although, there might be situations when the default segmentation rules segment source files in contrast to the desired expectations.
