...
<Steps>
  ...
  2. Klicke auf <Icon name="mdi:dots-vertical" class="inline-icon" /> (oder right-klicken) auf die benötigt Datei und auswählen **Settings**. <Image src={fileContextMenuSettings} alt="File context menu settings" />
  ...
  6. Füge deine SRX-Segmentierungsregeln ein und klicke auf **Speichern**. <Image src={fileParserConfiguration} alt="File parser configuration" class="width-xl" />
</Steps>
