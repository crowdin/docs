...
Normalerweise werden Branches in Crowdin Enterprise automatisch erstellt, wenn du die GitHub-, GitLab- oder eine andere VCS-Integration verwendest. Wenn du Branches dennoch manuell erstellen musst, stelle sicher, dass du zuerst den Master-Branch hochlädst, da alle anderen als Feature-Branches betrachtet werden.
