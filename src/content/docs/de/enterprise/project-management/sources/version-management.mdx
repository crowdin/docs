...
<Image src={versionsBranches} alt="Branch-Struktur" />
...
<Steps>
  ...
  2. Führe einen der folgenden Schritte aus:
     ...
     * Bewege den Mauszeiger über den gewünschten Branch, klicke auf <Icon name="mdi:dots-vertical" class="inline-icon" /> (oder klicke mit der rechten Maustaste) und wähle **Klonen**.
...
<Steps>
  ...
  2. Klicke auf <Icon name="mdi:dots-vertical" class="inline-icon" /> (oder klicke mit der rechten Maustaste) und wähle **Zusammenführen**.
