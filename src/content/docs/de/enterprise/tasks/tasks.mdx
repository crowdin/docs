...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      4. Click **Create**. <Image src={details} alt="Task Details" />
    </Steps>
  </TabItem>
  <TabItem label="String-based project">
    <Steps>
      ...
      3. Set the task parameters:
         ...
         * *Title* &ndash; specify the name of the task that will be visible to translators or proofreaders.
         * *Description* (optional) &ndash; add any additional details that may be helpful.
      4. Click **Create**. <Image src={detailsSB} alt="Task Details" />
    </Steps>
  </TabItem>
</Tabs>
...
<LinkCard title="User Tasks" description="Learn how to view, filter, and manage tasks assigned to you." href="/enterprise/user-tasks/" />
