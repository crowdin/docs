...
* Verwenden Sie nicht länger "Lorem Ipsum", sondern fügen Sie stattdessen echte Texte von Crowdin Enterprise in Ihre Prototypen ein. Strings added from Crowdin Enterprise become linked to the text fields in Figma.
* Erstellen Sie Quelltexte aus Ihren Entwürfen und laden Sie sie in Ihr Crowdin Enterprise-Projekt hoch. Created strings become linked to text fields in Figma. This way, developers could use uploaded strings, reducing time spent on development.
