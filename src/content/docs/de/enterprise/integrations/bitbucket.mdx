...
Wenn Sie die Integration einrichten, wählen Sie bestehende Repository-Zweige aus, die dem Crowdin Enterprise-Projekt hinzugefügt werden sollen. To add future branches from Bitbucket to Crowdin Enterprise automatically, create a pattern for the branch names in the integration settings.
