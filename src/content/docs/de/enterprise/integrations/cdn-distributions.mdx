...
<Tabs syncKey="projectType">
  <TabItem label="Dateibasiertes Projekt">
    <Steps>
      ...
      7. Kopiere <Icon name="material-symbols:file-copy" class="inline-icon" /> den **Distribution-Hash** und das **Distribution-Manifest**. Das Manifest ist eine JSON-Datei mit wichtigen Details zur Verteilung (z. B. Dateien, Sprachen und Pfade), die in deiner Integration verwendet werden kann.
    </Steps>
  </TabItem>
