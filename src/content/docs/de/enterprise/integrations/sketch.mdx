...
Added strings will be transferred to your Crowdin Enterprise project and also will be displayed in the list of the **Strings** tab. You can edit or delete the strings from the same list anytime. Die jeweiligen Änderungen werden auch auf die Strings in Ihrem Crowdin Enterprise-Projekt angewendet.
