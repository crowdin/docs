...
<Aside>
  ...
  * [GitLab-Integration](https://store.crowdin.com/gitlab) &ndash; für Repositories, die auf GitLab.com gehostet werden.
  * [GitLab-Self-Managed-Integration](https://store.crowdin.com/gitlab-server) &ndash; für eine selbst gehostete GitLab-Instanz.
</Aside>

In dateibasierten Projekten kannst du zwischen zwei möglichen GitLab-Integrationsmodi wählen:

* **Modus für Quell- und Übersetzungsdateien** &ndash; Quell- und Übersetzungsdateien zwischen deinem GitLab-Repository und dem Crowdin-Enterprise-Projekt synchronisieren.
...
<Steps>
  ...
  4. Autorisiere anschließend die Verbindung mit Crowdin auf der GitLab-Seite: <Image src={authorization} alt="GitLab Integration Authorization" class="width-lg" />
</Steps>
...
<Tabs syncKey="projectType">
  <TabItem label="Dateibasiertes Projekt">
    <Image src={unconfigured} alt="GitLab-Integration nicht konfiguriert" />
  ...
  <TabItem label="Zeichenfolgenbasiertes Projekt">
    <Image src={unconfiguredSb} alt="GitLab-Integration nicht konfiguriert" />
  </TabItem>
</Tabs>
