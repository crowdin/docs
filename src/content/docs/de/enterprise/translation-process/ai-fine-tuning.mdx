...
<LinkCard title="Kontinuierliche Feinabstimmung" description="Automatisiere den Fine-Tuning-Prozess mit inkrementellen Aktualisierungen deiner KI-Modelle auf Grundlage neuer Übersetzungen in Crowdin-Enterprise-Projekten." href="https://store.crowdin.com/continuous-fine-tuning" target="_blank" />
...
* **Trainingsdatensatz** &ndash; Enthält Daten, die für das Modelltraining verwendet werden, einschließlich Übersetzungen aus ausgewählten Projekten und Translation Memories.
* **Validierungsdatensatz** &ndash; Enthält Daten zur Bewertung der Modellgenauigkeit und stellt sicher, dass das trainierte Modell mit unbekannten Daten gut funktioniert.
