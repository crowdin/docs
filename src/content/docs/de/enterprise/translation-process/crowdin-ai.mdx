...
Auf der Registerkarte **Nutzung** kannst du durch die Festlegung von Tages- und Monatsbudgets steuern, wie viel dein Unternehmen für KI-Funktionen ausgibt. Du kannst Limits organisationsweit, als Basiseinstellung pro Benutzer und für bestimmte Benutzer festlegen. Die Limits gelten für deine Organisationsmitglieder, die KI-Funktionen verwenden.
...
Gilt für alle Mitglieder der Organisation, für die keine benutzerdefinierten Limits festgelegt wurden. Verwende diese Felder, um eine Basis für deine Organisation festzulegen, indem du die Standardwerte erhöhst oder verringerst. Wenn ein Mitglied sein Limit erreicht, werden nur die eigenen KI-Anfragen pausiert, bis der Zeitraum zurückgesetzt wird.

Standardlimits pro Benutzer können nicht höher sein als die organisationsweiten Limits.

#### Benutzerbezogene Limits

Weise bestimmten Mitgliedern der Organisation benutzerdefinierte Limits zu, die die standardmäßigen Limits pro Benutzer ersetzen. Dies ist nützlich für Power-User, Evaluatoren oder Nutzer, die strengere Limits als die Standardwerte benötigen.

Im Abschnitt **Benutzerbezogene Limits** kannst du jedes Organisationsmitglied mit den folgenden Details einsehen:

* **Benutzer**: Das Mitglied der Organisation.
...
<Steps>
  ...
  2. Wähle im Dialog **Benutzerlimits festlegen** im Feld **Benutzer** ein oder mehrere Mitglieder deiner Organisation aus. Benutzer, für die bereits benutzerdefinierte Limits festgelegt wurden, können nicht ausgewählt werden.
...
Um die Limits eines bestimmten Benutzers zu verwalten, klicke auf <Icon name="mdi:dots-vertical" class="inline-icon" /> (oder klicke mit der rechten Maustaste) auf den gewünschten Benutzer und wähle eine der folgenden Optionen aus:
...
Alternativ kannst du auf den Benutzer klicken, um seine Limits zu bearbeiten.

<Aside>
  Benutzerdefinierte Limits haben Vorrang vor den standardmäßigen Limits pro Benutzer, jedoch gelten stets die organisationsweiten Limits zusätzlich dazu. Auch ein Mitglied ohne persönliches Limit unterliegt weiterhin dem organisationsweiten Budget.
</Aside>
