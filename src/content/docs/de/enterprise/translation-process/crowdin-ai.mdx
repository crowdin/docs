...
Prompt engineering is crucial for guiding AI in understanding context and providing accurate translations. Die Anpassung von Prompts innerhalb von Crowdin Enterprise stellt sicher, dass KI-Algorithmen die Feinheiten Ihres Projekts verstehen, was zu einer verbesserten Übersetzungsqualität führt.
...
<Steps>
  ...
  2. Klicken Sie im Tab **Prompts** auf **Neuer Prompt**. Alternatively, you can go ahead with creating prompt samples clicking **Try a sample**. Crowdin allows you to quickly set up pre-configured prompts that are ready to perform effectively from the moment they are created. While these samples are designed to work good initially, you can customize them to your personal preferences.
...
<LinkCard title="Vorübersetzung" description="Explore various pre-translation options to speed up your project localization." href="/enterprise/pre-translation/" />
