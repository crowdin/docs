...
<LinkCard title="API Overview" description="Explore the Crowdin API documentation to learn more about the available endpoints and how to use them." href="/developer/api/" />

<HelpBanner title="Need Help?" description="We support all developers who help us improve our product and add interesting developments to our community." buttonText="Contact Support" buttonLink="https://crowdin.com/contacts" />
...
Unser Team ist bereit, Sie bei der technischen Umsetzung Ihrer App zu unterstützen. Sobald Ihre App fertig ist, besprechen wir mit Ihnen, wie wir Sie bei der Bekanntmachung mit unseren Kunden unterstützen können. For any guidance from our team contact us at <a href="mailto:support@crowdin.com">support@crowdin.com</a>.
