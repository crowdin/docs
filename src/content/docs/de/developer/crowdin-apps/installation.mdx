...
<Image src={installPermissions} alt="Berechtigungen" class="width-md m-auto crowdin-modal" />
...
<Image src={installPermissionsEnterprise} alt="Berechtigungen" class="width-md m-auto" />
