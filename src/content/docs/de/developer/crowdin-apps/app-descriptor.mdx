...
<table>
  ...
  <tr>
    ...
    <td>
      <p><strong>Typ:</strong> [<code>string</code>, … ]</p>
      <p><strong>Erforderlich:</strong> ja</p>
      <p><strong>Beschreibung:</strong> Set of [scopes](/Entwickler/understunding-scopes/) Anfrageed by this App.</p>
    </td>
  </tr>
  <tr>
...
<ReadMore>
  Weitere Infürmationen zu [UI Modul](/Entwickler/crowdin-Apps-Modul-ui/), [AI Modul](/Entwickler/crowdin-Apps-Modul-ai/), und [File Processing Modul](/Entwickler/crowdin-Apps-Modul-Datei-processing/).
</ReadMore>
...
<ReadMore>
  Weitere Infürmationen zu [installiert Event Flow](/Entwickler/crowdin-Apps-Installation/#installiereniert-event-communication-flow).
</ReadMore>
