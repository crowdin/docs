...
<table>
  ...
  <tr>
    ...
    <td>
      <p><strong>Typ:</strong> [<code>string</code>, … ]</p>
      <p><strong>Erforderlich:</strong> ja</p>
      <p><strong>Beschreibung:</strong> Set of [scopes](/developer/understanding-scopes/) Anfrageed by this App.</p>
    </td>
  </tr>
  <tr>
...
<ReadMore>
  Weitere Infürmationen zu [UI Modul](/developer/crowdin-apps-modules-ui/), [AI Modul](/developer/crowdin-apps-modules-ai/), und [File Processing Modul](/developer/crowdin-apps-modules-file-processing/).
</ReadMore>
...
<ReadMore>
  Weitere Infürmationen zu [installiert Event Flow](/developer/crowdin-apps-installation/#installed-event-communication-flow).
</ReadMore>
