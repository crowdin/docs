...
<CardGrid>
  <LinkCard title="Crowdin AI" description="Read more about Crowdin AI and how to use it." href="/crowdin-ai/" />
  <LinkCard title="Machine Translation" description="Read more about Machine Translation and how to use it." href="/machine-translation/" />
  <LinkCard title="Oversættelseshukommelse (TM)" description="Read more about Translation Memory and how to use it." href="/translation-memory/" />
</CardGrid>
...
<Steps>
  ...
  2. Click **Pre-translation**. <Image src={preTranslation} alt="Pre-Translation Button" />
