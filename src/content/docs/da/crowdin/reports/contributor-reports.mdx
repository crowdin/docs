...
<Image src={translatorsProjectStatus} alt="Projektoversigt" />
...
To select the languages for custom rates, click **Edit Languages** and select the ones you need. Individuelle satser kan oprettes i det ønskede antal.
...
<Image src={topMembers} alt="Topmedlemmer" />
...
### Rapportgenerering {#generating-my-contribution}
...
#### Basissatser {#base-rates-my-contribution}
...
#### Nettosatsplaner {#net-rate-schemes-my-contribution}
...
#### Tilføjelse af Tilpassede satser {#custom-rates-my-contribution}
...
### Resultatanalyse {#result-analysis-my-contribution}
