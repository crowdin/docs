...
<Steps>
  ...
  4. Then authorize the connection with Crowdin on the GitLab side: <Image src={authorization} alt="GitLab Integration Authorization" class="width-sm" />
</Steps>
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Image src={unconfigured} alt="GitLab Integration Unconfigured" class="crowdin-modal" />
  ...
  <TabItem label="String-based project">
    <Image src={unconfiguredSb} alt="GitLab Integration Unconfigured" class="crowdin-modal" />
  </TabItem>
</Tabs>
