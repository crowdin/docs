...
<Steps>
  ...
  5. *(Optional)* Add a description which will be displayed as the initial message in the topic. Simpel tekst eller Markdown kan benyttes.
  ...
  7. Click **Create Topic**. <Image src={createTopic} alt="Create Topic" />
</Steps>
