...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      4. Crowdin matcher automatisk uploadede oversættelser med de korrekte kildefiler og sprog. Tjek det manuelt for at sikre, at alt er matchet korrekt. <Image src={uploadTranslationsConfigure} alt="Match Files" class="width-xl" />
