...
<Image src={tasksUserPage} alt="Brugeropgaver" />
...
<CardGrid>
  ...
  <LinkCard title="Opgavestatusændring" description="Learn how to update task statuses to keep track of your progress." href="/tasks/#changing-task-status" />
</CardGrid>
