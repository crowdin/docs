...
<CardGrid>
  <LinkCard title="Skærmfotos" description="Learn how managers can upload and tag screenshots." href="/screenshots/" />
  <LinkCard title="Figma plug-in" description="Learn how managers can upload tagged designs for translation directly from Figma." href="/figma-plugin/#uploading-tagged-screenshots-to-crowdin" />
  <LinkCard title="Projektindstillinger" description="Learn how managers configure the Language Page View to enable this feature." href="/project-settings/#project-language-page-view" />
