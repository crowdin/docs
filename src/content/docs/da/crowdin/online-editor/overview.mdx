...
<Aside>
  Make sure to enable [QA checks](/project-settings/qa-checks/) to help you find strings that require review. For fundne problematikker understreges oversættelserne, som kræver gennemgang, med rødt.
</Aside>
...
* *UI Language* &ndash; select your preferred language for the Crowdin UI. Det valgte sprog anvendes i Editor og andre dele af Crowdin.
...
<LinkCard title="Udtrykssyntakselementer" description="Learn how to build and use verbal expressions with practical examples." href="/expression-syntax-elements/" />
