...
A project TM is created automatically for each Crowdin project. By default, each translation made within the project is automatically added to the project’s TM. This behavior can be customized in the [project settings](/project-settings/translation-memories/) to save only approved translations.
...
<Steps>
  ...
  4. *(Optional)* Assign the TM to the needed projects. Dette trin kan overspringes og en TM tildeles senere.
  5. Klik på **Opret**. <Image src={createTmDialog} alt="Create TM Dialog" class="width-xl crowdin-modal" />
</Steps>

<CardGrid>
  <LinkCard title="Tildeling af TM" href="/project-settings/translation-memories/#assigning-tm" />
  <LinkCard title="TM-prioritering" href="/project-settings/translation-memories/#prioritizing-tm" />
  <LinkCard title="Ændring af Standard TM" href="/project-settings/translation-memories/#changing-default-tm" />
</CardGrid>
...
<LinkCard title="Translation Memory Generator" description="Use this app to create a TM based on the translated Crowdin project." href="https://store.crowdin.com/tmg" target="_blank" />
...
<Steps>
  ...
  6. Klik på **Opret**. <Image src={addTranslationUnitDialog} alt="Add Translation Unit Dialog" class="width-xl crowdin-modal" />
</Steps>
...
Using the shared TMs, you can pre-translate any of the projects you own. TM-forslag fra alle TM'er vil ligeledes fremgå i Editor.
...
<CardGrid>
  ...
  <LinkCard title="Præoversættelse" href="/pre-translation/" />
</CardGrid>
...
3. Tildelt TM-prioritering &ndash; prioriteringen af TM'en, som et TM-forslag er gemt i. <ReadMore>Read more about [Prioritizing TM](/project-settings/translation-memories/#prioritizing-tm).</ReadMore>
