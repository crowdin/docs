...
<Image src={privateProfile} alt="Denne profil er fortrolig" />

Følg disse trin for at gøre profilen fortrolig:
...
Af sikkerhedshensyn kan vi ikke slette en konto på vegne af brugeren. Brugeren skal have adgang til Crowdin-kontoen, for at kunne slette den.
...
<Steps>
  ...
  5. Download genopretningskoder, så disse kan benyttes, såfremt mobilenheden er utilgængelig. <Image src={twoFactorAuthenticationRecoveryCodes} alt="Recovery codes" class="width-md" />
</Steps>
...
<Image src={sessions} alt="Sessioner" />
...
<Image src={sudoModeConfirmingCredentials} alt="Bekræftelse af legitimationsoplysninger" class="width-md" />
...
For at deaktivere notifikationer, ryd afkrydsningsfeltet ved siden af notifikationstypen. You can also clear the checkbox on the channel name to disable all notification types. Once all the boxes below are cleared, you won't receive any notifications from that channel.

<Image src={disableNotifications} alt="Deaktivering af notifikationer" />
...
Crowdin Store offers various apps that you can install to extend the functionality of Crowdin, synchronize your content stored in a CMS, and more. Nogle af de pågældende apps er gratis at benytte, mens andre er betalte.
...
<Image src={tokens} alt="Personlige Adgangstegn" />
...
Følg disse trin for at oprette et nyt personligt adgangs-token:
...
### Ophævelse af et Personligt adgangstoken

Revoke a personal access token if it’s no longer needed or you suspect it was compromised.

Følg disse trin for at ophæve et personligt adgangstoken:
...
Sikkerhedsloggen omfatter begivenheder såsom logins, adgangskode- og brugernavnsskift mv.
...
<Steps>
  ...
  4. Klik på **Opret**. <Image src={oauthAppsNewApp} alt="Create OAuth App" class="width-md crowdin-modal" />
</Steps>
...
* **Edit** &ndash; update the application name, description, URLs, and scopes. Tilgå Klient-ID og Klient Hemmelighed for den oprettede app.
