...
<Image src={installPermissions} alt="Tilladelser" class="width-md m-auto crowdin-modal" />
...
<Image src={installPermissionsEnterprise} alt="Tilladelser" class="width-md m-auto" />
