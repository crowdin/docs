...
* Organisationsrolle: Alle, Admin, Leder, Leverandør, Kunde.
* Status: Alle, Aktiv, Afventende, Blokeret.
...
* Senest set: Enhver dato, tilpasset interval.
* 2FA: Alle, tofaktorgodkendelse aktiveret, tofaktorgodkendelse deaktiveret.
...
<Image src={usersList} alt="Brugerliste" />

## Viewing User Profiles

Følg disse trin for at få vist og håndtere brugerprofiler:
...
<Image src={userDetails} alt="Brugeroplysninger" />
...
<Steps>
  ...
  4. Select the desired action:
     * **Add projects permissions** or **Remove projects permissions**. You can manage permissions for multiple projects at once by assigning or removing any project role.
