...
<Steps>
  ...
  2. Double-click on the member or right-click and select **Details** from the menu.
  3. In the appeared dialog, you can perform various actions:
...
## Ændring af Projektmedlemstilladelser
...
Følg disse trin for at ændre projektmedlemstilladelser:

<Steps>
  1. Open your project and select **Members** on the left sidebar.
  2. Select one or multiple members whose permissions you want to change.
  3. Click **Permissions** in the upper-right corner.
  4. Select either **Add project permissions** or **Remove project permissions**.
  5. Indstil i den viste dialog de tilladelser, som skal tilføjes/fjernes og bekræft ændringerne.
</Steps>
...
<Steps>
  1. Open your project and select **Members** on the left sidebar.
  2. Select one or multiple members that you want to contact.
  3. Click **Contact** or right-click on the selected members and select **Contact** from the menu.
  4. Skriv beskeden og afsend den.
</Steps>
...
<Steps>
  1. Open your project and select **Members** on the left sidebar.
  2. Select one or multiple members that you want to delete.
  3. Click <Icon name="mdi:delete" class="inline-icon" /> or right-click on the selected members and select **Delete** from the menu.
...
<CardGrid>
  <LinkCard title="Inviting People" description="Learn how to invite people to your translation project." href="/enterprise/inviting-people/" />
  <LinkCard title="Roles" description="Learn more about the roles and permissions in Crowdin." href="/enterprise/roles/" />
</CardGrid>
