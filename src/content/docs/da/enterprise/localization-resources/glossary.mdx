...
<Steps>
  ...
  4. *(Optional)* Click **Select files** to upload your existing glossary. Dette trin kan overspringes, og en ordliste kan uploades senere.
  5. Klik på **Opret**. <Image src={createGlossaryDialog} alt="Create glossary dialog" class="width-lg" />
</Steps>

<CardGrid>
  <LinkCard title="Ordlistetildeling" href="/enterprise/project-settings/glossaries/#assigning-glossary" />
  <LinkCard title="Skift af Standardordliste" href="/enterprise/project-settings/glossaries/#changing-default-glossary" />
</CardGrid>
...
<Steps>
  ...
  2. Klik på den relevante ordliste.
  ...
  7. Klik på **Opret**. <Image src={addConceptDialog} alt="Add Concept Dialog" />
</Steps>
...
<LinkCard title="AI Alignment" description="Learn how to configure AI Alignment for consistent terminology management." href="/enterprise/crowdin-ai/#ai-alignment" />
...
<Image src={configureImport} alt="Opsætning af ordlisteimport" class="crowdin-modal" />
...
Følg disse trin for at dele ordlister mellem alle organisationsprojekterne:
...
<QuestionAnswer title="A client updates a glossary term translation, but the vendor doesn’t see it in the Editor. How it can be fixed?">
  The priority is given to the organization's own glossaries first, followed by external (i.e., client) glossaries. For at løse dette kan leverandøren deaktivere sin egen ordliste og kun bruge kundens ditto for at sikre, at de ser det opdaterede term.
</QuestionAnswer>
