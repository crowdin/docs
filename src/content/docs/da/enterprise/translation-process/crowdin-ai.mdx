...
Crowdin Enterprise integrerer med top AI-udbydere, herunder OpenAI, Google Gemini, Microsoft Azure OpenAI og mange flere, hvilket muliggør udnyttelse af avancerede AI-drevne oversættelser, som overvejer ekstra kontekst på forskellige niveauer. These translations can be applied to your content with a few clicks using [pre-translation via AI](#pre-translation-via-ai). Additionally, AI in Crowdin Enterprise can be used for [AI suggestions in the Editor](#using-ai-in-the-editor) and [AI QA checks](#ai-qa-check).
...
Prompt engineering is crucial for guiding AI in understanding context and providing accurate translations. Tilpasning af prompter i Crowdin Enterprise sikrer, at AI-algoritmer forstår nuancerne i projektet, hvilket resulterer i forbedret oversættelseskvalitet.
...
<Steps>
  1. Åbn den relevante organisations **Arbejdsrum** og vælg **AI** fra venstre sidebjælke.
  2. Klik fra fanen **Prompter** på **Ny prompt**. Alternatively, you can go ahead with creating prompt samples clicking **Try a sample**. Crowdin allows you to quickly set up pre-configured prompts that are ready to perform effectively from the moment they are created. While these samples are designed to work good initially, you can customize them to your personal preferences.
  3. In the appeared dialog, set the prompt parameters:
     * Select the prompt type (i.e., [Pre-translation & AI Suggestion](#pre-translation-via-ai), [Alignment](#ai-alignment), [QA check](#ai-qa-check), or Create custom type)
     ...
     * Advanced mode &ndash; click **Advanced mode** to compose your prompt with a higher degree of precision. Use the following placeholders to insert context: <Aside type="tip">Click on the placeholder to copy it for further pasting into the prompt field.</Aside>
       ...
       * `%projectName%` &ndash; Crowdin Enterprise-projektnavn.
...
Managing AI prompts in Crowdin Enterprise involves various operations such as filtering and searching, editing, cloning, and deleting AI prompts. Fnd vejledninger til hver operation nedenfor.
...
* **Type** – The prompt's type (e.g., Pre-translation & AI Suggestion, Alignment, QA check, Custom type).
...
Crowdin Enterprise understøtter forskellige AI-udbydere, som hver tilbyder unikke modeller og funktioner til oversættelsesopgaver. By configuring providers, you can tailor AI functionality to suit your specific localization needs. Uanset om der anvendes håndterede Crowdin-tjenester eller egne API-nøgler integreres, muliggør Crowdin Enterprise problemfri integration med AI-tjenester.
...
P.t. understøtter Crowdin Enterprise flg. AI-udbydere:
...
<Steps>
  1. Åbn den relevante organisations **Arbejdsrum** og vælg **AI** fra venstre sidebjælke.
  2. In the **Providers** tab, click <Icon name="mdi:dots-vertical" class="inline-icon" /> toward the needed provider and select **Edit**. Alternativt, klik blot på den ønskede udbyder.
  3. Select **Enabled**.
...
<Steps>
  1. Åbn den relevante organisations **Arbejdsrum** og vælg **AI** fra venstre sidebjælke.
  2. In the **Providers** tab, click <Icon name="mdi:dots-vertical" class="inline-icon" /> toward the needed provider and select **Disable**. Alternativt, klik på den ønskede udbyder og ryd **Aktiveret** i udbyderindstillingerne.
</Steps>
...
### AI-indstillinger for organisationen
...
Select a default prompt with the **Pre-translation & AI Suggestion** type for AI suggestions in the Editor. If no prompt is selected, AI suggestions will not be shown in the **Context & Translations** section.
...
<LinkCard title="AI Prompts in the Project Settings" description="Configure and manage AI Prompts for use in a project." href="/enterprise/project-settings/ai/" />
...
<LinkCard title="Præoversættelse" description="Explore various pre-translation options to speed up your project localization." href="/enterprise/pre-translation/" />
...
To use AI in the Editor, configure a prompt with the **Pre-translation & AI Suggestion** type and select it in **AI > Settings > Editor AI Suggestion**.
...
<LinkCard title="Crowdin Copilot App" description="Use the Crowdin Copilot Store app for context-aware AI chat and task automation in Crowdin." href="https://store.crowdin.com/crowdin-copilot" target="_blank" />
...
<LinkCard title="How to Get the Most from the AI Translations" description="Discover how AI revolutionizes the localization process and workflow by enhancing translation accuracy through contextual understanding." href="https://crowdin.com/blog/2024/04/24/how-to-get-the-most-from-the-ai-translations" target="_blank" />
