...
<Steps>
  ...
  3. Click **Open in Editor** to start translating or proofreading as needed.
</Steps>

As you work on the task, change its status from **To Do** to **In Progress**. Once your work is complete, update the status to **Done**.

<CardGrid>
  <LinkCard title="Working on Tasks in the Editor" description="Learn how to efficiently handle your translation and proofreading tasks in the Editor." href="/enterprise/online-editor/#tasks-in-the-editor" />
  <LinkCard title="Changing Tast Status" description="Learn how to update task statuses to keep track of your progress." href="/enterprise/tasks/#changing-task-status" />
</CardGrid>
...
In some cases, tasks may be part of a sequence where one needs to be completed before the next can begin. F.eks.:
