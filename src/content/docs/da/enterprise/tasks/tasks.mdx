...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      2. Click <Icon name="mdi:plus" class="inline-icon" />**New task**. <Image src={addNew} alt="New Task" />
      ...
      4. Klik på **Opret**. <Image src={details} alt="Task Details" />
    </Steps>
  </TabItem>
  <TabItem label="String-based project">
    <Steps>
      1. Open your project and select **Tasks** on the left sidebar.
      2. Click <Icon name="mdi:plus" class="inline-icon" />**New task**. <Image src={addNewSB} alt="New Task" />
      3. Opsæt opgaveparametrene:
         * *Type* &ndash; select between *Translate by own translators*, *Proofread by own proofreaders*, *Translate by vendor*, and *Proofread by vendor*.
         * *Workflow step* &ndash; select the necessary step from the project workflow.
         * *[Create a pending proofreading task](#sequential-tasks)* (only for translation tasks) &ndash; creates a separate proofreading task that starts once the translation is completed.
         ...
         * *Title* &ndash; specify the name of the task that will be visible to translators or proofreaders.
         * *Description* (optional) &ndash; add any additional details that may be helpful.
      4. Klik på **Opret**. <Image src={detailsSB} alt="Task Details" />
    </Steps>
  </TabItem>
</Tabs>
...
<Steps>
  ...
  2. Alternatively, click <Icon name="mdi:dots-vertical" class="inline-icon" /> next to the template name and select **Apply**.
</Steps>
...
<Steps>
  1. Open your project and select **Tasks** on the left sidebar.
  2. In the **Board** or **All tasks** section, click <Icon name="mdi:dots-vertical" class="inline-icon" /> (or right-click) on the task you want to change and select **Edit**. <Image src={edit} alt="Editing Task" />
...
By default, all project tasks are displayed in the **Tasks** section either in the **Board** or **All Tasks** sections. Opgaver kan om nødvendigt filtreres vha. de eksisterende filterindstillinger:
...
* Arbejdsgangstrin: Alle, Intet arbejdsgangstrin eller et bestemt arbejdsgangstrin.
...
<Image src={close} alt="Opgavelukning" class="width-sm" />
...
<LinkCard title="Brugeropgaver" description="Learn how to view, filter, and manage tasks assigned to you." href="/enterprise/user-tasks/" />
