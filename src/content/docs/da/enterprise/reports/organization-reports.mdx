...
<Image src={reportsTab} alt="Organisationsrapporter" />
...
This report tracks the overall translation and proofreading activity in the organization. You can filter the data by **Date Range**, **Language**, and **Member**. The report is split into two main parts: **Translation** and **Proofreading**.
...
You can filter the data by **Date Range**, **Language**, and **Member**. The report uses a **Rates template** to calculate savings. By default, it uses the **Default Net Rate Scheme**, but you can select a custom template to reflect specific agreements.
...
* **Total** &ndash; organization-level cost for all proofreading and translation activities (including all members and languages). Resultatet vises øverst midt på siden.
* **Totals** &ndash; general translation cost for every language or each member. Resultaterne grupperes efter den parameter, der vælges.
* **Subtotals** &ndash; separate translation cost for every language or each member. Resultaterne grupperes efter den parameter, der vælges.
...
To select the languages and users for custom rates, click the drop-down menus, and select the ones you need. Individuelle satser kan oprettes i det ønskede antal.
...
* **Total** – The organization-level cost and time spent for all translation and proofreading activities across all projects. Resultatet vises øverst midt på siden.
* **Totals** – The total cost and time spent for every language, member, or project. Resultaterne grupperes efter den parameter, der vælges.
...
<Steps>
  ...
  4. Select a specific project. Alternatively, select **All projects**.
</Steps>
...
Afsnittet Arkiv muliggør at tilgå poster for tidligere genererede rapporter over Oversættelsesomkostninger, hvilket giver en bekvem måde at gennemgå historiske data.
...
En organisation har sit eget uafhængige arkivafsnit med tidligere genererede rapporter, som kun er tilgængelige for brugere med minimum ledelsestilladelser.
...
<Steps>
  ...
  2. Click on **Archive**.
  3. Klik på navnet på den ønskede arkivpost.
  4. Når arkivrapportposten åbnes, kan alle ønskede data ses.
</Steps>
...
<Steps>
  1. Open your organization's **Workspace** and select **Reports** on the left sidebar.
  2. Click on **Archive**.
  3. Click <Icon name="mdi:dots-vertical" class="inline-icon" /> (or right-click) on the needed report in the list.
  4. Klik på det foretrukne fileksportformat.
</Steps>
...
<CardGrid>
  <LinkCard title="Projektrapporter" description="View your project status and various localization reports." href="/enterprise/project-reports/" />
