...
<Image src={details} alt="Projektdetaljer" />
...
<Aside title="Prerequisites">
  The **Show files and tagged screenshots** and **Show screenshots only** options will only work if your [source strings have been tagged](/enterprise/screenshots/#tag-strings) on the screenshots.
</Aside>

## Overførsel af ejerskab

Som udgangspunkt ejer man selv de projektet, man opretter i Crowdin Enterprise. Projektejerskabet kan overføres til en anden bruger i den pågældende organisation.
...
Denne valgmulighed er tilgængelig for projektejere, projektledere, overordnede gruppeledere samt organisationsadmins. Et Crowdins Enterprise-projekt, inkl. alle oversættelser og relaterede lokaliseringsressourcer, kan slettes.
