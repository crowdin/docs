...
Ved eksport af oversættelser udfylder Crowdin Enterprise som standard uoversatte strenge med kildetekst for at undgå eksport af tomme filer. You can change this behavior by using the options below.
...
Choose if you want to export only strings with approved translations. Sørg for, at det valgte antal nødvendige godkendelser ikke overstiger det faktiske antal korrekturlæsningstrin i projektarbejdsgangen.
