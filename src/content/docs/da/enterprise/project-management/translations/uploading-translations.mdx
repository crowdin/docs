---
title: Upload af eksisterende oversættelser
...
Findes eksisterende oversættelser, kan disse uploades til det relevante Crowdin Enterprise-projekt.
...
Bedste praksis er at uploade oversatte filer med nøgleværdistrukturer.
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Steps>
      ...
      4. Crowdin Enterprise matcher automatisk uploadede oversættelser med de korrekte kildefiler og sprog. Tjek det manuelt for at sikre, at alt er matchet korrekt.
  ...
  <TabItem label="String-based project">
    <Steps>
      ...
      3. Crowdin Enterprise forsøger automatisk at registrere det målsprog, der uploades oversættelser til. Check it manually to make sure target languages are matched correctly towards translation files.
    ...
    <Image src={uploadTranslationsSb} alt="Upload oversættelser" />
  </TabItem>
</Tabs>
...
Denne funktion er p.t. tilgængelig for flg. sprog (uafhængigt af sprogparkombinationen): arabisk, engelsk, fransk, hollandsk, italiensk, japansk, kinesisk forenklet/traditionel, koreansk, polsk, portugisisk-brasiliansk, russisk, spansk, thailandsk, tysk og tyrkisk.
