...
<Steps>
  ...
  3. Click <Icon name="mdi:eye-off" class="inline-icon" />.
</Steps>
...
By default, all source strings of the project are displayed in **Sources > Strings**. Om nødvendigt kan strenge filtreres ud via de tilgængelige filterindstillinger (Problematikker: Alle, Med uløste problematikker, Uden uløste problematikker; Kommentarer: Alle, Med kommentarer, Uden kommentarer; Skærmfotos: Alle, Med skærmfotos, Uden skærmfotos; Synlighed: Alle, Kun synlige og Kun skjulte) og projektetiketter.

<Image src={stringFilter} alt="Strengefiltrering" />
...
Brug etiketter i projektet som en nem måde at føje kontekst til strengene på eller organisere dem efter bestemte emner. Labels are also useful while creating translation and proofreading tasks or searching for specific strings in the Editor with the help of [Advanced Filter](/enterprise/online-editor/#advanced-filter).

<LinkCard title="Projektetikethåndtering" description="Learn how to make your Crowdin project labels." href="/enterprise/project-settings/labels/" />
...
<Steps>
  ...
  3. Click **Save**. <Image src={labelsAddingToOneString} alt="Adding Labels" class="width-lg crowdin-modal" />
</Steps>
...
<Steps>
  ...
  4. Click **Apply**. <Image src={labelsAddingToMultipleStrings} alt="Adding Labels" />
</Steps>

##### Add labels to the source strings in CSV and XLSX files using a dedicated column for labels

<ReadMore>
  Read more about [Configuring Columns for Import](/enterprise/csv-xlsx-configuration/#columns-configuration).
</ReadMore>
