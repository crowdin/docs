...
Opretholde en fleksibel lokaliseringsproces og undgå oversættelsesforsinkelser ved tilføjede tekster eller nye produktfunktioner. Integrér projektgrene med Crowdin Enterprise og giv straks oversættere adgang til alle nye tekster.

When several people work on product development, branches help manage different content versions. Arbejdes der med kontinuerligt projekt, kan projektgrene føjes til Crowdin Enterprise og dermed lade oversættere behandle teksterne parallelt med udviklingen for at undgå udrulningsforsinkelser.

Grene i Crowdin Enterprise ligner almindelige mapper markeret med et særligt ikon og har en særlig adfærd for dubletstrenge.

Example of branch structure in Crowdin Enterprise:

<Image src={versionsBranches} alt="Grenstruktur" />

## Managing Branches

You can create, clone, merge, rename, prioritize, protect, or delete branches in Crowdin Enterprise to streamline localization alongside development. Use the available UI options, API, or CLI depending on your workflow and project type.
...
Crowdin Enterprise provides visual indicators when you are viewing a protected branch:
...
You can merge one branch into another directly from the **Branches** tab using the context menu. During the merge process, Crowdin Enterprise displays a summary of changes (i.e., source text updates and new translations), allowing you to select exactly which changes to accept before completing the merge.
...
Følg disse trin for at angive prioriteter for de relevante grene:
...
<Tabs syncKey="projectType">
  ...
  <Image src={versionsDuplicateStrings} alt="Dubletter" />
  </TabItem>
  <TabItem label="String-based project">
...
<Image src={branchMerging} alt="Grenfletning" class="no-shadow mb-8" />
...
<Image src={branchTranslationVerification} alt="Grenoversættelsesbekræftelse" class="no-shadow" />
