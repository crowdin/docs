...
<Steps>
  ...
  2. Click <Icon name="mdi:dots-vertical" class="inline-icon" /> (or right-click) on the needed file and select **Settings**. <Image src={fileContextMenuSettings} alt="File context menu settings" />
  ...
  6. Paste your SRX segmentation rules and click **Save**. <Image src={fileParserConfiguration} alt="File parser configuration" class="width-xl" />
</Steps>
