...
<Aside type="tip">
  If you don't have a preferred vendor yet, you can explore the list of our [partner vendors](https://store.crowdin.com/partners) available on the Crowdin Store.
</Aside>

## Tilføjelse af leverandørleder til den relevante organisation
...
<Steps>
  ...
  2. Click **Add vendor's manager** in the center of the page. You’ll be redirected to the **Users** page with the **Invite people** dialog open.
  3. Enter the email of the vendor’s manager you want to invite.
  4. Make sure **Workspace manager** is selected to grant the necessary permissions for managing the localization process.
  5. *(Optional)* Add a message if needed.
  6. Click **Send invite**. <Image src={addManagerForm} alt="Vendor manager form" />
</Steps>
...
<Steps>
  1. Open your organization's **Workspace** and select **Vendors** on the left sidebar.
  2. Click **Invite vendor** in the center of the page.
  3. In the **Invite vendor** dialog, enter the subdomain of the existing Crowdin Enterprise organization.
  4. *(Optional)* Add a message to provide additional context.
  5. Click **Invite**. <Image src={inviteForm} alt="Vendor invite form" class="width-xl" />
  6. Alternatively, click **Get a shareable link** and send it to the vendor manually.
</Steps>

## Se også

<LinkCard title="Oversættelse og korrekturlæsning af leverandør" description="Configure translation and proofreading by vendor in your project workflow." href="/enterprise/translation-proofreading-by-vendor/" />
