---
title: Start med en organisation
...
Man vil sin organisation kunne:
...
* Tildele admin-adgang på forskellige niveauer.
...
<Steps>
  1. Åbn tilmeldingssiden.
  2. Select your preferred data center (**US Data Center** or **EU Data Center**). This defines where your organization’s data (files, strings, and other resources) will be stored.
  3. Enter your organization's name. It will also be used in the URL (e.g., `organization-name.crowdin.com`).
  4. Fill in all the fields with your account data and click **Create Organization**. <Image src={createWorkspace} alt="Creating an organization" class="width-lg" />
  5. Go to your inbox, open the activation email, and click **Activate Organization**.
</Steps>
...
## Tilmelding via en invitation

Deltag i en organisation for sammen med teamet at begynde at arbejde på lokaliseringsprojekter.
Følg disse trin for at deltage i en organisation efter modtagelse af en invitation:

<Steps>
  1. Open the invitation email and click **Accept Invitation**.
  2. Opret et brugernavn og adgangskode.
  3. Click **Create Account**. <Image src={acceptInvitation} alt="Accepting an invitation" class="width-lg" />
</Steps>

## Indlogning i en organisation

Følg disse trin for at logge ind, når organisationen er oprettet og aktiveret:

<Steps>
  1. Åbn login-siden.
  2. Enter your organization's name and click **Continue**. <Image src={logIn} alt="Signing in form" class="width-lg" />
  3. Angiv e-mail/brugernavn og adgangskode.
  4. Click **Log in**.
</Steps>
...
<Steps>
  ...
  2. Click **Forgot the URL?**.
  3. Tilføj relevante e-mailadresse.
  4. Click **Confirm**.
</Steps>
