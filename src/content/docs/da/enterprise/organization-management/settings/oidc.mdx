...
<CardGrid>
  <LinkCard title="Configure OpenID Connect for Okta" href="#okta" />
  <LinkCard title="Configure OpenID Connect for Auth0" href="#auth0" />
</CardGrid>
...
<Steps>
  ...
  5. In the *Assign Crowdin Enterprise OpenID Connect to Groups* dialog, click **Assign** on **Everyone** to enable Crowdin Enterprise OpenID Connect app to all users in your organization, click **Done**. Alternativt kan separate grupper eller individuelle brugere tildeles.
</Steps>
...
<Steps>
  ...
  2. Click on **OpenID Connect**. Automatisk omdirigering sker dernæst til Okta login-siden.
...
<Steps>
  ...
  2. Click on **OpenID Connect**. Man omdirigeres dernæst automatisk til Auth0 login-siden.
  3. Angiv de relevante legitimationsoplysninger. Efter godkendelse af login-oplysningerne, omdirigeres man automatisk til Crowdin Enterprise.
</Steps>
