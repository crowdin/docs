...
<Image src={workflowEditor} alt="Kildetekstrevision i arbejdsgangseditoren" />
...
<Image src={editorCorrectedText} alt="Korrigeret tekst i Editors Revisionstilstand" />
