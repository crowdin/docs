---
title: Oversættelse via leverandør-API
...
## Tilføjelse af Leverandør-API til organisationen
...
## Tilføjelse af Oversættelse via Leverandør-API-trin til arbejdsgangen
...
<Image src={workflowEditor} alt="Oversættelse via Leverandør-API i Arbejdsgangseditoren" />

## Oversættelsesbestilling fra Leverandør (API)
...
<Image src={ordersHistory} alt="Bestillingshistorik" class="width-2xl" />
