...
Azure Repos-integrationen muliggør synk af filer mellem hhv. det relevante Azure Repos-repo og Crowdin Enterprise-projekt.
...
* **Målfil-pakketilstand** &ndash; generér og push oversættelsesfiler i det valgte format til Azure Repos-repo'et fra Crowdin Enterprise-projektet. I denne tilstand pusher integration oversættelsesfiler og synker ikke kilder fra repo'et. I tilfælde, hvor der udføres en kildetekstrevision i Crowdin Enterprise-projektet, og kildeteksten ønskes opdateret til repo'et, kan der tilføjes et kildesprog som målsprog, hvilket så pushes til repo'et sammen med oversættelserne.
...
<Tabs syncKey="projectType">
  <TabItem label="File-based project">
    <Image src={unconfigured} alt="Azure Repos Integration - ikke-opsat" />
  ...
  <TabItem label="String-based project">
    <Image src={unconfiguredSb} alt="Azure Repos Integration - ikke-opsat" />
  </TabItem>
</Tabs>
...
When working with Azure Repos integration in the **Target File Bundles Mode**, the integration will send the completed translations from your Crowdin Enterprise project without pulling sources from your repo. Når der vælges et repo og grene til oversættelss, angives ligeledes, hvor integrationen skal placere (put) de genererede pakker med oversættelser.
...
Når integration opsættes, vælges de eksisterende repo-grene, som skal føjes til Crowdin Enterprise-projektet. Opret et mønster for grennavnene i integrationsindstillingerne for automatisk at føje fremtidige grene fra Azure Repos til Crowdin Enterprise.
