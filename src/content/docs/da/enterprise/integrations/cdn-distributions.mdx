...
A distribution is a CDN vault that mirrors your project's translated content and is required for integration with your apps. Distributions work by using [Bundles](/enterprise/bundles/) to package and serve your files.
...
<CardGrid>
  ...
  <LinkCard title="Android SDK (kommer snart)" href="https://crowdin.github.io/mobile-sdk-android/" target="_blank" />
...
You can manage your CDN usage price and set up notifications for daily usage limits in the **Organization Settings > Billing > CDN Distributions**.
