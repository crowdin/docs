...
<Steps>
  ...
  2. Angiv navnet på opsætningsfilen fra det relevante repo.
  3. Click **Continue**.
</Steps>
...
<Image src={ignoreFiles} alt="Ignorere filer eller mapper" class="width-2xl" />
...
<Image src={configuringSpreadsheets} alt="Opsætning af regneark" class="width-2xl" />
...
<Image src={configuringXml} alt="Opsætning af XML-filer" class="width-2xl" />
...
<Steps>
  ...
  3. Click **Save** to save the created configuration. <Image src={filesList} alt="Apply filters to all translatable branches" class="width-2xl" />
</Steps>
