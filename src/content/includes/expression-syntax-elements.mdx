...
| `wordboundary`    | `word boundary`                | match a word boundary \b (position between a word and non-word character)                          |                      |
| `nonwordboundary` | `non-word boundary`            | match a non-word boundary \B (position that is not a word boundary)                                |                      |
